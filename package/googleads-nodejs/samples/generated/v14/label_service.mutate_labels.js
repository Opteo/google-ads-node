...
function main(customerId, operations) {
  // [START googleads_v14_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v14;
  ...
  callMutateLabels();
  // [END googleads_v14_generated_LabelService_MutateLabels_async]
}
