...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v14_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v14;
  ...
  callListInvoices();
  // [END googleads_v14_generated_InvoiceService_ListInvoices_async]
}
