...
function main(customerId, operation) {
  // [START googleads_v14_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
  /**
  ...
  const {CustomerUserAccessInvitationServiceClient} = require('google-ads').v14;
  ...
  // [END googleads_v14_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
}
