...
function main(customerId, operations) {
  // [START googleads_v14_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v14;
  ...
  callMutateAssets();
  // [END googleads_v14_generated_AssetService_MutateAssets_async]
}
