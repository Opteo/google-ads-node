...
function main(customerId, campaignDuration, plannedProducts) {
  // [START googleads_v14_generated_ReachPlanService_GenerateReachForecast_async]
  /**
  ...
  const {ReachPlanServiceClient} = require('google-ads').v14;
  ...
  // [END googleads_v14_generated_ReachPlanService_GenerateReachForecast_async]
}
