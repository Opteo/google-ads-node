...
function main(customerId, query) {
  // [START googleads_v14_generated_GoogleAdsService_SearchStream_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v14;
  ...
  callSearchStream();
  // [END googleads_v14_generated_GoogleAdsService_SearchStream_async]
}
