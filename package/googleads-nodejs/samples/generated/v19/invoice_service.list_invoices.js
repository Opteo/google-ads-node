...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v19_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v19;
  ...
  callListInvoices();
  // [END googleads_v19_generated_InvoiceService_ListInvoices_async]
}
