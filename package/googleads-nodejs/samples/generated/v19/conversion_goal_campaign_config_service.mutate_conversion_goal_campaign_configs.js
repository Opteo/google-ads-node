...
function main(customerId, operations) {
  // [START googleads_v19_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
  /**
  ...
  const {ConversionGoalCampaignConfigServiceClient} = require('google-ads').v19;
  ...
  // [END googleads_v19_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
}
