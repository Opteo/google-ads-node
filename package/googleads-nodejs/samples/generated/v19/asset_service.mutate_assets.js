...
function main(customerId, operations) {
  // [START googleads_v19_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v19;
  ...
  callMutateAssets();
  // [END googleads_v19_generated_AssetService_MutateAssets_async]
}
