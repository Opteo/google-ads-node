...
function main(customerId, operations) {
  // [START googleads_v19_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v19;
  ...
  callMutateLabels();
  // [END googleads_v19_generated_LabelService_MutateLabels_async]
}
