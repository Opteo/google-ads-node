...
function main(customerId, operation) {
  // [START googleads_v19_generated_AccountLinkService_MutateAccountLink_async]
  /**
  ...
  const {AccountLinkServiceClient} = require('google-ads').v19;
  ...
  // [END googleads_v19_generated_AccountLinkService_MutateAccountLink_async]
}
