...
function main(resourceName) {
  // [START googleads_v19_generated_BatchJobService_ListBatchJobResults_async]
  /**
  ...
  const {BatchJobServiceClient} = require('google-ads').v19;
  ...
  async function callListBatchJobResults() {
    ...
    // Run request
    const iterable = googleadsClient.listBatchJobResultsAsync(request);
  ...
  // [END googleads_v19_generated_BatchJobService_ListBatchJobResults_async]
}
