...
function main(customerId, operation) {
  // [START googleads_v19_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
  /**
  ...
  const {CustomerUserAccessInvitationServiceClient} = require('google-ads').v19;
  ...
  // [END googleads_v19_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
}
