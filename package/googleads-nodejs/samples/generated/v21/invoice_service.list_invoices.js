...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v21_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v21;
  ...
  callListInvoices();
  // [END googleads_v21_generated_InvoiceService_ListInvoices_async]
}
