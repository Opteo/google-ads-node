...
function main(customerId, operations) {
  // [START googleads_v21_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v21;
  ...
  callMutateLabels();
  // [END googleads_v21_generated_LabelService_MutateLabels_async]
}
