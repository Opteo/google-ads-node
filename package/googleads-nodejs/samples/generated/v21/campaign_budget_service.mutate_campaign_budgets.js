...
function main(customerId, operations) {
  // [START googleads_v21_generated_CampaignBudgetService_MutateCampaignBudgets_async]
  /**
  ...
  const {CampaignBudgetServiceClient} = require('google-ads').v21;
  ...
  // [END googleads_v21_generated_CampaignBudgetService_MutateCampaignBudgets_async]
}
