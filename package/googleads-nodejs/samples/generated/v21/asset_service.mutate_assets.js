...
function main(customerId, operations) {
  // [START googleads_v21_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v21;
  ...
  callMutateAssets();
  // [END googleads_v21_generated_AssetService_MutateAssets_async]
}
