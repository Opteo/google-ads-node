...
function main(customerId, recommendationTypes, advertisingChannelType) {
  // [START googleads_v21_generated_RecommendationService_GenerateRecommendations_async]
  /**
  ...
  const {RecommendationServiceClient} = require('google-ads').v21;
  ...
  // [END googleads_v21_generated_RecommendationService_GenerateRecommendations_async]
}
