...
function main(customerId, operation) {
  // [START googleads_v21_generated_AccountLinkService_MutateAccountLink_async]
  /**
  ...
  const {AccountLinkServiceClient} = require('google-ads').v21;
  ...
  // [END googleads_v21_generated_AccountLinkService_MutateAccountLink_async]
}
