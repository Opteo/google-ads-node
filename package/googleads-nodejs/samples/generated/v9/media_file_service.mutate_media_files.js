...
function main(customerId, operations) {
  // [START googleads_v9_generated_MediaFileService_MutateMediaFiles_async]
  /**
  ...
  const {MediaFileServiceClient} = require('google-ads').v9;
  ...
  // [END googleads_v9_generated_MediaFileService_MutateMediaFiles_async]
}
