...
function main(customerId, operations) {
  // [START googleads_v9_generated_FeedItemTargetService_MutateFeedItemTargets_async]
  /**
  ...
  const {FeedItemTargetServiceClient} = require('google-ads').v9;
  ...
  // [END googleads_v9_generated_FeedItemTargetService_MutateFeedItemTargets_async]
}
