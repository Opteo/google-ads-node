...
function main(resourceName) {
  // [START googleads_v9_generated_ExpandedLandingPageViewService_GetExpandedLandingPageView_async]
  /**
  ...
  const {ExpandedLandingPageViewServiceClient} = require('google-ads').v9;
