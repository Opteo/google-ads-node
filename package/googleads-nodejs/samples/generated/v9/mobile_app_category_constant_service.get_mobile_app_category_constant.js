...
function main(resourceName) {
  // [START googleads_v9_generated_MobileAppCategoryConstantService_GetMobileAppCategoryConstant_async]
  /**
  ...
  const {MobileAppCategoryConstantServiceClient} = require('google-ads').v9;
