...
function main(customerId, operations) {
  // [START googleads_v9_generated_UserListService_MutateUserLists_async]
  /**
  ...
  const {UserListServiceClient} = require('google-ads').v9;
  ...
  callMutateUserLists();
  // [END googleads_v9_generated_UserListService_MutateUserLists_async]
}
