...
function main(resourceName) {
  // [START googleads_v9_generated_ProductGroupViewService_GetProductGroupView_async]
  /**
  ...
  const {ProductGroupViewServiceClient} = require('google-ads').v9;
  ...
  async function callGetProductGroupView() {
    ...
    // Run request
    const response = await googleadsClient.getProductGroupView(request);
