...
function main(customerId, operations) {
  // [START googleads_v9_generated_CampaignService_MutateCampaigns_async]
  /**
  ...
  const {CampaignServiceClient} = require('google-ads').v9;
  ...
  callMutateCampaigns();
  // [END googleads_v9_generated_CampaignService_MutateCampaigns_async]
}
