...
function main(customerId, operations) {
  // [START googleads_v9_generated_RecommendationService_ApplyRecommendation_async]
  /**
  ...
  const {RecommendationServiceClient} = require('google-ads').v9;
  ...
  // [END googleads_v9_generated_RecommendationService_ApplyRecommendation_async]
}
