...
function main(resourceName) {
  // [START googleads_v9_generated_KeywordViewService_GetKeywordView_async]
  /**
  ...
  const {KeywordViewServiceClient} = require('google-ads').v9;
  ...
  async function callGetKeywordView() {
    ...
    // Run request
    const response = await googleadsClient.getKeywordView(request);
