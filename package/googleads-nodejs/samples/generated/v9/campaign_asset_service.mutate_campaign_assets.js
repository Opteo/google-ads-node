...
function main(customerId, operations) {
  // [START googleads_v9_generated_CampaignAssetService_MutateCampaignAssets_async]
  /**
  ...
  const {CampaignAssetServiceClient} = require('google-ads').v9;
  ...
  // [END googleads_v9_generated_CampaignAssetService_MutateCampaignAssets_async]
}
