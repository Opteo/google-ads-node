...
function main(resourceName) {
  // [START googleads_v9_generated_DynamicSearchAdsSearchTermViewService_GetDynamicSearchAdsSearchTermView_async]
  /**
  ...
  const {DynamicSearchAdsSearchTermViewServiceClient} = require('google-ads').v9;
