...
function main(customerId, operations) {
  // [START googleads_v9_generated_CustomerManagerLinkService_MutateCustomerManagerLink_async]
  /**
  ...
  const {CustomerManagerLinkServiceClient} = require('google-ads').v9;
  ...
  // [END googleads_v9_generated_CustomerManagerLinkService_MutateCustomerManagerLink_async]
}
