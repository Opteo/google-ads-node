...
function main(resourceName) {
  // [START googleads_v9_generated_AgeRangeViewService_GetAgeRangeView_async]
  /**
  ...
  const {AgeRangeViewServiceClient} = require('google-ads').v9;
  ...
  async function callGetAgeRangeView() {
    ...
    // Run request
    const response = await googleadsClient.getAgeRangeView(request);
