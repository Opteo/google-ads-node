...
function main(customerId, operations) {
  // [START googleads_v22_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
  /**
  ...
  const {KeywordPlanAdGroupKeywordServiceClient} = require('google-ads').v22;
  ...
  // [END googleads_v22_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
}
