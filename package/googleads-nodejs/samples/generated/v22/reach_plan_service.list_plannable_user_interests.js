...
function main(customerId) {
  // [START googleads_v22_generated_ReachPlanService_ListPlannableUserInterests_async]
  /**
   ...
   */
  // const userInterestTaxonomyTypes = [1,2,3,4]
  /**
  ...
  const {ReachPlanServiceClient} = require('google-ads').v22;

  // Instantiates a client
  const googleadsClient = new ReachPlanServiceClient();

  async function callListPlannableUserInterests() {
    // Construct request
    const request = {
      customerId,
    };
    ...
    // Run request
    const response = await googleadsClient.listPlannableUserInterests(request);
    console.log(response);
  }

  callListPlannableUserInterests();
  // [END googleads_v22_generated_ReachPlanService_ListPlannableUserInterests_async]
}
