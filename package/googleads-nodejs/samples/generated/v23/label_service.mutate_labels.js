...
function main(customerId, operations) {
  // [START googleads_v23_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v23;
  ...
  callMutateLabels();
  // [END googleads_v23_generated_LabelService_MutateLabels_async]
}
