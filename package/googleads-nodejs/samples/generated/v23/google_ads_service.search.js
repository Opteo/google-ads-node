...
function main(customerId, query) {
  // [START googleads_v23_generated_GoogleAdsService_Search_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v23;
  ...
  callSearch();
  // [END googleads_v23_generated_GoogleAdsService_Search_async]
}
