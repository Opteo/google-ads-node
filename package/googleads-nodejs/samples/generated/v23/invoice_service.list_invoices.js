...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v23_generated_InvoiceService_ListInvoices_async]
  /**
   ...
   */
  // const includeGranularLevelInvoiceDetails = true

  // Imports the Googleads library
  const {InvoiceServiceClient} = require('google-ads').v23;
  ...
  callListInvoices();
  // [END googleads_v23_generated_InvoiceService_ListInvoices_async]
}
