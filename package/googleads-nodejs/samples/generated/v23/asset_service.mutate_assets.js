...
function main(customerId, operations) {
  // [START googleads_v23_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v23;
  ...
  callMutateAssets();
  // [END googleads_v23_generated_AssetService_MutateAssets_async]
}
