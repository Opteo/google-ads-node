...
function main(customerId, operation) {
  // [START googleads_v17_generated_AccountLinkService_MutateAccountLink_async]
  /**
  ...
  const {AccountLinkServiceClient} = require('google-ads').v17;
  ...
  // [END googleads_v17_generated_AccountLinkService_MutateAccountLink_async]
}
