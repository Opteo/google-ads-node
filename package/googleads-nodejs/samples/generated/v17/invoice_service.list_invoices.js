...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v17_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v17;
  ...
  callListInvoices();
  // [END googleads_v17_generated_InvoiceService_ListInvoices_async]
}
