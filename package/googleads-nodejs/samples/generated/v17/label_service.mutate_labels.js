...
function main(customerId, operations) {
  // [START googleads_v17_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v17;
  ...
  callMutateLabels();
  // [END googleads_v17_generated_LabelService_MutateLabels_async]
}
