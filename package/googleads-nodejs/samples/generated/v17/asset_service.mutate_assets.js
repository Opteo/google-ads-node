...
function main(customerId, operations) {
  // [START googleads_v17_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v17;
  ...
  callMutateAssets();
  // [END googleads_v17_generated_AssetService_MutateAssets_async]
}
