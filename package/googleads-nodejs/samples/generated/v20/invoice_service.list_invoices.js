...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v20_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v20;
  ...
  callListInvoices();
  // [END googleads_v20_generated_InvoiceService_ListInvoices_async]
}
