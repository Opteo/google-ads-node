...
function main(customerId, operations) {
  // [START googleads_v20_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
  /**
  ...
  const {AssetGroupListingGroupFilterServiceClient} = require('google-ads').v20;
  ...
  // [END googleads_v20_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
}
