...
function main(customerId, operations) {
  // [START googleads_v20_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
  /**
  ...
  const {KeywordPlanAdGroupKeywordServiceClient} = require('google-ads').v20;
  ...
  // [END googleads_v20_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
}
