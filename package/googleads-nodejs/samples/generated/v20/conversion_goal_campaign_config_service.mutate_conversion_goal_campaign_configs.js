...
function main(customerId, operations) {
  // [START googleads_v20_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
  /**
  ...
  const {ConversionGoalCampaignConfigServiceClient} = require('google-ads').v20;
  ...
  // [END googleads_v20_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
}
