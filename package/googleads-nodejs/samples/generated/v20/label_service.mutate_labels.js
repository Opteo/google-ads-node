...
function main(customerId, operations) {
  // [START googleads_v20_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v20;
  ...
  callMutateLabels();
  // [END googleads_v20_generated_LabelService_MutateLabels_async]
}
