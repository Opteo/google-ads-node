...
function main(customerId, recommendationTypes, advertisingChannelType) {
  // [START googleads_v20_generated_RecommendationService_GenerateRecommendations_async]
  /**
   ...
   *  CAMPAIGN_BUDGET
   */
  // const campaignImageAssetCount = 1234
  /**
   *  Optional. Current campaign call asset count.
   *  This field is optional for the following recommendation_types:
   *  CAMPAIGN_BUDGET
   */
  // const campaignCallAssetCount = 1234
  /**
   *  Optional. Current campaign country codes.
   *  This field is required for the following recommendation_types:
   *  CAMPAIGN_BUDGET if AdvertisingChannelType is SEARCH
   */
  // const countryCodes = ['abc','def']
  /**
   ...
   */
  // const targetPartnerSearchNetwork = true
  /**
   ...
   */
  // const targetContentNetwork = true
  /**
   ...
   *  CAMPAIGN_BUDGET
   */
  // const merchantCenterAccountId = 1234

  // Imports the Googleads library
  const {RecommendationServiceClient} = require('google-ads').v20;
  ...
  // [END googleads_v20_generated_RecommendationService_GenerateRecommendations_async]
}
