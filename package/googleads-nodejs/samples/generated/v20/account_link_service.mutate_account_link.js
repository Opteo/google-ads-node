...
function main(customerId, operation) {
  // [START googleads_v20_generated_AccountLinkService_MutateAccountLink_async]
  /**
  ...
  const {AccountLinkServiceClient} = require('google-ads').v20;
  ...
  // [END googleads_v20_generated_AccountLinkService_MutateAccountLink_async]
}
