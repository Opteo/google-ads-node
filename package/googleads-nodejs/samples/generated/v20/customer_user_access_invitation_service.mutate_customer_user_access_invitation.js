...
function main(customerId, operation) {
  // [START googleads_v20_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
  /**
  ...
  const {CustomerUserAccessInvitationServiceClient} = require('google-ads').v20;
  ...
  // [END googleads_v20_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
}
