...
function main(customerId, operations) {
  // [START googleads_v20_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v20;
  ...
  callMutateAssets();
  // [END googleads_v20_generated_AssetService_MutateAssets_async]
}
