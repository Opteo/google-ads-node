...
function main(customerId, query) {
  // [START googleads_v20_generated_GoogleAdsService_Search_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v20;
  ...
  callSearch();
  // [END googleads_v20_generated_GoogleAdsService_Search_async]
}
