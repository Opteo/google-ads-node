...
function main(customerId, query) {
  // [START googleads_v12_generated_GoogleAdsService_SearchStream_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v12;
  ...
  callSearchStream();
  // [END googleads_v12_generated_GoogleAdsService_SearchStream_async]
}
