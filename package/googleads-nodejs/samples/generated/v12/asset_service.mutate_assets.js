...
function main(customerId, operations) {
  // [START googleads_v12_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v12;
  ...
  callMutateAssets();
  // [END googleads_v12_generated_AssetService_MutateAssets_async]
}
