...
function main(customerId, operations) {
  // [START googleads_v12_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v12;
  ...
  callMutateLabels();
  // [END googleads_v12_generated_LabelService_MutateLabels_async]
}
