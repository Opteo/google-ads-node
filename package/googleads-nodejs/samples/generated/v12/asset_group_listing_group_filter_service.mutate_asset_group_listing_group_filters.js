...
function main(customerId, operations) {
  // [START googleads_v12_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
  /**
  ...
  const {AssetGroupListingGroupFilterServiceClient} = require('google-ads').v12;
  ...
  // [END googleads_v12_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
}
