...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v12_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v12;
  ...
  callListInvoices();
  // [END googleads_v12_generated_InvoiceService_ListInvoices_async]
}
