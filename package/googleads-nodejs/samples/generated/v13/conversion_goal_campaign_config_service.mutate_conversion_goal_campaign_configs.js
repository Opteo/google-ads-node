...
function main(customerId, operations) {
  // [START googleads_v13_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
  /**
  ...
  const {ConversionGoalCampaignConfigServiceClient} = require('google-ads').v13;
  ...
  // [END googleads_v13_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
}
