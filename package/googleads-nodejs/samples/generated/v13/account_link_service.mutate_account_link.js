...
function main(customerId, operation) {
  // [START googleads_v13_generated_AccountLinkService_MutateAccountLink_async]
  /**
  ...
  const {AccountLinkServiceClient} = require('google-ads').v13;
  ...
  // [END googleads_v13_generated_AccountLinkService_MutateAccountLink_async]
}
