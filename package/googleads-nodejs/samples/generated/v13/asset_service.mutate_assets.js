...
function main(customerId, operations) {
  // [START googleads_v13_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v13;
  ...
  callMutateAssets();
  // [END googleads_v13_generated_AssetService_MutateAssets_async]
}
