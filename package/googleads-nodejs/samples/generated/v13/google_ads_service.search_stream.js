...
function main(customerId, query) {
  // [START googleads_v13_generated_GoogleAdsService_SearchStream_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v13;
  ...
  callSearchStream();
  // [END googleads_v13_generated_GoogleAdsService_SearchStream_async]
}
