...
function main(customerId, operations) {
  // [START googleads_v13_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v13;
  ...
  callMutateLabels();
  // [END googleads_v13_generated_LabelService_MutateLabels_async]
}
