...
function main(customerId, operations) {
  // [START googleads_v13_generated_CampaignBudgetService_MutateCampaignBudgets_async]
  /**
  ...
  const {CampaignBudgetServiceClient} = require('google-ads').v13;
  ...
  // [END googleads_v13_generated_CampaignBudgetService_MutateCampaignBudgets_async]
}
