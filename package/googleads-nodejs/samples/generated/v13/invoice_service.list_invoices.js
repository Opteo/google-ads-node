...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v13_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v13;
  ...
  callListInvoices();
  // [END googleads_v13_generated_InvoiceService_ListInvoices_async]
}
