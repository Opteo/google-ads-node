...
function main(customerId, operations) {
  // [START googleads_v13_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
  /**
  ...
  const {KeywordPlanAdGroupKeywordServiceClient} = require('google-ads').v13;
  ...
  // [END googleads_v13_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
}
