...
function main(customerId, operation) {
  // [START googleads_v10_generated_CustomerClientLinkService_MutateCustomerClientLink_async]
  /**
  ...
  const {CustomerClientLinkServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CustomerClientLinkService_MutateCustomerClientLink_async]
}
