...
function main(customerId, operations) {
  // [START googleads_v10_generated_CampaignBudgetService_MutateCampaignBudgets_async]
  /**
  ...
  const {CampaignBudgetServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CampaignBudgetService_MutateCampaignBudgets_async]
}
