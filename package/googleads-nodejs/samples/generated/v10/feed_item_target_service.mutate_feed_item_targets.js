...
function main(customerId, operations) {
  // [START googleads_v10_generated_FeedItemTargetService_MutateFeedItemTargets_async]
  /**
  ...
  const {FeedItemTargetServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_FeedItemTargetService_MutateFeedItemTargets_async]
}
