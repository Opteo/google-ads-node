...
function main(customerId, operations) {
  // [START googleads_v10_generated_AdGroupLabelService_MutateAdGroupLabels_async]
  /**
  ...
  const {AdGroupLabelServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_AdGroupLabelService_MutateAdGroupLabels_async]
}
