...
function main(customerId, operations) {
  // [START googleads_v10_generated_AudienceService_MutateAudiences_async]
  /**
  ...
  const {AudienceServiceClient} = require('google-ads').v10;
  ...
  callMutateAudiences();
  // [END googleads_v10_generated_AudienceService_MutateAudiences_async]
}
