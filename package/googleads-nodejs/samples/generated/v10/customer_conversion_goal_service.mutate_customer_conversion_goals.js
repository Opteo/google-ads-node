...
function main(customerId, operations) {
  // [START googleads_v10_generated_CustomerConversionGoalService_MutateCustomerConversionGoals_async]
  /**
  ...
  const {CustomerConversionGoalServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CustomerConversionGoalService_MutateCustomerConversionGoals_async]
}
