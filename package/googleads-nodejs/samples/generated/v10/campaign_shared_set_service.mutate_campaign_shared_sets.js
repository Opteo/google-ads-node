...
function main(customerId, operations) {
  // [START googleads_v10_generated_CampaignSharedSetService_MutateCampaignSharedSets_async]
  /**
  ...
  const {CampaignSharedSetServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CampaignSharedSetService_MutateCampaignSharedSets_async]
}
