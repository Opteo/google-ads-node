...
function main(resourceName, operations) {
  // [START googleads_v10_generated_OfflineUserDataJobService_AddOfflineUserDataJobOperations_async]
  /**
  ...
  const {OfflineUserDataJobServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_OfflineUserDataJobService_AddOfflineUserDataJobOperations_async]
}
