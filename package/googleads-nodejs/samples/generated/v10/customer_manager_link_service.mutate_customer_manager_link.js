...
function main(customerId, operations) {
  // [START googleads_v10_generated_CustomerManagerLinkService_MutateCustomerManagerLink_async]
  /**
  ...
  const {CustomerManagerLinkServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CustomerManagerLinkService_MutateCustomerManagerLink_async]
}
