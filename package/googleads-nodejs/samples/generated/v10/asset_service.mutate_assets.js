...
function main(customerId, operations) {
  // [START googleads_v10_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v10;
  ...
  callMutateAssets();
  // [END googleads_v10_generated_AssetService_MutateAssets_async]
}
