...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v10_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v10;
  ...
  callListInvoices();
  // [END googleads_v10_generated_InvoiceService_ListInvoices_async]
}
