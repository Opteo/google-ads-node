...
function main(customerId) {
  // [START googleads_v10_generated_PaymentsAccountService_ListPaymentsAccounts_async]
  /**
  ...
  const {PaymentsAccountServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_PaymentsAccountService_ListPaymentsAccounts_async]
}
