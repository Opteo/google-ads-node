...
function main(customerId, operations) {
  // [START googleads_v10_generated_AssetGroupSignalService_MutateAssetGroupSignals_async]
  /**
  ...
  const {AssetGroupSignalServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_AssetGroupSignalService_MutateAssetGroupSignals_async]
}
