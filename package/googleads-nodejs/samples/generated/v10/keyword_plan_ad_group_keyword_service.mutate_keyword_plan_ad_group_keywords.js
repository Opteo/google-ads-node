...
function main(customerId, operations) {
  // [START googleads_v10_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
  /**
  ...
  const {KeywordPlanAdGroupKeywordServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
}
