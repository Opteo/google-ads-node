...
function main(customerId, operation) {
  // [START googleads_v10_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
  /**
  ...
  const {CustomerUserAccessInvitationServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
}
