...
function main(customerId, operations) {
  // [START googleads_v10_generated_CustomerAssetService_MutateCustomerAssets_async]
  /**
  ...
  const {CustomerAssetServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CustomerAssetService_MutateCustomerAssets_async]
}
