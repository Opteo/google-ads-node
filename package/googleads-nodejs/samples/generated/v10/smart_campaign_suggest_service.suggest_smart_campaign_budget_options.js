...
function main(customerId, campaign, suggestionInfo) {
  // [START googleads_v10_generated_SmartCampaignSuggestService_SuggestSmartCampaignBudgetOptions_async]
  /**
  ...
  const {SmartCampaignSuggestServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_SmartCampaignSuggestService_SuggestSmartCampaignBudgetOptions_async]
}
