...
function main(customerId, operations) {
  // [START googleads_v10_generated_FeedItemSetService_MutateFeedItemSets_async]
  /**
  ...
  const {FeedItemSetServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_FeedItemSetService_MutateFeedItemSets_async]
}
