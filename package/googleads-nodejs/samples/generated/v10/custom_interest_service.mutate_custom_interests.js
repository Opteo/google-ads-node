...
function main(customerId, operations) {
  // [START googleads_v10_generated_CustomInterestService_MutateCustomInterests_async]
  /**
  ...
  const {CustomInterestServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CustomInterestService_MutateCustomInterests_async]
}
