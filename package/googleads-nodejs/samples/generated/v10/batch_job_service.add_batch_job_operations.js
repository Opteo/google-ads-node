...
function main(resourceName, mutateOperations) {
  // [START googleads_v10_generated_BatchJobService_AddBatchJobOperations_async]
  /**
  ...
  const {BatchJobServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_BatchJobService_AddBatchJobOperations_async]
}
