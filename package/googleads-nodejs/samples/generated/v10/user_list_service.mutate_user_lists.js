...
function main(customerId, operations) {
  // [START googleads_v10_generated_UserListService_MutateUserLists_async]
  /**
  ...
  const {UserListServiceClient} = require('google-ads').v10;
  ...
  callMutateUserLists();
  // [END googleads_v10_generated_UserListService_MutateUserLists_async]
}
