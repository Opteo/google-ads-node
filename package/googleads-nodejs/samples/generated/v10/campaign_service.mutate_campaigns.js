...
function main(customerId, operations) {
  // [START googleads_v10_generated_CampaignService_MutateCampaigns_async]
  /**
  ...
  const {CampaignServiceClient} = require('google-ads').v10;
  ...
  callMutateCampaigns();
  // [END googleads_v10_generated_CampaignService_MutateCampaigns_async]
}
