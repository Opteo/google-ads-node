...
function main(customerId, operations) {
  // [START googleads_v10_generated_CampaignConversionGoalService_MutateCampaignConversionGoals_async]
  /**
  ...
  const {CampaignConversionGoalServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CampaignConversionGoalService_MutateCampaignConversionGoals_async]
}
