...
function main(customerId, operations) {
  // [START googleads_v10_generated_CampaignLabelService_MutateCampaignLabels_async]
  /**
  ...
  const {CampaignLabelServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CampaignLabelService_MutateCampaignLabels_async]
}
