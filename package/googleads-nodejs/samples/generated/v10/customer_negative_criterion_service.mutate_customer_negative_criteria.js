...
function main(customerId, operations) {
  // [START googleads_v10_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
  /**
  ...
  const {CustomerNegativeCriterionServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
}
