...
function main(customerId, conversionAdjustments, partialFailure) {
  // [START googleads_v10_generated_ConversionAdjustmentUploadService_UploadConversionAdjustments_async]
  /**
  ...
  const {ConversionAdjustmentUploadServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_ConversionAdjustmentUploadService_UploadConversionAdjustments_async]
}
