...
function main(customerId, operations) {
  // [START googleads_v10_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v10;
  ...
  callMutateLabels();
  // [END googleads_v10_generated_LabelService_MutateLabels_async]
}
