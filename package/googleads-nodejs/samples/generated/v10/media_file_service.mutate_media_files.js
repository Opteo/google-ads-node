...
function main(customerId, operations) {
  // [START googleads_v10_generated_MediaFileService_MutateMediaFiles_async]
  /**
  ...
  const {MediaFileServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_MediaFileService_MutateMediaFiles_async]
}
