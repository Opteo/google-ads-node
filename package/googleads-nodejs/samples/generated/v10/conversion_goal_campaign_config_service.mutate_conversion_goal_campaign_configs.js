...
function main(customerId, operations) {
  // [START googleads_v10_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
  /**
  ...
  const {ConversionGoalCampaignConfigServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
}
