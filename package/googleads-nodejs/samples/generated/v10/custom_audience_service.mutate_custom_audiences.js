...
function main(customerId, operations) {
  // [START googleads_v10_generated_CustomAudienceService_MutateCustomAudiences_async]
  /**
  ...
  const {CustomAudienceServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_CustomAudienceService_MutateCustomAudiences_async]
}
