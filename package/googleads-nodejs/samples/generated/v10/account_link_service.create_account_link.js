...
function main(customerId, accountLink) {
  // [START googleads_v10_generated_AccountLinkService_CreateAccountLink_async]
  /**
  ...
  const {AccountLinkServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_AccountLinkService_CreateAccountLink_async]
}
