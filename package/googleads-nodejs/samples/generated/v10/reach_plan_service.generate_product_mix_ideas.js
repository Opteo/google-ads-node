...
function main(customerId, plannableLocationId, currencyCode, budgetMicros) {
  // [START googleads_v10_generated_ReachPlanService_GenerateProductMixIdeas_async]
  /**
  ...
  const {ReachPlanServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_ReachPlanService_GenerateProductMixIdeas_async]
}
