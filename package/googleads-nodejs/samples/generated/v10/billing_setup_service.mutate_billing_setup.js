...
function main(customerId, operation) {
  // [START googleads_v10_generated_BillingSetupService_MutateBillingSetup_async]
  /**
  ...
  const {BillingSetupServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_BillingSetupService_MutateBillingSetup_async]
}
