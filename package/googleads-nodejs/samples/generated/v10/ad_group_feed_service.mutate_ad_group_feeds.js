...
function main(customerId, operations) {
  // [START googleads_v10_generated_AdGroupFeedService_MutateAdGroupFeeds_async]
  /**
  ...
  const {AdGroupFeedServiceClient} = require('google-ads').v10;
  ...
  // [END googleads_v10_generated_AdGroupFeedService_MutateAdGroupFeeds_async]
}
