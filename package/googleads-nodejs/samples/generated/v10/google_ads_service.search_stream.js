...
function main(customerId, query) {
  // [START googleads_v10_generated_GoogleAdsService_SearchStream_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v10;
  ...
  callSearchStream();
  // [END googleads_v10_generated_GoogleAdsService_SearchStream_async]
}
