...
function main(customerId, query) {
  // [START googleads_v16_generated_GoogleAdsService_Search_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v16;
  ...
  callSearch();
  // [END googleads_v16_generated_GoogleAdsService_Search_async]
}
