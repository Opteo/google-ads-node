...
function main(customerId, operations) {
  // [START googleads_v16_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
  /**
  ...
  const {ConversionGoalCampaignConfigServiceClient} = require('google-ads').v16;
  ...
  // [END googleads_v16_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async]
}
