...
function main(customerId, recommendationTypes, advertisingChannelType) {
  // [START googleads_v16_generated_RecommendationService_GenerateRecommendations_async]
  /**
  ...
  const {RecommendationServiceClient} = require('google-ads').v16;
  ...
  // [END googleads_v16_generated_RecommendationService_GenerateRecommendations_async]
}
