...
function main(customerId, operations) {
  // [START googleads_v16_generated_CampaignBudgetService_MutateCampaignBudgets_async]
  /**
  ...
  const {CampaignBudgetServiceClient} = require('google-ads').v16;
  ...
  // [END googleads_v16_generated_CampaignBudgetService_MutateCampaignBudgets_async]
}
