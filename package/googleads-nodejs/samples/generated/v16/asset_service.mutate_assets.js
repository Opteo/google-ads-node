...
function main(customerId, operations) {
  // [START googleads_v16_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v16;
  ...
  callMutateAssets();
  // [END googleads_v16_generated_AssetService_MutateAssets_async]
}
