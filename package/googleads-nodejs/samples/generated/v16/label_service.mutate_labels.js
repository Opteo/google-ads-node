...
function main(customerId, operations) {
  // [START googleads_v16_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v16;
  ...
  callMutateLabels();
  // [END googleads_v16_generated_LabelService_MutateLabels_async]
}
