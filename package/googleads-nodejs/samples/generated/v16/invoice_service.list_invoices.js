...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v16_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v16;
  ...
  callListInvoices();
  // [END googleads_v16_generated_InvoiceService_ListInvoices_async]
}
