...
function main(customerId, operation) {
  // [START googleads_v16_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
  /**
  ...
  const {CustomerUserAccessInvitationServiceClient} = require('google-ads').v16;
  ...
  // [END googleads_v16_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async]
}
