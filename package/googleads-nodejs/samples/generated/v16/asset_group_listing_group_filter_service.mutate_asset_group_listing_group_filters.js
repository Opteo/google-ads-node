...
function main(customerId, operations) {
  // [START googleads_v16_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
  /**
  ...
  const {AssetGroupListingGroupFilterServiceClient} = require('google-ads').v16;
  ...
  // [END googleads_v16_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
}
