...
function main(customerId, campaignDuration, plannedProducts) {
  // [START googleads_v16_generated_ReachPlanService_GenerateReachForecast_async]
  /**
  ...
  const {ReachPlanServiceClient} = require('google-ads').v16;
  ...
  // [END googleads_v16_generated_ReachPlanService_GenerateReachForecast_async]
}
