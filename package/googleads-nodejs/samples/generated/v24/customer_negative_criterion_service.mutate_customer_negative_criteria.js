...
function main(customerId, operations) {
  // [START googleads_v24_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
  /**
  ...
  const {CustomerNegativeCriterionServiceClient} = require('google-ads').v24;
  ...
  // [END googleads_v24_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
}
