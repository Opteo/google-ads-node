...
function main(customerId, recommendationTypes, advertisingChannelType) {
  // [START googleads_v24_generated_RecommendationService_GenerateRecommendations_async]
  /**
  ...
  const {RecommendationServiceClient} = require('google-ads').v24;
  ...
  // [END googleads_v24_generated_RecommendationService_GenerateRecommendations_async]
}
