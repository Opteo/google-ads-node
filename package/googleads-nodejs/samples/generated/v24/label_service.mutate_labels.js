...
function main(customerId, operations) {
  // [START googleads_v24_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v24;
  ...
  callMutateLabels();
  // [END googleads_v24_generated_LabelService_MutateLabels_async]
}
