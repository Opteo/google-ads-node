...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v24_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v24;
  ...
  callListInvoices();
  // [END googleads_v24_generated_InvoiceService_ListInvoices_async]
}
