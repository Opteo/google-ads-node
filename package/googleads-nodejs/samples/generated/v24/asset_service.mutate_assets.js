...
function main(customerId, operations) {
  // [START googleads_v24_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v24;
  ...
  callMutateAssets();
  // [END googleads_v24_generated_AssetService_MutateAssets_async]
}
