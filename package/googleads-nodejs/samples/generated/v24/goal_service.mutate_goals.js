...
function main(customerId, operations) {
  // [START googleads_v24_generated_GoalService_MutateGoals_async]
  /**
  ...
  const {GoalServiceClient} = require('google-ads').v24;
  ...
  callMutateGoals();
  // [END googleads_v24_generated_GoalService_MutateGoals_async]
}
