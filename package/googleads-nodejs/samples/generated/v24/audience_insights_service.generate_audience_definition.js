...
function main(customerId, audienceDescription) {
  // [START googleads_v24_generated_AudienceInsightsService_GenerateAudienceDefinition_async]
  /**
  ...
  async function callGenerateAudienceDefinition() {
    // Construct request
    const request = {
      customerId,
      audienceDescription,
    ...
    // Run request
    const response = await googleadsClient.generateAudienceDefinition(request);
    console.log(response);
  }

  callGenerateAudienceDefinition();
  // [END googleads_v24_generated_AudienceInsightsService_GenerateAudienceDefinition_async]
}
