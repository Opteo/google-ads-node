...
function main(customerId, operations) {
  // [START googleads_v24_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
  /**
  ...
  const {KeywordPlanAdGroupKeywordServiceClient} = require('google-ads').v24;
  ...
  // [END googleads_v24_generated_KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_async]
}
