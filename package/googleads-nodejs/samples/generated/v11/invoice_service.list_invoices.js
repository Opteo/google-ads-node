...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v11_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v11;
  ...
  callListInvoices();
  // [END googleads_v11_generated_InvoiceService_ListInvoices_async]
}
