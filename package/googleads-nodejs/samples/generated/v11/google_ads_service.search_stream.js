...
function main(customerId, query) {
  // [START googleads_v11_generated_GoogleAdsService_SearchStream_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v11;
  ...
  callSearchStream();
  // [END googleads_v11_generated_GoogleAdsService_SearchStream_async]
}
