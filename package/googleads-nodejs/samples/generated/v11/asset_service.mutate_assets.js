...
function main(customerId, operations) {
  // [START googleads_v11_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v11;
  ...
  callMutateAssets();
  // [END googleads_v11_generated_AssetService_MutateAssets_async]
}
