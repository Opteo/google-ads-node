...
function main(customerId, operations) {
  // [START googleads_v11_generated_CampaignBudgetService_MutateCampaignBudgets_async]
  /**
  ...
  const {CampaignBudgetServiceClient} = require('google-ads').v11;
  ...
  // [END googleads_v11_generated_CampaignBudgetService_MutateCampaignBudgets_async]
}
