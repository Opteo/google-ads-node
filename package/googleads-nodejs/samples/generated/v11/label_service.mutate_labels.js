...
function main(customerId, operations) {
  // [START googleads_v11_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v11;
  ...
  callMutateLabels();
  // [END googleads_v11_generated_LabelService_MutateLabels_async]
}
