...
function main(customerId, operations) {
  // [START googleads_v11_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
  /**
  ...
  const {CustomerNegativeCriterionServiceClient} = require('google-ads').v11;
  ...
  // [END googleads_v11_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
}
