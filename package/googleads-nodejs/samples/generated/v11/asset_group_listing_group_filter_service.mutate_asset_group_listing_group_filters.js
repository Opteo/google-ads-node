...
function main(customerId, operations) {
  // [START googleads_v11_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
  /**
  ...
  const {AssetGroupListingGroupFilterServiceClient} = require('google-ads').v11;
  ...
  // [END googleads_v11_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
}
