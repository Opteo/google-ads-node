...
function main(customerId, operations) {
  // [START googleads_v11_generated_UserListService_MutateUserLists_async]
  /**
  ...
  const {UserListServiceClient} = require('google-ads').v11;
  ...
  callMutateUserLists();
  // [END googleads_v11_generated_UserListService_MutateUserLists_async]
}
