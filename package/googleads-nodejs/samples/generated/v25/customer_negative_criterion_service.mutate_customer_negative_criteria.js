...
function main(customerId, operations) {
  // [START googleads_v25_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
  /**
  ...
  const {CustomerNegativeCriterionServiceClient} = require('google-ads').v25;
  ...
  // [END googleads_v25_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
}
