...
function main(customerId, operations) {
  // [START googleads_v25_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v25;
  ...
  callMutateAssets();
  // [END googleads_v25_generated_AssetService_MutateAssets_async]
}
