...
function main(customerId, customerInsightsGroup, countryLocations) {
  // [START googleads_v25_generated_ContentCreatorInsightsService_GenerateCreatorInsights_async]
  /**
   ...
   */
  // const countryLocations = [1,2,3,4]
  /**
  ...
  async function callGenerateCreatorInsights() {
    // Construct request
    const request = {
      customerId,
    ...
    // Run request
    const response = await googleadsClient.generateCreatorInsights(request);
    console.log(response);
  }

  callGenerateCreatorInsights();
  // [END googleads_v25_generated_ContentCreatorInsightsService_GenerateCreatorInsights_async]
}
