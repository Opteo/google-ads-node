...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v25_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v25;
  ...
  callListInvoices();
  // [END googleads_v25_generated_InvoiceService_ListInvoices_async]
}
