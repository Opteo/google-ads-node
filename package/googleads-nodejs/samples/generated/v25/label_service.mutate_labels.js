...
function main(customerId, operations) {
  // [START googleads_v25_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v25;
  ...
  callMutateLabels();
  // [END googleads_v25_generated_LabelService_MutateLabels_async]
}
