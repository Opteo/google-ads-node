...
function main(customerId, operations) {
  // [START googleads_v25_generated_GoalService_MutateGoals_async]
  /**
  ...
  const {GoalServiceClient} = require('google-ads').v25;
  ...
  callMutateGoals();
  // [END googleads_v25_generated_GoalService_MutateGoals_async]
}
