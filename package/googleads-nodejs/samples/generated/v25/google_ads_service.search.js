...
function main(customerId, query) {
  // [START googleads_v25_generated_GoogleAdsService_Search_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v25;
  ...
  callSearch();
  // [END googleads_v25_generated_GoogleAdsService_Search_async]
}
