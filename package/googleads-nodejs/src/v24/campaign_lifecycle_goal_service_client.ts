 ...
 */
import * as gapicConfig from './campaign_lifecycle_goal_service_client_config.json';
 ...
 * @memberof v24
 */
export class CampaignLifecycleGoalServiceClient {
  ...
  campaignLifecycleGoalServiceStub?: Promise<{ [name: string]: Function }>;
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof CampaignLifecycleGoalServiceClient;
    if (
  ...
  initialize() {
    ...
    // google.ads.googleads.v24.services.CampaignLifecycleGoalService.
    this.campaignLifecycleGoalServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    for (const methodName of campaignLifecycleGoalServiceStubMethods) {
      const callPromise = this.campaignLifecycleGoalServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   */
  configureCampaignLifecycleGoals(
    request?: protos.google.ads.googleads.v24.services.IConfigureCampaignLifecycleGoalsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v24.services.IConfigureCampaignLifecycleGoalsResponse,
      (
        | protos.google.ads.googleads.v24.services.IConfigureCampaignLifecycleGoalsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'configureCampaignLifecycleGoals response %j',
            response,
          );
