 ...
 */
import * as gapicConfig from './customer_lifecycle_goal_service_client_config.json';
 ...
 * @memberof v24
 */
export class CustomerLifecycleGoalServiceClient {
  ...
  customerLifecycleGoalServiceStub?: Promise<{ [name: string]: Function }>;
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof CustomerLifecycleGoalServiceClient;
    if (
  ...
  initialize() {
    ...
    // google.ads.googleads.v24.services.CustomerLifecycleGoalService.
    this.customerLifecycleGoalServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    for (const methodName of customerLifecycleGoalServiceStubMethods) {
      const callPromise = this.customerLifecycleGoalServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   */
  configureCustomerLifecycleGoals(
    request?: protos.google.ads.googleads.v24.services.IConfigureCustomerLifecycleGoalsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v24.services.IConfigureCustomerLifecycleGoalsResponse,
      (
        | protos.google.ads.googleads.v24.services.IConfigureCustomerLifecycleGoalsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'configureCustomerLifecycleGoals response %j',
            response,
          );
