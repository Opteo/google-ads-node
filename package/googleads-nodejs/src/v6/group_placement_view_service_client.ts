 ...
 * `src/v6/group_placement_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './group_placement_view_service_client_config.json';
 ...
 * @memberof v6
 */
export class GroupPlacementViewServiceClient {
  ...
  groupPlacementViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof GroupPlacementViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v6.services.GroupPlacementViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.groupPlacementViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v6.services.GroupPlacementViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v6.services.GroupPlacementViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const groupPlacementViewServiceStubMethods =
        ['getGroupPlacementView'];
    for (const methodName of groupPlacementViewServiceStubMethods) {
      const callPromise = this.groupPlacementViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getGroupPlacementView(
      request: protos.google.ads.googleads.v6.services.IGetGroupPlacementViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v6.resources.IGroupPlacementView,
        protos.google.ads.googleads.v6.services.IGetGroupPlacementViewRequest|undefined, {}|undefined
      ]>;
  getGroupPlacementView(
      request: protos.google.ads.googleads.v6.services.IGetGroupPlacementViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v6.resources.IGroupPlacementView,
          protos.google.ads.googleads.v6.services.IGetGroupPlacementViewRequest|null|undefined,
          {}|null|undefined>): void;
  getGroupPlacementView(
      request: protos.google.ads.googleads.v6.services.IGetGroupPlacementViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [GroupPlacementView]{@link google.ads.googleads.v6.resources.GroupPlacementView}.
 *   Please see the
