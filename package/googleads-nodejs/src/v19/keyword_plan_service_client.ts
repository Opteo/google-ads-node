 ...
 * `src/v19/keyword_plan_service_client_config.json`.
...
export class KeywordPlanServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v19.services.KeywordPlanService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordPlanServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v19.services.KeywordPlanService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v19.services.KeywordPlanService,
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v19.services.MutateKeywordPlansResponse|MutateKeywordPlansResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v19/keyword_plan_service.mutate_keyword_plans.js</caption>
 * region_tag:googleads_v19_generated_KeywordPlanService_MutateKeywordPlans_async
 */
  mutateKeywordPlans(
      request?: protos.google.ads.googleads.v19.services.IMutateKeywordPlansRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v19.services.IMutateKeywordPlansResponse,
        protos.google.ads.googleads.v19.services.IMutateKeywordPlansRequest|undefined, {}|undefined
      ]>;
  mutateKeywordPlans(
      request: protos.google.ads.googleads.v19.services.IMutateKeywordPlansRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v19.services.IMutateKeywordPlansResponse,
          protos.google.ads.googleads.v19.services.IMutateKeywordPlansRequest|null|undefined,
          {}|null|undefined>): void;
  mutateKeywordPlans(
      request: protos.google.ads.googleads.v19.services.IMutateKeywordPlansRequest,
      callback: Callback<
  ...
  mutateKeywordPlans(
    ...
    return this.innerApiCalls.mutateKeywordPlans(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.googleads.v19.services.IMutateKeywordPlansResponse,
        protos.google.ads.googleads.v19.services.IMutateKeywordPlansRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('mutateKeywordPlans response %j', response);
