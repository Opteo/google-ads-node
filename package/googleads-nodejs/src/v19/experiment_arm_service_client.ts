 ...
 * `src/v19/experiment_arm_service_client_config.json`.
...
export class ExperimentArmServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v19.services.ExperimentArmService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.experimentArmServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v19.services.ExperimentArmService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v19.services.ExperimentArmService,
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v19.services.MutateExperimentArmsResponse|MutateExperimentArmsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v19/experiment_arm_service.mutate_experiment_arms.js</caption>
 * region_tag:googleads_v19_generated_ExperimentArmService_MutateExperimentArms_async
 */
  mutateExperimentArms(
      request?: protos.google.ads.googleads.v19.services.IMutateExperimentArmsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v19.services.IMutateExperimentArmsResponse,
        protos.google.ads.googleads.v19.services.IMutateExperimentArmsRequest|undefined, {}|undefined
      ]>;
  mutateExperimentArms(
      request: protos.google.ads.googleads.v19.services.IMutateExperimentArmsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v19.services.IMutateExperimentArmsResponse,
          protos.google.ads.googleads.v19.services.IMutateExperimentArmsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateExperimentArms(
      request: protos.google.ads.googleads.v19.services.IMutateExperimentArmsRequest,
      callback: Callback<
  ...
  mutateExperimentArms(
    ...
    return this.innerApiCalls.mutateExperimentArms(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.googleads.v19.services.IMutateExperimentArmsResponse,
        protos.google.ads.googleads.v19.services.IMutateExperimentArmsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('mutateExperimentArms response %j', response);
