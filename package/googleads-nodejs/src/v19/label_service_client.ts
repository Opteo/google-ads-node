 ...
 * `src/v19/label_service_client_config.json`.
...
export class LabelServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v19.services.LabelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.labelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v19.services.LabelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v19.services.LabelService,
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v19.services.MutateLabelsResponse|MutateLabelsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v19/label_service.mutate_labels.js</caption>
 * region_tag:googleads_v19_generated_LabelService_MutateLabels_async
 */
  mutateLabels(
      request?: protos.google.ads.googleads.v19.services.IMutateLabelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v19.services.IMutateLabelsResponse,
        protos.google.ads.googleads.v19.services.IMutateLabelsRequest|undefined, {}|undefined
      ]>;
  mutateLabels(
      request: protos.google.ads.googleads.v19.services.IMutateLabelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v19.services.IMutateLabelsResponse,
          protos.google.ads.googleads.v19.services.IMutateLabelsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateLabels(
      request: protos.google.ads.googleads.v19.services.IMutateLabelsRequest,
      callback: Callback<
  ...
  mutateLabels(
    ...
    return this.innerApiCalls.mutateLabels(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.googleads.v19.services.IMutateLabelsResponse,
        protos.google.ads.googleads.v19.services.IMutateLabelsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('mutateLabels response %j', response);
