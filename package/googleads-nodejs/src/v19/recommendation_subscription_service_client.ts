 ...
 * `src/v19/recommendation_subscription_service_client_config.json`.
...
export class RecommendationSubscriptionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v19.services.RecommendationSubscriptionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.recommendationSubscriptionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v19.services.RecommendationSubscriptionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v19.services.RecommendationSubscriptionService,
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v19.services.MutateRecommendationSubscriptionResponse|MutateRecommendationSubscriptionResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v19/recommendation_subscription_service.mutate_recommendation_subscription.js</caption>
 * region_tag:googleads_v19_generated_RecommendationSubscriptionService_MutateRecommendationSubscription_async
 */
  mutateRecommendationSubscription(
      request?: protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionResponse,
        protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionRequest|undefined, {}|undefined
      ]>;
  mutateRecommendationSubscription(
      request: protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionResponse,
          protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionRequest|null|undefined,
          {}|null|undefined>): void;
  mutateRecommendationSubscription(
      request: protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionRequest,
      callback: Callback<
  ...
  mutateRecommendationSubscription(
    ...
    return this.innerApiCalls.mutateRecommendationSubscription(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionResponse,
        protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('mutateRecommendationSubscription response %j', response);
