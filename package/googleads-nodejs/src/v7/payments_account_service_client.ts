 ...
 * `src/v7/payments_account_service_client_config.json`.
...
export class PaymentsAccountServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.PaymentsAccountService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.PaymentsAccountService.
    this.paymentsAccountServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.PaymentsAccountService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.PaymentsAccountService,
 ...
 *   The first element of the array is an object representing [ListPaymentsAccountsResponse]{@link google.ads.googleads.v7.services.ListPaymentsAccountsResponse}.
 *   Please see the
