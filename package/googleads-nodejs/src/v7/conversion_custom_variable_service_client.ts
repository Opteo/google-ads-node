...
export class ConversionCustomVariableServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.ConversionCustomVariableService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionCustomVariableServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.ConversionCustomVariableService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.ConversionCustomVariableService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const conversionCustomVariableServiceStubMethods =
        ['getConversionCustomVariable', 'mutateConversionCustomVariables'];
  ...
  getConversionCustomVariable(
      request: protos.google.ads.googleads.v7.services.IGetConversionCustomVariableRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.IConversionCustomVariable,
        protos.google.ads.googleads.v7.services.IGetConversionCustomVariableRequest|undefined, {}|undefined
      ]>;
  getConversionCustomVariable(
      request: protos.google.ads.googleads.v7.services.IGetConversionCustomVariableRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.IConversionCustomVariable,
          protos.google.ads.googleads.v7.services.IGetConversionCustomVariableRequest|null|undefined,
          {}|null|undefined>): void;
  getConversionCustomVariable(
      request: protos.google.ads.googleads.v7.services.IGetConversionCustomVariableRequest,
      callback: Callback<
 ...
 */
  ...
  mutateConversionCustomVariables(
      request: protos.google.ads.googleads.v7.services.IMutateConversionCustomVariablesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.services.IMutateConversionCustomVariablesResponse,
        protos.google.ads.googleads.v7.services.IMutateConversionCustomVariablesRequest|undefined, {}|undefined
      ]>;
  mutateConversionCustomVariables(
      request: protos.google.ads.googleads.v7.services.IMutateConversionCustomVariablesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.services.IMutateConversionCustomVariablesResponse,
          protos.google.ads.googleads.v7.services.IMutateConversionCustomVariablesRequest|null|undefined,
          {}|null|undefined>): void;
  mutateConversionCustomVariables(
      request: protos.google.ads.googleads.v7.services.IMutateConversionCustomVariablesRequest,
      callback: Callback<
