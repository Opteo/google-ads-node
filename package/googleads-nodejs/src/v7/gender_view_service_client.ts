 ...
 * `src/v7/gender_view_service_client_config.json`.
...
export class GenderViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.GenderViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.GenderViewService.
    this.genderViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.GenderViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.GenderViewService,
 ...
 *   The first element of the array is an object representing [GenderView]{@link google.ads.googleads.v7.resources.GenderView}.
 *   Please see the
