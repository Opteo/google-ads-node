 ...
 * `src/v7/landing_page_view_service_client_config.json`.
...
export class LandingPageViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.LandingPageViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.LandingPageViewService.
    this.landingPageViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.LandingPageViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.LandingPageViewService,
 ...
 *   The first element of the array is an object representing [LandingPageView]{@link google.ads.googleads.v7.resources.LandingPageView}.
 *   Please see the
