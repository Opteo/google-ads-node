 ...
 * `src/v7/feed_placeholder_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './feed_placeholder_view_service_client_config.json';
 ...
 * @memberof v7
 */
export class FeedPlaceholderViewServiceClient {
  ...
  feedPlaceholderViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof FeedPlaceholderViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.FeedPlaceholderViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.FeedPlaceholderViewService.
    this.feedPlaceholderViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.FeedPlaceholderViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.FeedPlaceholderViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const feedPlaceholderViewServiceStubMethods =
        ['getFeedPlaceholderView'];
    for (const methodName of feedPlaceholderViewServiceStubMethods) {
      const callPromise = this.feedPlaceholderViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getFeedPlaceholderView(
      request: protos.google.ads.googleads.v7.services.IGetFeedPlaceholderViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.IFeedPlaceholderView,
        protos.google.ads.googleads.v7.services.IGetFeedPlaceholderViewRequest|undefined, {}|undefined
      ]>;
  getFeedPlaceholderView(
      request: protos.google.ads.googleads.v7.services.IGetFeedPlaceholderViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.IFeedPlaceholderView,
          protos.google.ads.googleads.v7.services.IGetFeedPlaceholderViewRequest|null|undefined,
          {}|null|undefined>): void;
  getFeedPlaceholderView(
      request: protos.google.ads.googleads.v7.services.IGetFeedPlaceholderViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [FeedPlaceholderView]{@link google.ads.googleads.v7.resources.FeedPlaceholderView}.
 *   Please see the
