 ...
 * `src/v7/group_placement_view_service_client_config.json`.
...
export class GroupPlacementViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.GroupPlacementViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.GroupPlacementViewService.
    this.groupPlacementViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.GroupPlacementViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.GroupPlacementViewService,
 ...
 *   The first element of the array is an object representing [GroupPlacementView]{@link google.ads.googleads.v7.resources.GroupPlacementView}.
 *   Please see the
