 ...
 * `src/v7/click_view_service_client_config.json`.
...
export class ClickViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.ClickViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.ClickViewService.
    this.clickViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.ClickViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.ClickViewService,
 ...
 *   The first element of the array is an object representing [ClickView]{@link google.ads.googleads.v7.resources.ClickView}.
 *   Please see the
