 ...
 * `src/v7/video_service_client_config.json`.
...
export class VideoServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.VideoService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.videoServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.VideoService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.VideoService,
 ...
 *   The first element of the array is an object representing [Video]{@link google.ads.googleads.v7.resources.Video}.
 *   Please see the
