 ...
 * `src/v7/campaign_simulation_service_client_config.json`.
...
export class CampaignSimulationServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.CampaignSimulationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignSimulationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.CampaignSimulationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.CampaignSimulationService,
  ...
  getCampaignSimulation(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v7.services.IGetCampaignSimulationRequest|undefined, {}|undefined
      ]>;
  getCampaignSimulation(
      request: protos.google.ads.googleads.v7.services.IGetCampaignSimulationRequest,
      options: CallOptions,
