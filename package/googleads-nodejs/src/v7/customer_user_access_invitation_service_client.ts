 ...
 * `src/v7/customer_user_access_invitation_service_client_config.json`.
...
export class CustomerUserAccessInvitationServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.CustomerUserAccessInvitationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.CustomerUserAccessInvitationService.
    this.customerUserAccessInvitationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.CustomerUserAccessInvitationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.CustomerUserAccessInvitationService,
  ...
  getCustomerUserAccessInvitation(
      ...
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.ICustomerUserAccessInvitation,
        protos.google.ads.googleads.v7.services.IGetCustomerUserAccessInvitationRequest|undefined, {}|undefined
      ]>;
  getCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v7.services.IGetCustomerUserAccessInvitationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.ICustomerUserAccessInvitation,
          protos.google.ads.googleads.v7.services.IGetCustomerUserAccessInvitationRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v7.services.IGetCustomerUserAccessInvitationRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CustomerUserAccessInvitation]{@link google.ads.googleads.v7.resources.CustomerUserAccessInvitation}.
 *   Please see the
 ...
 */
  ...
  mutateCustomerUserAccessInvitation(
      ...
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.services.IMutateCustomerUserAccessInvitationResponse,
        protos.google.ads.googleads.v7.services.IMutateCustomerUserAccessInvitationRequest|undefined, {}|undefined
      ]>;
  mutateCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v7.services.IMutateCustomerUserAccessInvitationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.services.IMutateCustomerUserAccessInvitationResponse,
          protos.google.ads.googleads.v7.services.IMutateCustomerUserAccessInvitationRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v7.services.IMutateCustomerUserAccessInvitationRequest,
      callback: Callback<
 ...
 * @param {google.ads.googleads.v7.services.CustomerUserAccessInvitationOperation} request.operation
 *   Required. The operation to perform on the access invitation
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomerUserAccessInvitationResponse]{@link google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
