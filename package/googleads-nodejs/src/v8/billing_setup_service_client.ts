...
export class BillingSetupServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.BillingSetupService', gapicConfig as gax.ClientConfig,
 ...
 *   The first element of the array is an object representing [BillingSetup]{@link google.ads.googleads.v8.resources.BillingSetup}.
 *   Please see the
 ...
 * @param {google.ads.googleads.v8.services.BillingSetupOperation} request.operation
 *   Required. The operation to perform.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateBillingSetupResponse]{@link google.ads.googleads.v8.services.MutateBillingSetupResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
