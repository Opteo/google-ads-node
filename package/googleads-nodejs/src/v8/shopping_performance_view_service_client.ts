...
export class ShoppingPerformanceViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.ShoppingPerformanceViewService', gapicConfig as gax.ClientConfig,
 ...
 *   The first element of the array is an object representing [ShoppingPerformanceView]{@link google.ads.googleads.v8.resources.ShoppingPerformanceView}.
 *   Please see the
