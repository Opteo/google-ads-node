...
export class GeoTargetConstantServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.GeoTargetConstantService', gapicConfig as gax.ClientConfig,
 ...
 *   The first element of the array is an object representing [GeoTargetConstant]{@link google.ads.googleads.v8.resources.GeoTargetConstant}.
 *   Please see the
 ...
 * @param {google.ads.googleads.v8.services.SuggestGeoTargetConstantsRequest.LocationNames} request.locationNames
 *   The location names to search by. At most 25 names can be set.
 * @param {google.ads.googleads.v8.services.SuggestGeoTargetConstantsRequest.GeoTargets} request.geoTargets
 *   The geo target constant resource names to filter by.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [SuggestGeoTargetConstantsResponse]{@link google.ads.googleads.v8.services.SuggestGeoTargetConstantsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
