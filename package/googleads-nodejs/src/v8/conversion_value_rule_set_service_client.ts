 ...
 * `src/v8/conversion_value_rule_set_service_client_config.json`.
...
export class ConversionValueRuleSetServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.ConversionValueRuleSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionValueRuleSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v8.services.ConversionValueRuleSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v8.services.ConversionValueRuleSetService,
  ...
  getConversionValueRuleSet(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v8.services.IGetConversionValueRuleSetRequest|undefined, {}|undefined
      ]>;
  getConversionValueRuleSet(
      request: protos.google.ads.googleads.v8.services.IGetConversionValueRuleSetRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateConversionValueRuleSetsResponse]{@link google.ads.googleads.v8.services.MutateConversionValueRuleSetsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
