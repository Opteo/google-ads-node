...
export class KeywordPlanIdeaServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.KeywordPlanIdeaService', gapicConfig as gax.ClientConfig,
 ...
 * @param {google.ads.googleads.v8.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork} request.keyword_planNetwork
 *   Targeting network.
 ...
 * @param {google.ads.googleads.v8.services.KeywordAndUrlSeed} request.keywordAndUrlSeed
 *   A Keyword and a specific Url to generate ideas from
 *   e.g. cars, www.example.com/cars.
 * @param {google.ads.googleads.v8.services.KeywordSeed} request.keywordSeed
 *   A Keyword or phrase to generate ideas from, e.g. cars.
 * @param {google.ads.googleads.v8.services.UrlSeed} request.urlSeed
 *   A specific url to generate ideas from, e.g. www.example.com/cars.
 * @param {google.ads.googleads.v8.services.SiteSeed} request.siteSeed
 *   The site to generate ideas from, e.g. www.example.com.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [GenerateKeywordIdeaResult]{@link google.ads.googleads.v8.services.GenerateKeywordIdeaResult}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [GenerateKeywordIdeaResult]{@link google.ads.googleads.v8.services.GenerateKeywordIdeaResult} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [GenerateKeywordIdeaResult]{@link google.ads.googleads.v8.services.GenerateKeywordIdeaResult}. The API will be called under the hood as needed, once per the page,
 ...
 */
  generateKeywordIdeasAsync(
      request?: protos.google.ads.googleads.v8.services.IGenerateKeywordIdeasRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.googleads.v8.services.IGenerateKeywordIdeaResult>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.generateKeywordIdeas.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.ads.googleads.v8.services.IGenerateKeywordIdeaResult>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
