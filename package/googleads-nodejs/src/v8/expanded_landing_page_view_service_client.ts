...
export class ExpandedLandingPageViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.ExpandedLandingPageViewService', gapicConfig as gax.ClientConfig,
 ...
 *   The first element of the array is an object representing [ExpandedLandingPageView]{@link google.ads.googleads.v8.resources.ExpandedLandingPageView}.
 *   Please see the
