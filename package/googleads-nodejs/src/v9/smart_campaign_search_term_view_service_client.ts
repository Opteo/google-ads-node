 ...
 */
import * as gapicConfig from './smart_campaign_search_term_view_service_client_config.json';
 ...
 * @memberof v9
 */
export class SmartCampaignSearchTermViewServiceClient {
  ...
  smartCampaignSearchTermViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof SmartCampaignSearchTermViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.SmartCampaignSearchTermViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.smartCampaignSearchTermViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.SmartCampaignSearchTermViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.SmartCampaignSearchTermViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const smartCampaignSearchTermViewServiceStubMethods =
        ['getSmartCampaignSearchTermView'];
    for (const methodName of smartCampaignSearchTermViewServiceStubMethods) {
      const callPromise = this.smartCampaignSearchTermViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getSmartCampaignSearchTermView(
      request?: protos.google.ads.googleads.v9.services.IGetSmartCampaignSearchTermViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.ISmartCampaignSearchTermView,
        protos.google.ads.googleads.v9.services.IGetSmartCampaignSearchTermViewRequest|undefined, {}|undefined
      ]>;
  getSmartCampaignSearchTermView(
      request: protos.google.ads.googleads.v9.services.IGetSmartCampaignSearchTermViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.ISmartCampaignSearchTermView,
          protos.google.ads.googleads.v9.services.IGetSmartCampaignSearchTermViewRequest|null|undefined,
          {}|null|undefined>): void;
  getSmartCampaignSearchTermView(
      request: protos.google.ads.googleads.v9.services.IGetSmartCampaignSearchTermViewRequest,
      callback: Callback<
