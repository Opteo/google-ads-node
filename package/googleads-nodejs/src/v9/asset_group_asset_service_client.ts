...
export class AssetGroupAssetServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.AssetGroupAssetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.assetGroupAssetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.AssetGroupAssetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.AssetGroupAssetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const assetGroupAssetServiceStubMethods =
        ['getAssetGroupAsset', 'mutateAssetGroupAssets'];
 ...
 */
  getAssetGroupAsset(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v9.services.IGetAssetGroupAssetRequest|undefined, {}|undefined
      ]>;
  getAssetGroupAsset(
      request: protos.google.ads.googleads.v9.services.IGetAssetGroupAssetRequest,
      options: CallOptions,
