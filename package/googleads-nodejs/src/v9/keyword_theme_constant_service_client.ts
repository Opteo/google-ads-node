...
export class KeywordThemeConstantServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.KeywordThemeConstantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordThemeConstantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.KeywordThemeConstantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.KeywordThemeConstantService,
 ...
 */
  getKeywordThemeConstant(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v9.services.IGetKeywordThemeConstantRequest|undefined, {}|undefined
      ]>;
  getKeywordThemeConstant(
      request: protos.google.ads.googleads.v9.services.IGetKeywordThemeConstantRequest,
      options: CallOptions,
