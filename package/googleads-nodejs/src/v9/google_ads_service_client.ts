...
export class GoogleAdsServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.GoogleAdsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.googleAdsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.GoogleAdsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.GoogleAdsService,
 ...
 */
  searchAsync(
      request?: protos.google.ads.googleads.v9.services.ISearchGoogleAdsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.googleads.v9.services.IGoogleAdsRow>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.search.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.ads.googleads.v9.services.IGoogleAdsRow>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
