...
export class ConversionValueRuleSetServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.ConversionValueRuleSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionValueRuleSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.ConversionValueRuleSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.ConversionValueRuleSetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const conversionValueRuleSetServiceStubMethods =
        ['getConversionValueRuleSet', 'mutateConversionValueRuleSets'];
 ...
 */
  getConversionValueRuleSet(
      request?: protos.google.ads.googleads.v9.services.IGetConversionValueRuleSetRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IConversionValueRuleSet,
        protos.google.ads.googleads.v9.services.IGetConversionValueRuleSetRequest|undefined, {}|undefined
      ]>;
  getConversionValueRuleSet(
      request: protos.google.ads.googleads.v9.services.IGetConversionValueRuleSetRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IConversionValueRuleSet,
          protos.google.ads.googleads.v9.services.IGetConversionValueRuleSetRequest|null|undefined,
          {}|null|undefined>): void;
  getConversionValueRuleSet(
      request: protos.google.ads.googleads.v9.services.IGetConversionValueRuleSetRequest,
      callback: Callback<
 ...
 */
  mutateConversionValueRuleSets(
      request?: protos.google.ads.googleads.v9.services.IMutateConversionValueRuleSetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateConversionValueRuleSetsResponse,
        protos.google.ads.googleads.v9.services.IMutateConversionValueRuleSetsRequest|undefined, {}|undefined
      ]>;
  mutateConversionValueRuleSets(
      request: protos.google.ads.googleads.v9.services.IMutateConversionValueRuleSetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateConversionValueRuleSetsResponse,
          protos.google.ads.googleads.v9.services.IMutateConversionValueRuleSetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateConversionValueRuleSets(
      request: protos.google.ads.googleads.v9.services.IMutateConversionValueRuleSetsRequest,
      callback: Callback<
