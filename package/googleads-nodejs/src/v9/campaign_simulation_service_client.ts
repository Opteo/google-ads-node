 ...
 */
import * as gapicConfig from './campaign_simulation_service_client_config.json';
 ...
 * @memberof v9
 */
export class CampaignSimulationServiceClient {
  ...
  campaignSimulationServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignSimulationServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CampaignSimulationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignSimulationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CampaignSimulationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CampaignSimulationService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignSimulationServiceStubMethods =
        ['getCampaignSimulation'];
    for (const methodName of campaignSimulationServiceStubMethods) {
      const callPromise = this.campaignSimulationServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getCampaignSimulation(
      request?: protos.google.ads.googleads.v9.services.IGetCampaignSimulationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.ICampaignSimulation,
        protos.google.ads.googleads.v9.services.IGetCampaignSimulationRequest|undefined, {}|undefined
      ]>;
  getCampaignSimulation(
      request: protos.google.ads.googleads.v9.services.IGetCampaignSimulationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.ICampaignSimulation,
          protos.google.ads.googleads.v9.services.IGetCampaignSimulationRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignSimulation(
      request: protos.google.ads.googleads.v9.services.IGetCampaignSimulationRequest,
      callback: Callback<
