...
export class BiddingStrategyServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.BiddingStrategyService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.biddingStrategyServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.BiddingStrategyService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.BiddingStrategyService,
