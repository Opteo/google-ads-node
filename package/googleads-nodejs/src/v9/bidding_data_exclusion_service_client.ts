...
export class BiddingDataExclusionServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.BiddingDataExclusionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.biddingDataExclusionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.BiddingDataExclusionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.BiddingDataExclusionService,
 ...
 */
  getBiddingDataExclusion(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v9.services.IGetBiddingDataExclusionRequest|undefined, {}|undefined
      ]>;
  getBiddingDataExclusion(
      request: protos.google.ads.googleads.v9.services.IGetBiddingDataExclusionRequest,
      options: CallOptions,
