 ...
 */
import * as gapicConfig from './detailed_demographic_service_client_config.json';
 ...
 * @memberof v9
 */
export class DetailedDemographicServiceClient {
  ...
  detailedDemographicServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof DetailedDemographicServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.DetailedDemographicService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.detailedDemographicServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.DetailedDemographicService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.DetailedDemographicService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const detailedDemographicServiceStubMethods =
        ['getDetailedDemographic'];
    for (const methodName of detailedDemographicServiceStubMethods) {
      const callPromise = this.detailedDemographicServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getDetailedDemographic(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v9.services.IGetDetailedDemographicRequest|undefined, {}|undefined
      ]>;
  getDetailedDemographic(
      request: protos.google.ads.googleads.v9.services.IGetDetailedDemographicRequest,
      options: CallOptions,
