 ...
 * `src/v25/automatically_created_asset_removal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './automatically_created_asset_removal_service_client_config.json';
 ...
 * @memberof v25
 */
export class AutomaticallyCreatedAssetRemovalServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof AutomaticallyCreatedAssetRemovalServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.AutomaticallyCreatedAssetRemovalService',
  ...
  initialize() {
    ...
    // google.ads.googleads.v25.services.AutomaticallyCreatedAssetRemovalService.
    this.automaticallyCreatedAssetRemovalServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    for (const methodName of automaticallyCreatedAssetRemovalServiceStubMethods) {
      const callPromise = this.automaticallyCreatedAssetRemovalServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.RemoveCampaignAutomaticallyCreatedAssetResponse|RemoveCampaignAutomaticallyCreatedAssetResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/automatically_created_asset_removal_service.remove_campaign_automatically_created_asset.js</caption>
   * region_tag:googleads_v25_generated_AutomaticallyCreatedAssetRemovalService_RemoveCampaignAutomaticallyCreatedAsset_async
   */
  removeCampaignAutomaticallyCreatedAsset(
    request?: protos.google.ads.googleads.v25.services.IRemoveCampaignAutomaticallyCreatedAssetRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IRemoveCampaignAutomaticallyCreatedAssetResponse,
      (
        | protos.google.ads.googleads.v25.services.IRemoveCampaignAutomaticallyCreatedAssetRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info(
      'removeCampaignAutomaticallyCreatedAsset request %j',
      request,
    );
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'removeCampaignAutomaticallyCreatedAsset response %j',
            response,
          );
