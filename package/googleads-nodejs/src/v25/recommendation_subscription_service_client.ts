 ...
 * `src/v25/recommendation_subscription_service_client_config.json`.
...
export class RecommendationSubscriptionServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof RecommendationSubscriptionServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.RecommendationSubscriptionService',
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.MutateRecommendationSubscriptionResponse|MutateRecommendationSubscriptionResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/recommendation_subscription_service.mutate_recommendation_subscription.js</caption>
   * region_tag:googleads_v25_generated_RecommendationSubscriptionService_MutateRecommendationSubscription_async
   */
  mutateRecommendationSubscription(
    request?: protos.google.ads.googleads.v25.services.IMutateRecommendationSubscriptionRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IMutateRecommendationSubscriptionResponse,
      (
        | protos.google.ads.googleads.v25.services.IMutateRecommendationSubscriptionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'mutateRecommendationSubscription response %j',
            response,
          );
