 ...
 * `src/v25/customer_negative_criterion_service_client_config.json`.
...
export class CustomerNegativeCriterionServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof CustomerNegativeCriterionServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.CustomerNegativeCriterionService',
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.MutateCustomerNegativeCriteriaResponse|MutateCustomerNegativeCriteriaResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/customer_negative_criterion_service.mutate_customer_negative_criteria.js</caption>
   * region_tag:googleads_v25_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async
   */
  mutateCustomerNegativeCriteria(
    request?: protos.google.ads.googleads.v25.services.IMutateCustomerNegativeCriteriaRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IMutateCustomerNegativeCriteriaResponse,
      (
        | protos.google.ads.googleads.v25.services.IMutateCustomerNegativeCriteriaRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'mutateCustomerNegativeCriteria response %j',
            response,
          );
