 ...
 * `src/v25/identity_verification_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './identity_verification_service_client_config.json';
 ...
 * @memberof v25
 */
export class IdentityVerificationServiceClient {
  ...
  identityVerificationServiceStub?: Promise<{ [name: string]: Function }>;
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof IdentityVerificationServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.IdentityVerificationService',
  ...
  initialize() {
    ...
    // google.ads.googleads.v25.services.IdentityVerificationService.
    this.identityVerificationServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    for (const methodName of identityVerificationServiceStubMethods) {
      const callPromise = this.identityVerificationServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   verification.
   * @param {google.ads.googleads.v25.enums.IdentityVerificationProgramEnum.IdentityVerificationProgram} request.verificationProgram
   ...
   * @example <caption>include:samples/generated/v25/identity_verification_service.start_identity_verification.js</caption>
   * region_tag:googleads_v25_generated_IdentityVerificationService_StartIdentityVerification_async
   */
  startIdentityVerification(
    request?: protos.google.ads.googleads.v25.services.IStartIdentityVerificationRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.protobuf.IEmpty,
      (
        | protos.google.ads.googleads.v25.services.IStartIdentityVerificationRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GetIdentityVerificationResponse|GetIdentityVerificationResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/identity_verification_service.get_identity_verification.js</caption>
   * region_tag:googleads_v25_generated_IdentityVerificationService_GetIdentityVerification_async
   */
  getIdentityVerification(
    request?: protos.google.ads.googleads.v25.services.IGetIdentityVerificationRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGetIdentityVerificationResponse,
      (
        | protos.google.ads.googleads.v25.services.IGetIdentityVerificationRequest
        | undefined
      ),
      {} | undefined,
    ]
