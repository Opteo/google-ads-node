 ...
 * `src/v25/customer_user_access_invitation_service_client_config.json`.
...
export class CustomerUserAccessInvitationServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof CustomerUserAccessInvitationServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.CustomerUserAccessInvitationService',
   ...
   * @param {google.ads.googleads.v25.services.CustomerUserAccessInvitationOperation} request.operation
   *   Required. The operation to perform on the access invitation
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.MutateCustomerUserAccessInvitationResponse|MutateCustomerUserAccessInvitationResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/customer_user_access_invitation_service.mutate_customer_user_access_invitation.js</caption>
   * region_tag:googleads_v25_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async
   */
  mutateCustomerUserAccessInvitation(
    request?: protos.google.ads.googleads.v25.services.IMutateCustomerUserAccessInvitationRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IMutateCustomerUserAccessInvitationResponse,
      (
        | protos.google.ads.googleads.v25.services.IMutateCustomerUserAccessInvitationRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'mutateCustomerUserAccessInvitation response %j',
            response,
          );
