 ...
 * `src/v25/asset_generation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './asset_generation_service_client_config.json';
 ...
 * @memberof v25
 */
export class AssetGenerationServiceClient {
  ...
  assetGenerationServiceStub?: Promise<{ [name: string]: Function }>;
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof AssetGenerationServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.AssetGenerationService',
  ...
  initialize() {
    ...
    // google.ads.googleads.v25.services.AssetGenerationService.
    this.assetGenerationServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    for (const methodName of assetGenerationServiceStubMethods) {
      const callPromise = this.assetGenerationServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   * @param {google.ads.googleads.v25.services.AssetGenerationExistingContext} [request.existingGenerationContext]
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GenerateTextResponse|GenerateTextResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/asset_generation_service.generate_text.js</caption>
   * region_tag:googleads_v25_generated_AssetGenerationService_GenerateText_async
   */
  generateText(
    request?: protos.google.ads.googleads.v25.services.IGenerateTextRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGenerateTextResponse,
      protos.google.ads.googleads.v25.services.IGenerateTextRequest | undefined,
      {} | undefined,
    ]
  >;
  generateText(
    ...
    callback: Callback<
      protos.google.ads.googleads.v25.services.IGenerateTextResponse,
      | protos.google.ads.googleads.v25.services.IGenerateTextRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   * @param {google.ads.googleads.v25.services.FinalUrlImageGenerationInput} [request.finalUrlGeneration]
   *   Optional. Generate images from a final url.
   * @param {google.ads.googleads.v25.services.FreeformImageGenerationInput} [request.freeformGeneration]
   *   Optional. Generate images from a freeform prompt.
   * @param {google.ads.googleads.v25.services.ProductRecontextGenerationImageInput} [request.productRecontextGeneration]
   *   Optional. Generate new images by recontextualizing existing product
   *   images.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GenerateImagesResponse|GenerateImagesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/asset_generation_service.generate_images.js</caption>
   * region_tag:googleads_v25_generated_AssetGenerationService_GenerateImages_async
   */
  generateImages(
    request?: protos.google.ads.googleads.v25.services.IGenerateImagesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGenerateImagesResponse,
      (
        | protos.google.ads.googleads.v25.services.IGenerateImagesRequest
        | undefined
      ),
      {} | undefined,
    ]
