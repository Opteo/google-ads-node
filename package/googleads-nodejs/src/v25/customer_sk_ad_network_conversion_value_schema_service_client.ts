 ...
 * `src/v25/customer_sk_ad_network_conversion_value_schema_service_client_config.json`.
...
export class CustomerSkAdNetworkConversionValueSchemaServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof CustomerSkAdNetworkConversionValueSchemaServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.CustomerSkAdNetworkConversionValueSchemaService',
  ...
  initialize() {
    ...
    for (const methodName of customerSkAdNetworkConversionValueSchemaServiceStubMethods) {
      const callPromise =
        this.customerSkAdNetworkConversionValueSchemaServiceStub.then(
          (stub) =>
            (...args: Array<{}>) => {
              if (this._terminated) {
   ...
   * @param {google.ads.googleads.v25.services.CustomerSkAdNetworkConversionValueSchemaOperation} request.operation
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.MutateCustomerSkAdNetworkConversionValueSchemaResponse|MutateCustomerSkAdNetworkConversionValueSchemaResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/customer_sk_ad_network_conversion_value_schema_service.mutate_customer_sk_ad_network_conversion_value_schema.js</caption>
   * region_tag:googleads_v25_generated_CustomerSkAdNetworkConversionValueSchemaService_MutateCustomerSkAdNetworkConversionValueSchema_async
   */
  mutateCustomerSkAdNetworkConversionValueSchema(
    request?: protos.google.ads.googleads.v25.services.IMutateCustomerSkAdNetworkConversionValueSchemaRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IMutateCustomerSkAdNetworkConversionValueSchemaResponse,
      (
        | protos.google.ads.googleads.v25.services.IMutateCustomerSkAdNetworkConversionValueSchemaRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info(
      'mutateCustomerSkAdNetworkConversionValueSchema request %j',
      request,
    );
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'mutateCustomerSkAdNetworkConversionValueSchema response %j',
            response,
          );
  ...
  close(): Promise<void> {
    if (
      ...
      return this.customerSkAdNetworkConversionValueSchemaServiceStub.then(
        (stub) => {
