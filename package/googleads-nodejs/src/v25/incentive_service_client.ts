 ...
 * `src/v25/incentive_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './incentive_service_client_config.json';
 ...
 * @memberof v25
 */
export class IncentiveServiceClient {
  ...
  incentiveServiceStub?: Promise<{ [name: string]: Function }>;
  ...
  constructor(
    ...
    const staticMembers = this.constructor as typeof IncentiveServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.IncentiveService',
  ...
  initialize() {
    ...
    // google.ads.googleads.v25.services.IncentiveService.
    this.incentiveServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    for (const methodName of incentiveServiceStubMethods) {
      const callPromise = this.incentiveServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   behalf of user.
   * @param {google.ads.googleads.v25.enums.IncentiveTypeEnum.IncentiveType} [request.incentiveType]
   *   Optional. The type of incentive to get.
   *   Defaults to ACQUISITION.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.FetchIncentiveResponse|FetchIncentiveResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/incentive_service.fetch_incentive.js</caption>
   * region_tag:googleads_v25_generated_IncentiveService_FetchIncentive_async
   */
  fetchIncentive(
    request?: protos.google.ads.googleads.v25.services.IFetchIncentiveRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IFetchIncentiveResponse,
      (
        | protos.google.ads.googleads.v25.services.IFetchIncentiveRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.ApplyIncentiveResponse|ApplyIncentiveResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/incentive_service.apply_incentive.js</caption>
   * region_tag:googleads_v25_generated_IncentiveService_ApplyIncentive_async
   */
  applyIncentive(
    request?: protos.google.ads.googleads.v25.services.IApplyIncentiveRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IApplyIncentiveResponse,
      (
        | protos.google.ads.googleads.v25.services.IApplyIncentiveRequest
        | undefined
      ),
      {} | undefined,
    ]
