 ...
 * `src/v25/shareable_preview_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './shareable_preview_service_client_config.json';
 ...
 * @memberof v25
 */
export class ShareablePreviewServiceClient {
  ...
  shareablePreviewServiceStub?: Promise<{ [name: string]: Function }>;
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof ShareablePreviewServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.ShareablePreviewService',
  ...
  initialize() {
    ...
    // google.ads.googleads.v25.services.ShareablePreviewService.
    this.shareablePreviewServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    for (const methodName of shareablePreviewServiceStubMethods) {
      const callPromise = this.shareablePreviewServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   * @param {google.ads.googleads.v25.actions.GenerateShareablePreviewsOperation} request.operation
   *   The operation to generate shareable previews.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GenerateShareablePreviewsResponse|GenerateShareablePreviewsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/shareable_preview_service.generate_shareable_previews.js</caption>
   * region_tag:googleads_v25_generated_ShareablePreviewService_GenerateShareablePreviews_async
   */
  generateShareablePreviews(
    request?: protos.google.ads.googleads.v25.services.IGenerateShareablePreviewsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGenerateShareablePreviewsResponse,
      (
        | protos.google.ads.googleads.v25.services.IGenerateShareablePreviewsRequest
        | undefined
      ),
      {} | undefined,
    ]
