 ...
 * `src/v25/audience_insights_service_client_config.json`.
...
export class AudienceInsightsServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof AudienceInsightsServiceClient;
    if (
    ...
    this.pathTemplates = {
      ...
      adGroupAdAssetCombinationViewPathTemplate:
      ...
      androidPrivacySharedKeyGoogleCampaignPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      androidPrivacySharedKeyGoogleNetworkTypePathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      appTopCombinationViewPathTemplate: new this._gaxModule.PathTemplate(
        'customers/{customer_id}/appTopCombinationViews/{ad_group_id}~{ad_id}~{asset_combination_category}',
      ),
      appliedIncentivePathTemplate: new this._gaxModule.PathTemplate(
      ...
      assetGroupListingGroupFilterPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      assetGroupTopCombinationViewPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      biddingSeasonalityAdjustmentPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      campaignAggregateAssetViewPathTemplate: new this._gaxModule.PathTemplate(
      ...
      campaignGoalConfigPathTemplate: new this._gaxModule.PathTemplate(
      ...
      campaignSearchTermViewPathTemplate: new this._gaxModule.PathTemplate(
      ...
      cartDataSalesViewPathTemplate: new this._gaxModule.PathTemplate(
      ...
      channelAggregateAssetViewPathTemplate: new this._gaxModule.PathTemplate(
      ...
      contentCriterionViewPathTemplate: new this._gaxModule.PathTemplate(
      ...
      conversionGoalCampaignConfigPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      customerSkAdNetworkConversionValueSchemaPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      customerUserAccessInvitationPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      dataLinkPathTemplate: new this._gaxModule.PathTemplate(
        'customers/{customer_id}/dataLinks/{product_link_id}~{data_link_id}',
      ),
      detailContentSuitabilityPlacementViewPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      dynamicSearchAdsSearchTermViewPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      finalUrlExpansionAssetViewPathTemplate: new this._gaxModule.PathTemplate(
      ...
      goalPathTemplate: new this._gaxModule.PathTemplate(
      ...
      groupContentSuitabilityPlacementViewPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      matchedLocationInterestViewPathTemplate: new this._gaxModule.PathTemplate(
      ...
      multiPartyAuthReviewPathTemplate: new this._gaxModule.PathTemplate(
        'customers/{customer_id}/multiPartyAuthReviews/{customer_invitation_id}',
      ),
      offlineConversionUploadClientSummaryPathTemplate:
        new this._gaxModule.PathTemplate(
          'customers/{customer_id}/offlineConversionUploadClientSummaries/{client}',
        ),
      offlineConversionUploadConversionActionSummaryPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      operatingSystemVersionConstantPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      performanceMaxPlacementViewPathTemplate: new this._gaxModule.PathTemplate(
      ...
      shoppingProductPathTemplate: new this._gaxModule.PathTemplate(
      ...
      targetingExpansionViewPathTemplate: new this._gaxModule.PathTemplate(
      ...
      travelActivityPerformanceViewPathTemplate:
        new this._gaxModule.PathTemplate(
      ...
      userListCustomerTypePathTemplate: new this._gaxModule.PathTemplate(
      ...
      videoEnhancementPathTemplate: new this._gaxModule.PathTemplate(
      ...
      youTubeVideoUploadPathTemplate: new this._gaxModule.PathTemplate(
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.AudienceInsightsService',
    ...
    this.audienceInsightsServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v25.services
   ...
   * @param {google.ads.googleads.v25.services.InsightsAudience} request.baselineAudience
   *   Required. A baseline audience for this report, typically all people in a
   *   region.
   * @param {google.ads.googleads.v25.services.InsightsAudience} request.specificAudience
   ...
   * @param {google.ads.googleads.v25.common.AdditionalApplicationInfo} [request.insightsApplicationInfo]
   *   Optional. Additional information on the application issuing the request.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GenerateInsightsFinderReportResponse|GenerateInsightsFinderReportResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/audience_insights_service.generate_insights_finder_report.js</caption>
   * region_tag:googleads_v25_generated_AudienceInsightsService_GenerateInsightsFinderReport_async
   */
  generateInsightsFinderReport(
    request?: protos.google.ads.googleads.v25.services.IGenerateInsightsFinderReportRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGenerateInsightsFinderReportResponse,
      (
        | protos.google.ads.googleads.v25.services.IGenerateInsightsFinderReportRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   * @param {google.ads.googleads.v25.common.LocationInfo} request.youtubeReachLocation
   ...
   * @param {google.ads.googleads.v25.services.KnowledgeGraphEntitySearchOptions} [request.knowledgeGraphEntitySearchOptions]
   *   Optional. Additional search options for Knowledge Graph Entities.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.ListAudienceInsightsAttributesResponse|ListAudienceInsightsAttributesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/audience_insights_service.list_audience_insights_attributes.js</caption>
   * region_tag:googleads_v25_generated_AudienceInsightsService_ListAudienceInsightsAttributes_async
   */
  listAudienceInsightsAttributes(
    request?: protos.google.ads.googleads.v25.services.IListAudienceInsightsAttributesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IListAudienceInsightsAttributesResponse,
      (
        | protos.google.ads.googleads.v25.services.IListAudienceInsightsAttributesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'listAudienceInsightsAttributes response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.ListInsightsEligibleDatesResponse|ListInsightsEligibleDatesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/audience_insights_service.list_insights_eligible_dates.js</caption>
   * region_tag:googleads_v25_generated_AudienceInsightsService_ListInsightsEligibleDates_async
   */
  listInsightsEligibleDates(
    request?: protos.google.ads.googleads.v25.services.IListInsightsEligibleDatesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IListInsightsEligibleDatesResponse,
      (
        | protos.google.ads.googleads.v25.services.IListInsightsEligibleDatesRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   * @param {string} request.customer_id
   *   Required. The ID of the customer.
   * @param {google.ads.googleads.v25.services.InsightsAudience} request.audience
   ...
   *
   *   Note that when an
   *   {@link protos.google.ads.googleads.v25.services.InsightsAudience.user_list|InsightsAudience.user_list}
   *   is requested:
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GenerateAudienceCompositionInsightsResponse|GenerateAudienceCompositionInsightsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/audience_insights_service.generate_audience_composition_insights.js</caption>
   * region_tag:googleads_v25_generated_AudienceInsightsService_GenerateAudienceCompositionInsights_async
   */
  generateAudienceCompositionInsights(
    request?: protos.google.ads.googleads.v25.services.IGenerateAudienceCompositionInsightsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGenerateAudienceCompositionInsightsResponse,
      (
        | protos.google.ads.googleads.v25.services.IGenerateAudienceCompositionInsightsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'generateAudienceCompositionInsights response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
   ...
   * @param {string} request.customer_id
   *   Required. The ID of the customer.
   * @param {google.ads.googleads.v25.services.InsightsAudienceDescription} request.audienceDescription
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GenerateAudienceDefinitionResponse|GenerateAudienceDefinitionResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/audience_insights_service.generate_audience_definition.js</caption>
   * region_tag:googleads_v25_generated_AudienceInsightsService_GenerateAudienceDefinition_async
   */
  generateAudienceDefinition(
    request?: protos.google.ads.googleads.v25.services.IGenerateAudienceDefinitionRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGenerateAudienceDefinitionResponse,
      (
        | protos.google.ads.googleads.v25.services.IGenerateAudienceDefinitionRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   * @param {google.ads.googleads.v25.common.AdditionalApplicationInfo} [request.insightsApplicationInfo]
   *   Optional. Additional information on the application issuing the request.
   * @param {google.ads.googleads.v25.services.InsightsAudienceDefinition} request.audienceDefinition
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GenerateSuggestedTargetingInsightsResponse|GenerateSuggestedTargetingInsightsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/audience_insights_service.generate_suggested_targeting_insights.js</caption>
   * region_tag:googleads_v25_generated_AudienceInsightsService_GenerateSuggestedTargetingInsights_async
   */
  generateSuggestedTargetingInsights(
    request?: protos.google.ads.googleads.v25.services.IGenerateSuggestedTargetingInsightsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGenerateSuggestedTargetingInsightsResponse,
      (
        | protos.google.ads.googleads.v25.services.IGenerateSuggestedTargetingInsightsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'generateSuggestedTargetingInsights response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
   ...
   * @param {string} request.customer_id
   *   Required. The ID of the customer.
   * @param {google.ads.googleads.v25.common.LocationInfo} request.countryLocation
   *   Required. The country in which to calculate the sizes and overlaps of
   *   audiences.
   * @param {google.ads.googleads.v25.common.AudienceInsightsAttribute} request.primaryAttribute
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GenerateAudienceOverlapInsightsResponse|GenerateAudienceOverlapInsightsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/audience_insights_service.generate_audience_overlap_insights.js</caption>
   * region_tag:googleads_v25_generated_AudienceInsightsService_GenerateAudienceOverlapInsights_async
   */
  generateAudienceOverlapInsights(
    request?: protos.google.ads.googleads.v25.services.IGenerateAudienceOverlapInsightsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGenerateAudienceOverlapInsightsResponse,
      (
        | protos.google.ads.googleads.v25.services.IGenerateAudienceOverlapInsightsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'generateAudienceOverlapInsights response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.GenerateTargetingSuggestionMetricsResponse|GenerateTargetingSuggestionMetricsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/audience_insights_service.generate_targeting_suggestion_metrics.js</caption>
   * region_tag:googleads_v25_generated_AudienceInsightsService_GenerateTargetingSuggestionMetrics_async
   */
  generateTargetingSuggestionMetrics(
    request?: protos.google.ads.googleads.v25.services.IGenerateTargetingSuggestionMetricsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IGenerateTargetingSuggestionMetricsResponse,
      (
        | protos.google.ads.googleads.v25.services.IGenerateTargetingSuggestionMetricsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'generateTargetingSuggestionMetrics response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
   ...
   */
  matchCustomerIdFromAccessibleBiddingStrategyName(
    accessibleBiddingStrategyName: string,
  ) {
    return this.pathTemplates.accessibleBiddingStrategyPathTemplate.match(
      accessibleBiddingStrategyName,
    ).customer_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  accountBudgetProposalPath(
    customerId: string,
    accountBudgetProposalId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAccountBudgetProposalName(
    accountBudgetProposalName: string,
  ) {
    return this.pathTemplates.accountBudgetProposalPathTemplate.match(
   ...
   */
  matchAccountBudgetProposalIdFromAccountBudgetProposalName(
    accountBudgetProposalName: string,
  ) {
    return this.pathTemplates.accountBudgetProposalPathTemplate.match(
      accountBudgetProposalName,
   ...
   * @returns {string} Resource name string.
   */
  adGroupAdAssetCombinationViewPath(
    customerId: string,
    adGroupId: string,
    adId: string,
    assetCombinationIdLow: string,
    assetCombinationIdHigh: string,
  ) {
  ...
  matchCustomerIdFromAdGroupAdAssetCombinationViewName(
    adGroupAdAssetCombinationViewName: string,
  ) {
    return this.pathTemplates.adGroupAdAssetCombinationViewPathTemplate.match(
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromAdGroupAdAssetCombinationViewName(
    adGroupAdAssetCombinationViewName: string,
  ) {
    return this.pathTemplates.adGroupAdAssetCombinationViewPathTemplate.match(
      adGroupAdAssetCombinationViewName,
   ...
   * @returns {string} A string representing the ad_id.
   */
  matchAdIdFromAdGroupAdAssetCombinationViewName(
    adGroupAdAssetCombinationViewName: string,
  ) {
    return this.pathTemplates.adGroupAdAssetCombinationViewPathTemplate.match(
      adGroupAdAssetCombinationViewName,
   ...
   */
  matchAssetCombinationIdLowFromAdGroupAdAssetCombinationViewName(
    adGroupAdAssetCombinationViewName: string,
  ) {
    return this.pathTemplates.adGroupAdAssetCombinationViewPathTemplate.match(
      adGroupAdAssetCombinationViewName,
   ...
   */
  matchAssetCombinationIdHighFromAdGroupAdAssetCombinationViewName(
    adGroupAdAssetCombinationViewName: string,
  ) {
    return this.pathTemplates.adGroupAdAssetCombinationViewPathTemplate.match(
      adGroupAdAssetCombinationViewName,
  ...
  matchCustomerIdFromAdGroupAdAssetViewName(adGroupAdAssetViewName: string) {
    return this.pathTemplates.adGroupAdAssetViewPathTemplate.match(
  ...
  matchCustomerIdFromAdGroupAdLabelName(adGroupAdLabelName: string) {
    return this.pathTemplates.adGroupAdLabelPathTemplate.match(
      adGroupAdLabelName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromAdGroupAssetSetName(adGroupAssetSetName: string) {
    return this.pathTemplates.adGroupAssetSetPathTemplate.match(
      adGroupAssetSetName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromAdGroupAudienceViewName(adGroupAudienceViewName: string) {
    return this.pathTemplates.adGroupAudienceViewPathTemplate.match(
  ...
  matchCustomerIdFromAdGroupBidModifierName(adGroupBidModifierName: string) {
    return this.pathTemplates.adGroupBidModifierPathTemplate.match(
  ...
  matchCustomerIdFromAdGroupCriterionName(adGroupCriterionName: string) {
    return this.pathTemplates.adGroupCriterionPathTemplate.match(
   ...
   * @returns {string} Resource name string.
   */
  adGroupCriterionCustomizerPath(
    customerId: string,
    adGroupId: string,
    criterionId: string,
    customizerAttributeId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAdGroupCriterionCustomizerName(
    adGroupCriterionCustomizerName: string,
  ) {
    return this.pathTemplates.adGroupCriterionCustomizerPathTemplate.match(
      adGroupCriterionCustomizerName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromAdGroupCriterionCustomizerName(
    adGroupCriterionCustomizerName: string,
  ) {
    return this.pathTemplates.adGroupCriterionCustomizerPathTemplate.match(
      adGroupCriterionCustomizerName,
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromAdGroupCriterionCustomizerName(
    adGroupCriterionCustomizerName: string,
  ) {
    return this.pathTemplates.adGroupCriterionCustomizerPathTemplate.match(
      adGroupCriterionCustomizerName,
   ...
   */
  matchCustomizerAttributeIdFromAdGroupCriterionCustomizerName(
    adGroupCriterionCustomizerName: string,
  ) {
    return this.pathTemplates.adGroupCriterionCustomizerPathTemplate.match(
      adGroupCriterionCustomizerName,
  ...
  matchCustomerIdFromAdGroupCriterionLabelName(
    adGroupCriterionLabelName: string,
  ) {
    return this.pathTemplates.adGroupCriterionLabelPathTemplate.match(
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromAdGroupCriterionLabelName(
    adGroupCriterionLabelName: string,
  ) {
    return this.pathTemplates.adGroupCriterionLabelPathTemplate.match(
      adGroupCriterionLabelName,
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromAdGroupCriterionLabelName(
    adGroupCriterionLabelName: string,
  ) {
    return this.pathTemplates.adGroupCriterionLabelPathTemplate.match(
      adGroupCriterionLabelName,
   ...
   * @returns {string} Resource name string.
   */
  adGroupCriterionSimulationPath(
    customerId: string,
    adGroupId: string,
    criterionId: string,
    type: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAdGroupCriterionSimulationName(
    adGroupCriterionSimulationName: string,
  ) {
    return this.pathTemplates.adGroupCriterionSimulationPathTemplate.match(
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromAdGroupCriterionSimulationName(
    adGroupCriterionSimulationName: string,
  ) {
    return this.pathTemplates.adGroupCriterionSimulationPathTemplate.match(
      adGroupCriterionSimulationName,
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromAdGroupCriterionSimulationName(
    adGroupCriterionSimulationName: string,
  ) {
    return this.pathTemplates.adGroupCriterionSimulationPathTemplate.match(
      adGroupCriterionSimulationName,
   ...
   */
  matchTypeFromAdGroupCriterionSimulationName(
    adGroupCriterionSimulationName: string,
  ) {
    return this.pathTemplates.adGroupCriterionSimulationPathTemplate.match(
      adGroupCriterionSimulationName,
   ...
   */
  matchModificationMethodFromAdGroupCriterionSimulationName(
    adGroupCriterionSimulationName: string,
  ) {
    return this.pathTemplates.adGroupCriterionSimulationPathTemplate.match(
      adGroupCriterionSimulationName,
   ...
   */
  matchStartDateFromAdGroupCriterionSimulationName(
    adGroupCriterionSimulationName: string,
  ) {
    return this.pathTemplates.adGroupCriterionSimulationPathTemplate.match(
      adGroupCriterionSimulationName,
   ...
   */
  matchEndDateFromAdGroupCriterionSimulationName(
    adGroupCriterionSimulationName: string,
  ) {
    return this.pathTemplates.adGroupCriterionSimulationPathTemplate.match(
      adGroupCriterionSimulationName,
  ...
  matchCustomerIdFromAdGroupCustomizerName(adGroupCustomizerName: string) {
    return this.pathTemplates.adGroupCustomizerPathTemplate.match(
   ...
   * @returns {string} A string representing the customizer_attribute_id.
   */
  matchCustomizerAttributeIdFromAdGroupCustomizerName(
    adGroupCustomizerName: string,
  ) {
    return this.pathTemplates.adGroupCustomizerPathTemplate.match(
      adGroupCustomizerName,
    ).customizer_attribute_id;
  ...
  matchCustomerIdFromAdGroupSimulationName(adGroupSimulationName: string) {
    return this.pathTemplates.adGroupSimulationPathTemplate.match(
   ...
   * @returns {string} A string representing the modification_method.
   */
  matchModificationMethodFromAdGroupSimulationName(
    adGroupSimulationName: string,
  ) {
    return this.pathTemplates.adGroupSimulationPathTemplate.match(
      adGroupSimulationName,
    ).modification_method;
  ...
  matchCustomerIdFromAdScheduleViewName(adScheduleViewName: string) {
    return this.pathTemplates.adScheduleViewPathTemplate.match(
      adScheduleViewName,
    ).customer_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  aiMaxSearchTermAdCombinationViewPath(
    customerId: string,
    adGroupId: string,
    searchTerm: string,
    landingPage: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAiMaxSearchTermAdCombinationViewName(
    aiMaxSearchTermAdCombinationViewName: string,
  ) {
    return this.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match(
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromAiMaxSearchTermAdCombinationViewName(
    aiMaxSearchTermAdCombinationViewName: string,
  ) {
    return this.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match(
      aiMaxSearchTermAdCombinationViewName,
   ...
   */
  matchSearchTermFromAiMaxSearchTermAdCombinationViewName(
    aiMaxSearchTermAdCombinationViewName: string,
  ) {
    return this.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match(
      aiMaxSearchTermAdCombinationViewName,
   ...
   */
  matchLandingPageFromAiMaxSearchTermAdCombinationViewName(
    aiMaxSearchTermAdCombinationViewName: string,
  ) {
    return this.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match(
      aiMaxSearchTermAdCombinationViewName,
   ...
   */
  matchHeadlineFromAiMaxSearchTermAdCombinationViewName(
    aiMaxSearchTermAdCombinationViewName: string,
  ) {
    return this.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match(
      aiMaxSearchTermAdCombinationViewName,
   ...
   * @returns {string} Resource name string.
   */
  androidPrivacySharedKeyGoogleAdGroupPath(
    customerId: string,
    campaignId: string,
    adGroupId: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAndroidPrivacySharedKeyGoogleAdGroupName(
    androidPrivacySharedKeyGoogleAdGroupName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleAdGroupPathTemplate.match(
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromAndroidPrivacySharedKeyGoogleAdGroupName(
    androidPrivacySharedKeyGoogleAdGroupName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleAdGroupPathTemplate.match(
      androidPrivacySharedKeyGoogleAdGroupName,
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromAndroidPrivacySharedKeyGoogleAdGroupName(
    androidPrivacySharedKeyGoogleAdGroupName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleAdGroupPathTemplate.match(
      androidPrivacySharedKeyGoogleAdGroupName,
   ...
   */
  matchAndroidPrivacyInteractionTypeFromAndroidPrivacySharedKeyGoogleAdGroupName(
    androidPrivacySharedKeyGoogleAdGroupName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleAdGroupPathTemplate.match(
      androidPrivacySharedKeyGoogleAdGroupName,
   ...
   */
  matchAndroidPrivacyNetworkTypeFromAndroidPrivacySharedKeyGoogleAdGroupName(
    androidPrivacySharedKeyGoogleAdGroupName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleAdGroupPathTemplate.match(
      androidPrivacySharedKeyGoogleAdGroupName,
   ...
   */
  matchAndroidPrivacyInteractionDateFromAndroidPrivacySharedKeyGoogleAdGroupName(
    androidPrivacySharedKeyGoogleAdGroupName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleAdGroupPathTemplate.match(
      androidPrivacySharedKeyGoogleAdGroupName,
   ...
   * @returns {string} Resource name string.
   */
  androidPrivacySharedKeyGoogleCampaignPath(
    customerId: string,
    campaignId: string,
    androidPrivacyInteractionType: string,
    androidPrivacyInteractionDate: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAndroidPrivacySharedKeyGoogleCampaignName(
    androidPrivacySharedKeyGoogleCampaignName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleCampaignPathTemplate.match(
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromAndroidPrivacySharedKeyGoogleCampaignName(
    androidPrivacySharedKeyGoogleCampaignName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleCampaignPathTemplate.match(
      androidPrivacySharedKeyGoogleCampaignName,
   ...
   * @returns {string} A string representing the android_privacy_interaction_type.
   */
  matchAndroidPrivacyInteractionTypeFromAndroidPrivacySharedKeyGoogleCampaignName(
    androidPrivacySharedKeyGoogleCampaignName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleCampaignPathTemplate.match(
      androidPrivacySharedKeyGoogleCampaignName,
   ...
   * @returns {string} A string representing the android_privacy_interaction_date.
   */
  matchAndroidPrivacyInteractionDateFromAndroidPrivacySharedKeyGoogleCampaignName(
    androidPrivacySharedKeyGoogleCampaignName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleCampaignPathTemplate.match(
      androidPrivacySharedKeyGoogleCampaignName,
   ...
   * @returns {string} Resource name string.
   */
  androidPrivacySharedKeyGoogleNetworkTypePath(
    customerId: string,
    campaignId: string,
    androidPrivacyInteractionType: string,
    androidPrivacyNetworkType: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAndroidPrivacySharedKeyGoogleNetworkTypeName(
    androidPrivacySharedKeyGoogleNetworkTypeName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleNetworkTypePathTemplate.match(
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromAndroidPrivacySharedKeyGoogleNetworkTypeName(
    androidPrivacySharedKeyGoogleNetworkTypeName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleNetworkTypePathTemplate.match(
      androidPrivacySharedKeyGoogleNetworkTypeName,
   ...
   * @returns {string} A string representing the android_privacy_interaction_type.
   */
  matchAndroidPrivacyInteractionTypeFromAndroidPrivacySharedKeyGoogleNetworkTypeName(
    androidPrivacySharedKeyGoogleNetworkTypeName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleNetworkTypePathTemplate.match(
      androidPrivacySharedKeyGoogleNetworkTypeName,
   ...
   * @returns {string} A string representing the android_privacy_network_type.
   */
  matchAndroidPrivacyNetworkTypeFromAndroidPrivacySharedKeyGoogleNetworkTypeName(
    androidPrivacySharedKeyGoogleNetworkTypeName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleNetworkTypePathTemplate.match(
      androidPrivacySharedKeyGoogleNetworkTypeName,
   ...
   * @returns {string} A string representing the android_privacy_interaction_date.
   */
  matchAndroidPrivacyInteractionDateFromAndroidPrivacySharedKeyGoogleNetworkTypeName(
    androidPrivacySharedKeyGoogleNetworkTypeName: string,
  ) {
    return this.pathTemplates.androidPrivacySharedKeyGoogleNetworkTypePathTemplate.match(
      androidPrivacySharedKeyGoogleNetworkTypeName,
   ...
   * @returns {string} Resource name string.
   */
  appTopCombinationViewPath(
    customerId: string,
    adGroupId: string,
    adId: string,
    assetCombinationCategory: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAppTopCombinationViewName(
    appTopCombinationViewName: string,
  ) {
    return this.pathTemplates.appTopCombinationViewPathTemplate.match(
      appTopCombinationViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromAppTopCombinationViewName(
    appTopCombinationViewName: string,
  ) {
    return this.pathTemplates.appTopCombinationViewPathTemplate.match(
      appTopCombinationViewName,
   ...
   * @returns {string} A string representing the ad_id.
   */
  matchAdIdFromAppTopCombinationViewName(appTopCombinationViewName: string) {
    return this.pathTemplates.appTopCombinationViewPathTemplate.match(
      appTopCombinationViewName,
    ).ad_id;
  }
   ...
   */
  matchAssetCombinationCategoryFromAppTopCombinationViewName(
    appTopCombinationViewName: string,
  ) {
    return this.pathTemplates.appTopCombinationViewPathTemplate.match(
      appTopCombinationViewName,
   ...
   * @returns {string} Resource name string.
   */
  appliedIncentivePath(customerId: string, couponCode: string) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAppliedIncentiveName(appliedIncentiveName: string) {
    return this.pathTemplates.appliedIncentivePathTemplate.match(
   ...
   */
  matchCouponCodeFromAppliedIncentiveName(appliedIncentiveName: string) {
    return this.pathTemplates.appliedIncentivePathTemplate.match(
      appliedIncentiveName,
    ).coupon_code;
  }
  ...
  matchCustomerIdFromAssetFieldTypeViewName(assetFieldTypeViewName: string) {
    return this.pathTemplates.assetFieldTypeViewPathTemplate.match(
      assetFieldTypeViewName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromAssetGroupAssetName(assetGroupAssetName: string) {
    return this.pathTemplates.assetGroupAssetPathTemplate.match(
      assetGroupAssetName,
    ).customer_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  assetGroupListingGroupFilterPath(
    customerId: string,
    assetGroupId: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAssetGroupListingGroupFilterName(
    assetGroupListingGroupFilterName: string,
  ) {
    return this.pathTemplates.assetGroupListingGroupFilterPathTemplate.match(
   ...
   * @returns {string} A string representing the asset_group_id.
   */
  matchAssetGroupIdFromAssetGroupListingGroupFilterName(
    assetGroupListingGroupFilterName: string,
  ) {
    return this.pathTemplates.assetGroupListingGroupFilterPathTemplate.match(
      assetGroupListingGroupFilterName,
   ...
   */
  matchListingGroupFilterIdFromAssetGroupListingGroupFilterName(
    assetGroupListingGroupFilterName: string,
  ) {
    return this.pathTemplates.assetGroupListingGroupFilterPathTemplate.match(
      assetGroupListingGroupFilterName,
   ...
   * @returns {string} Resource name string.
   */
  assetGroupProductGroupViewPath(
    customerId: string,
    assetGroupId: string,
    listingGroupFilterId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAssetGroupProductGroupViewName(
    assetGroupProductGroupViewName: string,
  ) {
    return this.pathTemplates.assetGroupProductGroupViewPathTemplate.match(
   ...
   * @returns {string} A string representing the asset_group_id.
   */
  matchAssetGroupIdFromAssetGroupProductGroupViewName(
    assetGroupProductGroupViewName: string,
  ) {
    return this.pathTemplates.assetGroupProductGroupViewPathTemplate.match(
      assetGroupProductGroupViewName,
   ...
   * @returns {string} A string representing the listing_group_filter_id.
   */
  matchListingGroupFilterIdFromAssetGroupProductGroupViewName(
    assetGroupProductGroupViewName: string,
  ) {
    return this.pathTemplates.assetGroupProductGroupViewPathTemplate.match(
      assetGroupProductGroupViewName,
  ...
  matchCustomerIdFromAssetGroupSignalName(assetGroupSignalName: string) {
    return this.pathTemplates.assetGroupSignalPathTemplate.match(
      assetGroupSignalName,
    ).customer_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  assetGroupTopCombinationViewPath(
    customerId: string,
    assetGroupId: string,
    assetCombinationCategory: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromAssetGroupTopCombinationViewName(
    assetGroupTopCombinationViewName: string,
  ) {
    return this.pathTemplates.assetGroupTopCombinationViewPathTemplate.match(
      assetGroupTopCombinationViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the asset_group_id.
   */
  matchAssetGroupIdFromAssetGroupTopCombinationViewName(
    assetGroupTopCombinationViewName: string,
  ) {
    return this.pathTemplates.assetGroupTopCombinationViewPathTemplate.match(
      assetGroupTopCombinationViewName,
   ...
   * @returns {string} A string representing the asset_combination_category.
   */
  matchAssetCombinationCategoryFromAssetGroupTopCombinationViewName(
    assetGroupTopCombinationViewName: string,
  ) {
    return this.pathTemplates.assetGroupTopCombinationViewPathTemplate.match(
      assetGroupTopCombinationViewName,
  ...
  matchCustomerIdFromAssetSetTypeViewName(assetSetTypeViewName: string) {
    return this.pathTemplates.assetSetTypeViewPathTemplate.match(
      assetSetTypeViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromBiddingDataExclusionName(
    biddingDataExclusionName: string,
  ) {
    return this.pathTemplates.biddingDataExclusionPathTemplate.match(
      biddingDataExclusionName,
    ).customer_id;
  }
   ...
   */
  matchSeasonalityEventIdFromBiddingDataExclusionName(
    biddingDataExclusionName: string,
  ) {
    return this.pathTemplates.biddingDataExclusionPathTemplate.match(
      biddingDataExclusionName,
   ...
   * @returns {string} Resource name string.
   */
  biddingSeasonalityAdjustmentPath(
    customerId: string,
    seasonalityEventId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromBiddingSeasonalityAdjustmentName(
    biddingSeasonalityAdjustmentName: string,
  ) {
    return this.pathTemplates.biddingSeasonalityAdjustmentPathTemplate.match(
   ...
   * @returns {string} A string representing the seasonality_event_id.
   */
  matchSeasonalityEventIdFromBiddingSeasonalityAdjustmentName(
    biddingSeasonalityAdjustmentName: string,
  ) {
    return this.pathTemplates.biddingSeasonalityAdjustmentPathTemplate.match(
      biddingSeasonalityAdjustmentName,
  ...
  matchCustomerIdFromBiddingStrategyName(biddingStrategyName: string) {
    return this.pathTemplates.biddingStrategyPathTemplate.match(
      biddingStrategyName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromBiddingStrategySimulationName(
    biddingStrategySimulationName: string,
  ) {
    return this.pathTemplates.biddingStrategySimulationPathTemplate.match(
   ...
   * @returns {string} A string representing the bidding_strategy_id.
   */
  matchBiddingStrategyIdFromBiddingStrategySimulationName(
    biddingStrategySimulationName: string,
  ) {
    return this.pathTemplates.biddingStrategySimulationPathTemplate.match(
      biddingStrategySimulationName,
   ...
   * @returns {string} A string representing the type.
   */
  matchTypeFromBiddingStrategySimulationName(
    biddingStrategySimulationName: string,
  ) {
    return this.pathTemplates.biddingStrategySimulationPathTemplate.match(
      biddingStrategySimulationName,
   ...
   * @returns {string} A string representing the modification_method.
   */
  matchModificationMethodFromBiddingStrategySimulationName(
    biddingStrategySimulationName: string,
  ) {
    return this.pathTemplates.biddingStrategySimulationPathTemplate.match(
      biddingStrategySimulationName,
   ...
   * @returns {string} A string representing the start_date.
   */
  matchStartDateFromBiddingStrategySimulationName(
    biddingStrategySimulationName: string,
  ) {
    return this.pathTemplates.biddingStrategySimulationPathTemplate.match(
      biddingStrategySimulationName,
   ...
   * @returns {string} A string representing the end_date.
   */
  matchEndDateFromBiddingStrategySimulationName(
    biddingStrategySimulationName: string,
  ) {
    return this.pathTemplates.biddingStrategySimulationPathTemplate.match(
      biddingStrategySimulationName,
   ...
   * @returns {string} Resource name string.
   */
  campaignAggregateAssetViewPath(
    customerId: string,
    campaignId: string,
    assetId: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCampaignAggregateAssetViewName(
    campaignAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.campaignAggregateAssetViewPathTemplate.match(
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromCampaignAggregateAssetViewName(
    campaignAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.campaignAggregateAssetViewPathTemplate.match(
      campaignAggregateAssetViewName,
   ...
   * @returns {string} A string representing the asset_id.
   */
  matchAssetIdFromCampaignAggregateAssetViewName(
    campaignAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.campaignAggregateAssetViewPathTemplate.match(
      campaignAggregateAssetViewName,
   ...
   */
  matchAssetLinkSourceFromCampaignAggregateAssetViewName(
    campaignAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.campaignAggregateAssetViewPathTemplate.match(
      campaignAggregateAssetViewName,
   ...
   * @returns {string} A string representing the field_type.
   */
  matchFieldTypeFromCampaignAggregateAssetViewName(
    campaignAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.campaignAggregateAssetViewPathTemplate.match(
      campaignAggregateAssetViewName,
  ...
  matchCustomerIdFromCampaignAssetSetName(campaignAssetSetName: string) {
    return this.pathTemplates.campaignAssetSetPathTemplate.match(
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCampaignAudienceViewName(
    campaignAudienceViewName: string,
  ) {
    return this.pathTemplates.campaignAudienceViewPathTemplate.match(
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromCampaignAudienceViewName(
    campaignAudienceViewName: string,
  ) {
    return this.pathTemplates.campaignAudienceViewPathTemplate.match(
      campaignAudienceViewName,
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromCampaignAudienceViewName(
    campaignAudienceViewName: string,
  ) {
    return this.pathTemplates.campaignAudienceViewPathTemplate.match(
      campaignAudienceViewName,
  ...
  matchCustomerIdFromCampaignBidModifierName(campaignBidModifierName: string) {
    return this.pathTemplates.campaignBidModifierPathTemplate.match(
      campaignBidModifierName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromCampaignBudgetName(campaignBudgetName: string) {
    return this.pathTemplates.campaignBudgetPathTemplate.match(
      campaignBudgetName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCampaignConversionGoalName(
    campaignConversionGoalName: string,
  ) {
    return this.pathTemplates.campaignConversionGoalPathTemplate.match(
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromCampaignConversionGoalName(
    campaignConversionGoalName: string,
  ) {
    return this.pathTemplates.campaignConversionGoalPathTemplate.match(
      campaignConversionGoalName,
   ...
   */
  matchCategoryFromCampaignConversionGoalName(
    campaignConversionGoalName: string,
  ) {
    return this.pathTemplates.campaignConversionGoalPathTemplate.match(
      campaignConversionGoalName,
   ...
   */
  matchSourceFromCampaignConversionGoalName(
    campaignConversionGoalName: string,
  ) {
    return this.pathTemplates.campaignConversionGoalPathTemplate.match(
      campaignConversionGoalName,
  ...
  matchCustomerIdFromCampaignCriterionName(campaignCriterionName: string) {
    return this.pathTemplates.campaignCriterionPathTemplate.match(
  ...
  matchCustomerIdFromCampaignCustomizerName(campaignCustomizerName: string) {
    return this.pathTemplates.campaignCustomizerPathTemplate.match(
   ...
   * @returns {string} A string representing the customizer_attribute_id.
   */
  matchCustomizerAttributeIdFromCampaignCustomizerName(
    campaignCustomizerName: string,
  ) {
    return this.pathTemplates.campaignCustomizerPathTemplate.match(
      campaignCustomizerName,
    ).customizer_attribute_id;
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCampaignGoalConfigName(campaignGoalConfigName: string) {
    return this.pathTemplates.campaignGoalConfigPathTemplate.match(
      campaignGoalConfigName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromCampaignGoalConfigName(campaignGoalConfigName: string) {
    return this.pathTemplates.campaignGoalConfigPathTemplate.match(
      campaignGoalConfigName,
    ).campaign_id;
  }
   ...
   */
  matchUnifiedGoalIdFromCampaignGoalConfigName(campaignGoalConfigName: string) {
    return this.pathTemplates.campaignGoalConfigPathTemplate.match(
      campaignGoalConfigName,
    ).unified_goal_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCampaignSearchTermInsightName(
    campaignSearchTermInsightName: string,
  ) {
    return this.pathTemplates.campaignSearchTermInsightPathTemplate.match(
      campaignSearchTermInsightName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromCampaignSearchTermInsightName(
    campaignSearchTermInsightName: string,
  ) {
    return this.pathTemplates.campaignSearchTermInsightPathTemplate.match(
      campaignSearchTermInsightName,
   ...
   */
  matchClusterIdFromCampaignSearchTermInsightName(
    campaignSearchTermInsightName: string,
  ) {
    return this.pathTemplates.campaignSearchTermInsightPathTemplate.match(
      campaignSearchTermInsightName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCampaignSearchTermViewName(
    campaignSearchTermViewName: string,
  ) {
    return this.pathTemplates.campaignSearchTermViewPathTemplate.match(
      campaignSearchTermViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromCampaignSearchTermViewName(
    campaignSearchTermViewName: string,
  ) {
    return this.pathTemplates.campaignSearchTermViewPathTemplate.match(
      campaignSearchTermViewName,
   ...
   */
  matchQueryFromCampaignSearchTermViewName(campaignSearchTermViewName: string) {
    return this.pathTemplates.campaignSearchTermViewPathTemplate.match(
      campaignSearchTermViewName,
    ).query;
  }
  ...
  matchCustomerIdFromCampaignSharedSetName(campaignSharedSetName: string) {
    return this.pathTemplates.campaignSharedSetPathTemplate.match(
  ...
  matchCustomerIdFromCampaignSimulationName(campaignSimulationName: string) {
    return this.pathTemplates.campaignSimulationPathTemplate.match(
   ...
   * @returns {string} A string representing the modification_method.
   */
  matchModificationMethodFromCampaignSimulationName(
    campaignSimulationName: string,
  ) {
    return this.pathTemplates.campaignSimulationPathTemplate.match(
      campaignSimulationName,
    ).modification_method;
  ...
  matchCriterionIdFromCarrierConstantName(carrierConstantName: string) {
    return this.pathTemplates.carrierConstantPathTemplate.match(
      carrierConstantName,
    ).criterion_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  cartDataSalesViewPath(customerId: string) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCartDataSalesViewName(cartDataSalesViewName: string) {
    return this.pathTemplates.cartDataSalesViewPathTemplate.match(
      cartDataSalesViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromChannelAggregateAssetViewName(
    channelAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(
   ...
   */
  matchAdvertisingChannelTypeFromChannelAggregateAssetViewName(
    channelAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(
      channelAggregateAssetViewName,
   ...
   * @returns {string} A string representing the asset_id.
   */
  matchAssetIdFromChannelAggregateAssetViewName(
    channelAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(
      channelAggregateAssetViewName,
   ...
   */
  matchAssetSourceFromChannelAggregateAssetViewName(
    channelAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(
      channelAggregateAssetViewName,
   ...
   * @returns {string} A string representing the field_type.
   */
  matchFieldTypeFromChannelAggregateAssetViewName(
    channelAggregateAssetViewName: string,
  ) {
    return this.pathTemplates.channelAggregateAssetViewPathTemplate.match(
      channelAggregateAssetViewName,
  ...
  matchCustomerIdFromCombinedAudienceName(combinedAudienceName: string) {
    return this.pathTemplates.combinedAudiencePathTemplate.match(
   ...
   */
  matchCombinedAudienceIdFromCombinedAudienceName(
    combinedAudienceName: string,
  ) {
    return this.pathTemplates.combinedAudiencePathTemplate.match(
      combinedAudienceName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromContentCriterionViewName(
    contentCriterionViewName: string,
  ) {
    return this.pathTemplates.contentCriterionViewPathTemplate.match(
      contentCriterionViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromContentCriterionViewName(contentCriterionViewName: string) {
    return this.pathTemplates.contentCriterionViewPathTemplate.match(
      contentCriterionViewName,
    ).ad_group_id;
  }
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromContentCriterionViewName(
    contentCriterionViewName: string,
  ) {
    return this.pathTemplates.contentCriterionViewPathTemplate.match(
      contentCriterionViewName,
  ...
  matchCustomerIdFromConversionActionName(conversionActionName: string) {
    return this.pathTemplates.conversionActionPathTemplate.match(
   ...
   */
  matchConversionActionIdFromConversionActionName(
   ...
   * @returns {string} Resource name string.
   */
  conversionCustomVariablePath(
    customerId: string,
    conversionCustomVariableId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromConversionCustomVariableName(
    conversionCustomVariableName: string,
  ) {
    return this.pathTemplates.conversionCustomVariablePathTemplate.match(
      conversionCustomVariableName,
    ).customer_id;
  }
   ...
   */
  matchConversionCustomVariableIdFromConversionCustomVariableName(
    conversionCustomVariableName: string,
  ) {
    return this.pathTemplates.conversionCustomVariablePathTemplate.match(
      conversionCustomVariableName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromConversionGoalCampaignConfigName(
    conversionGoalCampaignConfigName: string,
  ) {
    return this.pathTemplates.conversionGoalCampaignConfigPathTemplate.match(
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromConversionGoalCampaignConfigName(
    conversionGoalCampaignConfigName: string,
  ) {
    return this.pathTemplates.conversionGoalCampaignConfigPathTemplate.match(
      conversionGoalCampaignConfigName,
  ...
  matchCustomerIdFromConversionValueRuleName(conversionValueRuleName: string) {
    return this.pathTemplates.conversionValueRulePathTemplate.match(
   ...
   */
  matchConversionValueRuleIdFromConversionValueRuleName(
    conversionValueRuleName: string,
  ) {
    return this.pathTemplates.conversionValueRulePathTemplate.match(
      conversionValueRuleName,
   ...
   * @returns {string} Resource name string.
   */
  conversionValueRuleSetPath(
    customerId: string,
    conversionValueRuleSetId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromConversionValueRuleSetName(
    conversionValueRuleSetName: string,
  ) {
    return this.pathTemplates.conversionValueRuleSetPathTemplate.match(
      conversionValueRuleSetName,
    ).customer_id;
  }
   ...
   */
  matchConversionValueRuleSetIdFromConversionValueRuleSetName(
    conversionValueRuleSetName: string,
  ) {
    return this.pathTemplates.conversionValueRuleSetPathTemplate.match(
      conversionValueRuleSetName,
  ...
  matchCodeFromCurrencyConstantName(currencyConstantName: string) {
    return this.pathTemplates.currencyConstantPathTemplate.match(
      currencyConstantName,
    ).code;
  }
  ...
  matchCustomerIdFromCustomAudienceName(customAudienceName: string) {
    return this.pathTemplates.customAudiencePathTemplate.match(
      customAudienceName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCustomConversionGoalName(
    customConversionGoalName: string,
  ) {
    return this.pathTemplates.customConversionGoalPathTemplate.match(
  ...
  matchCustomerIdFromCustomInterestName(customInterestName: string) {
    return this.pathTemplates.customInterestPathTemplate.match(
      customInterestName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromCustomerAssetSetName(customerAssetSetName: string) {
    return this.pathTemplates.customerAssetSetPathTemplate.match(
  ...
  matchCustomerIdFromCustomerClientName(customerClientName: string) {
    return this.pathTemplates.customerClientPathTemplate.match(
      customerClientName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromCustomerClientLinkName(customerClientLinkName: string) {
    return this.pathTemplates.customerClientLinkPathTemplate.match(
      customerClientLinkName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the client_customer_id.
   */
  matchClientCustomerIdFromCustomerClientLinkName(
    customerClientLinkName: string,
  ) {
    return this.pathTemplates.customerClientLinkPathTemplate.match(
      customerClientLinkName,
    ).client_customer_id;
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCustomerConversionGoalName(
    customerConversionGoalName: string,
  ) {
    return this.pathTemplates.customerConversionGoalPathTemplate.match(
      customerConversionGoalName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the category.
   */
  matchCategoryFromCustomerConversionGoalName(
    customerConversionGoalName: string,
  ) {
    return this.pathTemplates.customerConversionGoalPathTemplate.match(
      customerConversionGoalName,
   ...
   * @returns {string} A string representing the source.
   */
  matchSourceFromCustomerConversionGoalName(
    customerConversionGoalName: string,
  ) {
    return this.pathTemplates.customerConversionGoalPathTemplate.match(
      customerConversionGoalName,
  ...
  matchCustomerIdFromCustomerCustomizerName(customerCustomizerName: string) {
    return this.pathTemplates.customerCustomizerPathTemplate.match(
   ...
   * @returns {string} A string representing the customizer_attribute_id.
   */
  matchCustomizerAttributeIdFromCustomerCustomizerName(
    customerCustomizerName: string,
  ) {
    return this.pathTemplates.customerCustomizerPathTemplate.match(
      customerCustomizerName,
    ).customizer_attribute_id;
  ...
  matchCustomerIdFromCustomerManagerLinkName(customerManagerLinkName: string) {
    return this.pathTemplates.customerManagerLinkPathTemplate.match(
      customerManagerLinkName,
    ).customer_id;
  }
   ...
   */
  matchManagerCustomerIdFromCustomerManagerLinkName(
    customerManagerLinkName: string,
  ) {
    return this.pathTemplates.customerManagerLinkPathTemplate.match(
      customerManagerLinkName,
    ).manager_customer_id;
   ...
   * @returns {string} A string representing the manager_link_id.
   */
  matchManagerLinkIdFromCustomerManagerLinkName(
    customerManagerLinkName: string,
  ) {
    return this.pathTemplates.customerManagerLinkPathTemplate.match(
      customerManagerLinkName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCustomerNegativeCriterionName(
    customerNegativeCriterionName: string,
  ) {
    return this.pathTemplates.customerNegativeCriterionPathTemplate.match(
      customerNegativeCriterionName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromCustomerNegativeCriterionName(
    customerNegativeCriterionName: string,
  ) {
    return this.pathTemplates.customerNegativeCriterionPathTemplate.match(
      customerNegativeCriterionName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCustomerSearchTermInsightName(
    customerSearchTermInsightName: string,
  ) {
    return this.pathTemplates.customerSearchTermInsightPathTemplate.match(
      customerSearchTermInsightName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the cluster_id.
   */
  matchClusterIdFromCustomerSearchTermInsightName(
    customerSearchTermInsightName: string,
  ) {
    return this.pathTemplates.customerSearchTermInsightPathTemplate.match(
      customerSearchTermInsightName,
   ...
   * @returns {string} Resource name string.
   */
  customerSkAdNetworkConversionValueSchemaPath(
    customerId: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCustomerSkAdNetworkConversionValueSchemaName(
    customerSkAdNetworkConversionValueSchemaName: string,
  ) {
    return this.pathTemplates.customerSkAdNetworkConversionValueSchemaPathTemplate.match(
      customerSkAdNetworkConversionValueSchemaName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the account_link_id.
   */
  matchAccountLinkIdFromCustomerSkAdNetworkConversionValueSchemaName(
    customerSkAdNetworkConversionValueSchemaName: string,
  ) {
    return this.pathTemplates.customerSkAdNetworkConversionValueSchemaPathTemplate.match(
      customerSkAdNetworkConversionValueSchemaName,
  ...
  matchCustomerIdFromCustomerUserAccessName(customerUserAccessName: string) {
    return this.pathTemplates.customerUserAccessPathTemplate.match(
      customerUserAccessName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromCustomerUserAccessInvitationName(
    customerUserAccessInvitationName: string,
  ) {
    return this.pathTemplates.customerUserAccessInvitationPathTemplate.match(
   ...
   */
  matchInvitationIdFromCustomerUserAccessInvitationName(
    customerUserAccessInvitationName: string,
  ) {
    return this.pathTemplates.customerUserAccessInvitationPathTemplate.match(
      customerUserAccessInvitationName,
  ...
  matchCustomerIdFromCustomizerAttributeName(customizerAttributeName: string) {
    return this.pathTemplates.customizerAttributePathTemplate.match(
   ...
   * @returns {string} A string representing the customizer_attribute_id.
   */
  matchCustomizerAttributeIdFromCustomizerAttributeName(
   ...
   * @returns {string} Resource name string.
   */
  dataLinkPath(customerId: string, productLinkId: string, dataLinkId: string) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromDataLinkName(dataLinkName: string) {
   ...
   */
  matchProductLinkIdFromDataLinkName(dataLinkName: string) {
    return this.pathTemplates.dataLinkPathTemplate.match(dataLinkName)
      .product_link_id;
  }
   ...
   */
  matchDataLinkIdFromDataLinkName(dataLinkName: string) {
    return this.pathTemplates.dataLinkPathTemplate.match(dataLinkName)
      .data_link_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  detailContentSuitabilityPlacementViewPath(
    customerId: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromDetailContentSuitabilityPlacementViewName(
    detailContentSuitabilityPlacementViewName: string,
  ) {
    return this.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.match(
      detailContentSuitabilityPlacementViewName,
    ).customer_id;
  }
   ...
   */
  matchPlacementFingerprintFromDetailContentSuitabilityPlacementViewName(
    detailContentSuitabilityPlacementViewName: string,
  ) {
    return this.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.match(
      detailContentSuitabilityPlacementViewName,
  ...
  matchCustomerIdFromDetailPlacementViewName(detailPlacementViewName: string) {
    return this.pathTemplates.detailPlacementViewPathTemplate.match(
  ...
  matchCustomerIdFromDetailedDemographicName(detailedDemographicName: string) {
    return this.pathTemplates.detailedDemographicPathTemplate.match(
   ...
   */
  matchDetailedDemographicIdFromDetailedDemographicName(
    detailedDemographicName: string,
  ) {
    return this.pathTemplates.detailedDemographicPathTemplate.match(
      detailedDemographicName,
  ...
  matchCustomerIdFromDisplayKeywordViewName(displayKeywordViewName: string) {
    return this.pathTemplates.displayKeywordViewPathTemplate.match(
      displayKeywordViewName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromDomainCategoryName(domainCategoryName: string) {
    return this.pathTemplates.domainCategoryPathTemplate.match(
      domainCategoryName,
    ).customer_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  dynamicSearchAdsSearchTermViewPath(
    customerId: string,
    adGroupId: string,
    searchTermFingerprint: string,
    headlineFingerprint: string,
    landingPageFingerprint: string,
    pageUrlFingerprint: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromDynamicSearchAdsSearchTermViewName(
    dynamicSearchAdsSearchTermViewName: string,
  ) {
    return this.pathTemplates.dynamicSearchAdsSearchTermViewPathTemplate.match(
      dynamicSearchAdsSearchTermViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromDynamicSearchAdsSearchTermViewName(
    dynamicSearchAdsSearchTermViewName: string,
  ) {
    return this.pathTemplates.dynamicSearchAdsSearchTermViewPathTemplate.match(
      dynamicSearchAdsSearchTermViewName,
   ...
   */
  matchSearchTermFingerprintFromDynamicSearchAdsSearchTermViewName(
    dynamicSearchAdsSearchTermViewName: string,
  ) {
    return this.pathTemplates.dynamicSearchAdsSearchTermViewPathTemplate.match(
      dynamicSearchAdsSearchTermViewName,
   ...
   */
  matchHeadlineFingerprintFromDynamicSearchAdsSearchTermViewName(
    dynamicSearchAdsSearchTermViewName: string,
  ) {
    return this.pathTemplates.dynamicSearchAdsSearchTermViewPathTemplate.match(
      dynamicSearchAdsSearchTermViewName,
   ...
   */
  matchLandingPageFingerprintFromDynamicSearchAdsSearchTermViewName(
    dynamicSearchAdsSearchTermViewName: string,
  ) {
    return this.pathTemplates.dynamicSearchAdsSearchTermViewPathTemplate.match(
      dynamicSearchAdsSearchTermViewName,
   ...
   */
  matchPageUrlFingerprintFromDynamicSearchAdsSearchTermViewName(
    dynamicSearchAdsSearchTermViewName: string,
  ) {
    return this.pathTemplates.dynamicSearchAdsSearchTermViewPathTemplate.match(
      dynamicSearchAdsSearchTermViewName,
   ...
   * @returns {string} Resource name string.
   */
  expandedLandingPageViewPath(
    customerId: string,
    expandedFinalUrlFingerprint: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromExpandedLandingPageViewName(
    expandedLandingPageViewName: string,
  ) {
    return this.pathTemplates.expandedLandingPageViewPathTemplate.match(
   ...
   */
  matchExpandedFinalUrlFingerprintFromExpandedLandingPageViewName(
    expandedLandingPageViewName: string,
  ) {
    return this.pathTemplates.expandedLandingPageViewPathTemplate.match(
      expandedLandingPageViewName,
   ...
   * @returns {string} Resource name string.
   */
  finalUrlExpansionAssetViewPath(
    customerId: string,
    campaignId: string,
    assetId: string,
    fieldType: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromFinalUrlExpansionAssetViewName(
    finalUrlExpansionAssetViewName: string,
  ) {
    return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromFinalUrlExpansionAssetViewName(
    finalUrlExpansionAssetViewName: string,
  ) {
    return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(
      finalUrlExpansionAssetViewName,
   ...
   * @returns {string} A string representing the asset_id.
   */
  matchAssetIdFromFinalUrlExpansionAssetViewName(
    finalUrlExpansionAssetViewName: string,
  ) {
    return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(
      finalUrlExpansionAssetViewName,
   ...
   * @returns {string} A string representing the field_type.
   */
  matchFieldTypeFromFinalUrlExpansionAssetViewName(
    finalUrlExpansionAssetViewName: string,
  ) {
    return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(
      finalUrlExpansionAssetViewName,
   ...
   */
  matchUrlFpFromFinalUrlExpansionAssetViewName(
    finalUrlExpansionAssetViewName: string,
  ) {
    return this.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match(
      finalUrlExpansionAssetViewName,
  ...
  matchCriterionIdFromGeoTargetConstantName(geoTargetConstantName: string) {
    return this.pathTemplates.geoTargetConstantPathTemplate.match(
  ...
  matchCustomerIdFromGeographicViewName(geographicViewName: string) {
    return this.pathTemplates.geographicViewPathTemplate.match(
      geographicViewName,
    ).customer_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  goalPath(customerId: string, unifiedGoalId: string) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromGoalName(goalName: string) {
   ...
   * @returns {string} A string representing the unified_goal_id.
   */
  matchUnifiedGoalIdFromGoalName(goalName: string) {
  ...
  matchGoogleAdsFieldFromGoogleAdsFieldName(googleAdsFieldName: string) {
    return this.pathTemplates.googleAdsFieldPathTemplate.match(
      googleAdsFieldName,
    ).google_ads_field;
  }
   ...
   * @returns {string} Resource name string.
   */
  groupContentSuitabilityPlacementViewPath(
    customerId: string,
    placementFingerprint: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromGroupContentSuitabilityPlacementViewName(
    groupContentSuitabilityPlacementViewName: string,
  ) {
    return this.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.match(
      groupContentSuitabilityPlacementViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the placement_fingerprint.
   */
  matchPlacementFingerprintFromGroupContentSuitabilityPlacementViewName(
    groupContentSuitabilityPlacementViewName: string,
  ) {
    return this.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.match(
      groupContentSuitabilityPlacementViewName,
  ...
  matchCustomerIdFromGroupPlacementViewName(groupPlacementViewName: string) {
    return this.pathTemplates.groupPlacementViewPathTemplate.match(
  ...
  matchCustomerIdFromHotelGroupViewName(hotelGroupViewName: string) {
    return this.pathTemplates.hotelGroupViewPathTemplate.match(
      hotelGroupViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromHotelPerformanceViewName(
    hotelPerformanceViewName: string,
  ) {
    return this.pathTemplates.hotelPerformanceViewPathTemplate.match(
      hotelPerformanceViewName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromHotelReconciliationName(hotelReconciliationName: string) {
    return this.pathTemplates.hotelReconciliationPathTemplate.match(
      hotelReconciliationName,
    ).customer_id;
  }
   ...
   */
  matchCommissionIdFromHotelReconciliationName(
    hotelReconciliationName: string,
  ) {
    return this.pathTemplates.hotelReconciliationPathTemplate.match(
      hotelReconciliationName,
    ).commission_id;
  ...
  matchCustomerIdFromIncomeRangeViewName(incomeRangeViewName: string) {
    return this.pathTemplates.incomeRangeViewPathTemplate.match(
      incomeRangeViewName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromKeywordPlanAdGroupName(keywordPlanAdGroupName: string) {
    return this.pathTemplates.keywordPlanAdGroupPathTemplate.match(
      keywordPlanAdGroupName,
    ).customer_id;
  }
   ...
   */
  matchKeywordPlanAdGroupIdFromKeywordPlanAdGroupName(
    keywordPlanAdGroupName: string,
  ) {
    return this.pathTemplates.keywordPlanAdGroupPathTemplate.match(
      keywordPlanAdGroupName,
    ).keyword_plan_ad_group_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  keywordPlanAdGroupKeywordPath(
    customerId: string,
    keywordPlanAdGroupKeywordId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromKeywordPlanAdGroupKeywordName(
    keywordPlanAdGroupKeywordName: string,
  ) {
    return this.pathTemplates.keywordPlanAdGroupKeywordPathTemplate.match(
   ...
   */
  matchKeywordPlanAdGroupKeywordIdFromKeywordPlanAdGroupKeywordName(
    keywordPlanAdGroupKeywordName: string,
  ) {
    return this.pathTemplates.keywordPlanAdGroupKeywordPathTemplate.match(
      keywordPlanAdGroupKeywordName,
  ...
  matchCustomerIdFromKeywordPlanCampaignName(keywordPlanCampaignName: string) {
    return this.pathTemplates.keywordPlanCampaignPathTemplate.match(
   ...
   */
  matchKeywordPlanCampaignIdFromKeywordPlanCampaignName(
    keywordPlanCampaignName: string,
  ) {
    return this.pathTemplates.keywordPlanCampaignPathTemplate.match(
      keywordPlanCampaignName,
   ...
   * @returns {string} Resource name string.
   */
  keywordPlanCampaignKeywordPath(
    customerId: string,
    keywordPlanCampaignKeywordId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromKeywordPlanCampaignKeywordName(
    keywordPlanCampaignKeywordName: string,
  ) {
    return this.pathTemplates.keywordPlanCampaignKeywordPathTemplate.match(
      keywordPlanCampaignKeywordName,
    ).customer_id;
  }
   ...
   */
  matchKeywordPlanCampaignKeywordIdFromKeywordPlanCampaignKeywordName(
    keywordPlanCampaignKeywordName: string,
  ) {
    return this.pathTemplates.keywordPlanCampaignKeywordPathTemplate.match(
      keywordPlanCampaignKeywordName,
   ...
   * @returns {string} Resource name string.
   */
  keywordThemeConstantPath(
    expressCategoryId: string,
    expressSubCategoryId: string,
  ) {
   ...
   */
  matchExpressCategoryIdFromKeywordThemeConstantName(
    keywordThemeConstantName: string,
  ) {
    return this.pathTemplates.keywordThemeConstantPathTemplate.match(
   ...
   */
  matchExpressSubCategoryIdFromKeywordThemeConstantName(
    keywordThemeConstantName: string,
  ) {
    return this.pathTemplates.keywordThemeConstantPathTemplate.match(
      keywordThemeConstantName,
    ).express_sub_category_id;
  }
  ...
  landingPageViewPath(
    customerId: string,
    unexpandedFinalUrlFingerprint: string,
  ) {
  ...
  matchCustomerIdFromLandingPageViewName(landingPageViewName: string) {
    return this.pathTemplates.landingPageViewPathTemplate.match(
      landingPageViewName,
    ).customer_id;
  }
   ...
   */
  matchUnexpandedFinalUrlFingerprintFromLandingPageViewName(
    landingPageViewName: string,
  ) {
    return this.pathTemplates.landingPageViewPathTemplate.match(
      landingPageViewName,
  ...
  matchCriterionIdFromLanguageConstantName(languageConstantName: string) {
    return this.pathTemplates.languageConstantPathTemplate.match(
      languageConstantName,
    ).criterion_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  leadFormSubmissionDataPath(
    customerId: string,
    leadFormUserSubmissionId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLeadFormSubmissionDataName(
    leadFormSubmissionDataName: string,
  ) {
    return this.pathTemplates.leadFormSubmissionDataPathTemplate.match(
   ...
   */
  matchLeadFormUserSubmissionIdFromLeadFormSubmissionDataName(
    leadFormSubmissionDataName: string,
  ) {
    return this.pathTemplates.leadFormSubmissionDataPathTemplate.match(
      leadFormSubmissionDataName,
    ).lead_form_user_submission_id;
  }
  ...
  /**
   * Return a fully-qualified liftMeasurementAgeRange resource name string.
   *
   * @param {string} customer_id
   * @param {string} lift_measurement_configuration_id
   * @param {string} campaign_id
   * @param {string} criterion_id
   * @returns {string} Resource name string.
   */
  liftMeasurementAgeRangePath(
    customerId: string,
    liftMeasurementConfigurationId: string,
    campaignId: string,
    criterionId: string,
  ) {
    return this.pathTemplates.liftMeasurementAgeRangePathTemplate.render({
      customer_id: customerId,
  ...
  /**
   * Parse the customer_id from LiftMeasurementAgeRange resource.
   *
   * @param {string} liftMeasurementAgeRangeName
   *   A fully-qualified path representing LiftMeasurementAgeRange resource.
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLiftMeasurementAgeRangeName(
    liftMeasurementAgeRangeName: string,
  ) {
    return this.pathTemplates.liftMeasurementAgeRangePathTemplate.match(
      liftMeasurementAgeRangeName,
    ).customer_id;
  }

  /**
   * Parse the lift_measurement_configuration_id from LiftMeasurementAgeRange resource.
   *
   * @param {string} liftMeasurementAgeRangeName
   *   A fully-qualified path representing LiftMeasurementAgeRange resource.
   * @returns {string} A string representing the lift_measurement_configuration_id.
   */
  matchLiftMeasurementConfigurationIdFromLiftMeasurementAgeRangeName(
    liftMeasurementAgeRangeName: string,
  ) {
    return this.pathTemplates.liftMeasurementAgeRangePathTemplate.match(
      liftMeasurementAgeRangeName,
  ...
  /**
   * Parse the campaign_id from LiftMeasurementAgeRange resource.
   *
   * @param {string} liftMeasurementAgeRangeName
   *   A fully-qualified path representing LiftMeasurementAgeRange resource.
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromLiftMeasurementAgeRangeName(
    liftMeasurementAgeRangeName: string,
  ) {
    return this.pathTemplates.liftMeasurementAgeRangePathTemplate.match(
      liftMeasurementAgeRangeName,
  ...
  /**
   * Parse the criterion_id from LiftMeasurementAgeRange resource.
   *
   * @param {string} liftMeasurementAgeRangeName
   *   A fully-qualified path representing LiftMeasurementAgeRange resource.
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromLiftMeasurementAgeRangeName(
    liftMeasurementAgeRangeName: string,
  ) {
    return this.pathTemplates.liftMeasurementAgeRangePathTemplate.match(
      liftMeasurementAgeRangeName,
  ...
  /**
   * Return a fully-qualified liftMeasurementCampaign resource name string.
   *
   * @param {string} customer_id
   * @param {string} lift_measurement_configuration_id
   * @param {string} campaign_id
   * @returns {string} Resource name string.
   */
  liftMeasurementCampaignPath(
    customerId: string,
    liftMeasurementConfigurationId: string,
    campaignId: string,
  ) {
    return this.pathTemplates.liftMeasurementCampaignPathTemplate.render({
      customer_id: customerId,
      lift_measurement_configuration_id: liftMeasurementConfigurationId,
      campaign_id: campaignId,
    });
  ...
  /**
   * Parse the customer_id from LiftMeasurementCampaign resource.
   *
   * @param {string} liftMeasurementCampaignName
   *   A fully-qualified path representing LiftMeasurementCampaign resource.
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLiftMeasurementCampaignName(
    liftMeasurementCampaignName: string,
  ) {
    return this.pathTemplates.liftMeasurementCampaignPathTemplate.match(
      liftMeasurementCampaignName,
    ).customer_id;
  }

  /**
   * Parse the lift_measurement_configuration_id from LiftMeasurementCampaign resource.
   *
   * @param {string} liftMeasurementCampaignName
   *   A fully-qualified path representing LiftMeasurementCampaign resource.
   * @returns {string} A string representing the lift_measurement_configuration_id.
   */
  matchLiftMeasurementConfigurationIdFromLiftMeasurementCampaignName(
    liftMeasurementCampaignName: string,
  ) {
    return this.pathTemplates.liftMeasurementCampaignPathTemplate.match(
      liftMeasurementCampaignName,
  ...
  /**
   * Parse the campaign_id from LiftMeasurementCampaign resource.
   *
   * @param {string} liftMeasurementCampaignName
   *   A fully-qualified path representing LiftMeasurementCampaign resource.
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromLiftMeasurementCampaignName(
    liftMeasurementCampaignName: string,
  ) {
    return this.pathTemplates.liftMeasurementCampaignPathTemplate.match(
      liftMeasurementCampaignName,
  ...
  /**
   * Return a fully-qualified liftMeasurementConfig resource name string.
   *
   * @param {string} customer_id
   * @param {string} lift_measurement_configuration_id
   * @returns {string} Resource name string.
   */
  liftMeasurementConfigPath(
    customerId: string,
    liftMeasurementConfigurationId: string,
  ) {
    return this.pathTemplates.liftMeasurementConfigPathTemplate.render({
      customer_id: customerId,
      lift_measurement_configuration_id: liftMeasurementConfigurationId,
    });
  }
  ...
  /**
   * Parse the customer_id from LiftMeasurementConfig resource.
   *
   * @param {string} liftMeasurementConfigName
   *   A fully-qualified path representing LiftMeasurementConfig resource.
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLiftMeasurementConfigName(
    liftMeasurementConfigName: string,
  ) {
    return this.pathTemplates.liftMeasurementConfigPathTemplate.match(
      liftMeasurementConfigName,
    ).customer_id;
  }

  /**
   * Parse the lift_measurement_configuration_id from LiftMeasurementConfig resource.
   *
   * @param {string} liftMeasurementConfigName
   *   A fully-qualified path representing LiftMeasurementConfig resource.
   * @returns {string} A string representing the lift_measurement_configuration_id.
   */
  matchLiftMeasurementConfigurationIdFromLiftMeasurementConfigName(
    liftMeasurementConfigName: string,
  ) {
    return this.pathTemplates.liftMeasurementConfigPathTemplate.match(
      liftMeasurementConfigName,
  ...
  /**
   * Return a fully-qualified liftMeasurementDevice resource name string.
   *
   * @param {string} customer_id
   * @param {string} lift_measurement_configuration_id
   * @param {string} campaign_id
   ...
   * @returns {string} Resource name string.
   */
  liftMeasurementDevicePath(
    customerId: string,
    liftMeasurementConfigurationId: string,
    campaignId: string,
    criterionId: string,
  ) {
    return this.pathTemplates.liftMeasurementDevicePathTemplate.render({
      customer_id: customerId,
      lift_measurement_configuration_id: liftMeasurementConfigurationId,
      campaign_id: campaignId,
      criterion_id: criterionId,
  ...
  /**
   * Parse the customer_id from LiftMeasurementDevice resource.
   *
   * @param {string} liftMeasurementDeviceName
   *   A fully-qualified path representing LiftMeasurementDevice resource.
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLiftMeasurementDeviceName(
    liftMeasurementDeviceName: string,
  ) {
    return this.pathTemplates.liftMeasurementDevicePathTemplate.match(
      liftMeasurementDeviceName,
    ).customer_id;
  }

  /**
   * Parse the lift_measurement_configuration_id from LiftMeasurementDevice resource.
   *
   * @param {string} liftMeasurementDeviceName
   *   A fully-qualified path representing LiftMeasurementDevice resource.
   * @returns {string} A string representing the lift_measurement_configuration_id.
   */
  matchLiftMeasurementConfigurationIdFromLiftMeasurementDeviceName(
    liftMeasurementDeviceName: string,
  ) {
    return this.pathTemplates.liftMeasurementDevicePathTemplate.match(
      liftMeasurementDeviceName,
  ...
  /**
   * Parse the campaign_id from LiftMeasurementDevice resource.
   *
   * @param {string} liftMeasurementDeviceName
   *   A fully-qualified path representing LiftMeasurementDevice resource.
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromLiftMeasurementDeviceName(
    liftMeasurementDeviceName: string,
  ) {
    return this.pathTemplates.liftMeasurementDevicePathTemplate.match(
      liftMeasurementDeviceName,
  ...
  /**
   * Parse the criterion_id from LiftMeasurementDevice resource.
   *
   * @param {string} liftMeasurementDeviceName
   *   A fully-qualified path representing LiftMeasurementDevice resource.
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromLiftMeasurementDeviceName(
    liftMeasurementDeviceName: string,
  ) {
    return this.pathTemplates.liftMeasurementDevicePathTemplate.match(
      liftMeasurementDeviceName,
  ...
  /**
   * Return a fully-qualified liftMeasurementFlight resource name string.
   *
   * @param {string} customer_id
   * @param {string} lift_measurement_configuration_id
   * @param {string} lift_measurement_flight_id
   * @returns {string} Resource name string.
   */
  liftMeasurementFlightPath(
    customerId: string,
    liftMeasurementConfigurationId: string,
    liftMeasurementFlightId: string,
  ) {
    return this.pathTemplates.liftMeasurementFlightPathTemplate.render({
      customer_id: customerId,
      lift_measurement_configuration_id: liftMeasurementConfigurationId,
      lift_measurement_flight_id: liftMeasurementFlightId,
    });
  }

  /**
   * Parse the customer_id from LiftMeasurementFlight resource.
   *
   * @param {string} liftMeasurementFlightName
   *   A fully-qualified path representing LiftMeasurementFlight resource.
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLiftMeasurementFlightName(
    liftMeasurementFlightName: string,
  ) {
    return this.pathTemplates.liftMeasurementFlightPathTemplate.match(
      liftMeasurementFlightName,
    ).customer_id;
  }

  /**
   * Parse the lift_measurement_configuration_id from LiftMeasurementFlight resource.
   *
   * @param {string} liftMeasurementFlightName
   *   A fully-qualified path representing LiftMeasurementFlight resource.
   * @returns {string} A string representing the lift_measurement_configuration_id.
   */
  matchLiftMeasurementConfigurationIdFromLiftMeasurementFlightName(
    liftMeasurementFlightName: string,
  ) {
    return this.pathTemplates.liftMeasurementFlightPathTemplate.match(
      liftMeasurementFlightName,
  ...
  /**
   * Parse the lift_measurement_flight_id from LiftMeasurementFlight resource.
   *
   * @param {string} liftMeasurementFlightName
   *   A fully-qualified path representing LiftMeasurementFlight resource.
   * @returns {string} A string representing the lift_measurement_flight_id.
   */
  matchLiftMeasurementFlightIdFromLiftMeasurementFlightName(
    liftMeasurementFlightName: string,
  ) {
    return this.pathTemplates.liftMeasurementFlightPathTemplate.match(
      liftMeasurementFlightName,
  ...
  /**
   * Return a fully-qualified liftMeasurementGender resource name string.
   *
   * @param {string} customer_id
   * @param {string} lift_measurement_configuration_id
   * @param {string} campaign_id
   ...
   * @returns {string} Resource name string.
   */
  liftMeasurementGenderPath(
    customerId: string,
    liftMeasurementConfigurationId: string,
    campaignId: string,
    criterionId: string,
  ) {
    return this.pathTemplates.liftMeasurementGenderPathTemplate.render({
      customer_id: customerId,
      lift_measurement_configuration_id: liftMeasurementConfigurationId,
      campaign_id: campaignId,
      criterion_id: criterionId,
  ...
  /**
   * Parse the customer_id from LiftMeasurementGender resource.
   *
   * @param {string} liftMeasurementGenderName
   *   A fully-qualified path representing LiftMeasurementGender resource.
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLiftMeasurementGenderName(
    liftMeasurementGenderName: string,
  ) {
    return this.pathTemplates.liftMeasurementGenderPathTemplate.match(
      liftMeasurementGenderName,
    ).customer_id;
  }

  /**
   * Parse the lift_measurement_configuration_id from LiftMeasurementGender resource.
   *
   * @param {string} liftMeasurementGenderName
   *   A fully-qualified path representing LiftMeasurementGender resource.
   * @returns {string} A string representing the lift_measurement_configuration_id.
   */
  matchLiftMeasurementConfigurationIdFromLiftMeasurementGenderName(
    liftMeasurementGenderName: string,
  ) {
    return this.pathTemplates.liftMeasurementGenderPathTemplate.match(
      liftMeasurementGenderName,
  ...
  /**
   * Parse the campaign_id from LiftMeasurementGender resource.
   *
   * @param {string} liftMeasurementGenderName
   *   A fully-qualified path representing LiftMeasurementGender resource.
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromLiftMeasurementGenderName(
    liftMeasurementGenderName: string,
  ) {
    return this.pathTemplates.liftMeasurementGenderPathTemplate.match(
      liftMeasurementGenderName,
  ...
  /**
   * Parse the criterion_id from LiftMeasurementGender resource.
   *
   * @param {string} liftMeasurementGenderName
   *   A fully-qualified path representing LiftMeasurementGender resource.
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromLiftMeasurementGenderName(
    liftMeasurementGenderName: string,
  ) {
    return this.pathTemplates.liftMeasurementGenderPathTemplate.match(
      liftMeasurementGenderName,
  ...
  /**
   * Return a fully-qualified liftMeasurementVideo resource name string.
   *
   * @param {string} customer_id
   * @param {string} lift_measurement_configuration_id
   * @param {string} campaign_id
   * @param {string} external_video_id
   * @returns {string} Resource name string.
   */
  liftMeasurementVideoPath(
    customerId: string,
    liftMeasurementConfigurationId: string,
    campaignId: string,
    externalVideoId: string,
  ) {
    return this.pathTemplates.liftMeasurementVideoPathTemplate.render({
      customer_id: customerId,
      lift_measurement_configuration_id: liftMeasurementConfigurationId,
      campaign_id: campaignId,
  ...
  /**
   * Parse the customer_id from LiftMeasurementVideo resource.
   *
   * @param {string} liftMeasurementVideoName
   *   A fully-qualified path representing LiftMeasurementVideo resource.
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLiftMeasurementVideoName(
    liftMeasurementVideoName: string,
  ) {
    return this.pathTemplates.liftMeasurementVideoPathTemplate.match(
      liftMeasurementVideoName,
    ).customer_id;
  }

  /**
   * Parse the lift_measurement_configuration_id from LiftMeasurementVideo resource.
   *
   * @param {string} liftMeasurementVideoName
   *   A fully-qualified path representing LiftMeasurementVideo resource.
   * @returns {string} A string representing the lift_measurement_configuration_id.
   */
  matchLiftMeasurementConfigurationIdFromLiftMeasurementVideoName(
    liftMeasurementVideoName: string,
  ) {
    return this.pathTemplates.liftMeasurementVideoPathTemplate.match(
      liftMeasurementVideoName,
  ...
  /**
   * Parse the campaign_id from LiftMeasurementVideo resource.
   *
   * @param {string} liftMeasurementVideoName
   *   A fully-qualified path representing LiftMeasurementVideo resource.
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromLiftMeasurementVideoName(
    liftMeasurementVideoName: string,
  ) {
    return this.pathTemplates.liftMeasurementVideoPathTemplate.match(
      liftMeasurementVideoName,
  ...
  /**
   * Parse the external_video_id from LiftMeasurementVideo resource.
   *
   * @param {string} liftMeasurementVideoName
   *   A fully-qualified path representing LiftMeasurementVideo resource.
   * @returns {string} A string representing the external_video_id.
   */
  matchExternalVideoIdFromLiftMeasurementVideoName(
    liftMeasurementVideoName: string,
  ) {
    return this.pathTemplates.liftMeasurementVideoPathTemplate.match(
      liftMeasurementVideoName,
   ...
   * @returns {string} Resource name string.
   */
  localServicesEmployeePath(customerId: string, glsEmployeeId: string) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLocalServicesEmployeeName(
    localServicesEmployeeName: string,
  ) {
    return this.pathTemplates.localServicesEmployeePathTemplate.match(
      localServicesEmployeeName,
    ).customer_id;
  }
   ...
   */
  matchGlsEmployeeIdFromLocalServicesEmployeeName(
    localServicesEmployeeName: string,
  ) {
    return this.pathTemplates.localServicesEmployeePathTemplate.match(
      localServicesEmployeeName,
  ...
  matchCustomerIdFromLocalServicesLeadName(localServicesLeadName: string) {
    return this.pathTemplates.localServicesLeadPathTemplate.match(
   ...
   */
  matchLocalServicesLeadIdFromLocalServicesLeadName(
    localServicesLeadName: string,
  ) {
    return this.pathTemplates.localServicesLeadPathTemplate.match(
      localServicesLeadName,
   ...
   * @returns {string} Resource name string.
   */
  localServicesLeadConversationPath(
    customerId: string,
    localServicesLeadConversationId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLocalServicesLeadConversationName(
    localServicesLeadConversationName: string,
  ) {
    return this.pathTemplates.localServicesLeadConversationPathTemplate.match(
   ...
   */
  matchLocalServicesLeadConversationIdFromLocalServicesLeadConversationName(
    localServicesLeadConversationName: string,
  ) {
    return this.pathTemplates.localServicesLeadConversationPathTemplate.match(
      localServicesLeadConversationName,
   ...
   * @returns {string} Resource name string.
   */
  localServicesVerificationArtifactPath(
    customerId: string,
    glsVerificationArtifactId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLocalServicesVerificationArtifactName(
    localServicesVerificationArtifactName: string,
  ) {
    return this.pathTemplates.localServicesVerificationArtifactPathTemplate.match(
   ...
   */
  matchGlsVerificationArtifactIdFromLocalServicesVerificationArtifactName(
    localServicesVerificationArtifactName: string,
  ) {
    return this.pathTemplates.localServicesVerificationArtifactPathTemplate.match(
      localServicesVerificationArtifactName,
    ).gls_verification_artifact_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromLocationInterestViewName(
    locationInterestViewName: string,
  ) {
    return this.pathTemplates.locationInterestViewPathTemplate.match(
      locationInterestViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromLocationInterestViewName(
    locationInterestViewName: string,
  ) {
    return this.pathTemplates.locationInterestViewPathTemplate.match(
      locationInterestViewName,
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromLocationInterestViewName(locationInterestViewName: string) {
    return this.pathTemplates.locationInterestViewPathTemplate.match(
      locationInterestViewName,
    ).ad_group_id;
  }
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromLocationInterestViewName(
    locationInterestViewName: string,
  ) {
    return this.pathTemplates.locationInterestViewPathTemplate.match(
      locationInterestViewName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromManagedPlacementViewName(
    managedPlacementViewName: string,
  ) {
    return this.pathTemplates.managedPlacementViewPathTemplate.match(
      managedPlacementViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromManagedPlacementViewName(
    managedPlacementViewName: string,
  ) {
    return this.pathTemplates.managedPlacementViewPathTemplate.match(
      managedPlacementViewName,
   ...
   * @returns {string} Resource name string.
   */
  matchedLocationInterestViewPath(
    customerId: string,
    countryCriterionId: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromMatchedLocationInterestViewName(
    matchedLocationInterestViewName: string,
  ) {
    return this.pathTemplates.matchedLocationInterestViewPathTemplate.match(
      matchedLocationInterestViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the country_criterion_id.
   */
  matchCountryCriterionIdFromMatchedLocationInterestViewName(
    matchedLocationInterestViewName: string,
  ) {
    return this.pathTemplates.matchedLocationInterestViewPathTemplate.match(
      matchedLocationInterestViewName,
   ...
   */
  matchMobileAppCategoryIdFromMobileAppCategoryConstantName(
    mobileAppCategoryConstantName: string,
  ) {
    return this.pathTemplates.mobileAppCategoryConstantPathTemplate.match(
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromMobileDeviceConstantName(
    mobileDeviceConstantName: string,
  ) {
    return this.pathTemplates.mobileDeviceConstantPathTemplate.match(
      mobileDeviceConstantName,
    ).criterion_id;
  }

  /**
   * Return a fully-qualified multiPartyAuthReview resource name string.
   *
   * @param {string} customer_id
   * @param {string} customer_invitation_id
   * @returns {string} Resource name string.
   */
  multiPartyAuthReviewPath(customerId: string, customerInvitationId: string) {
    return this.pathTemplates.multiPartyAuthReviewPathTemplate.render({
      customer_id: customerId,
  ...
  /**
   * Parse the customer_id from MultiPartyAuthReview resource.
   *
   * @param {string} multiPartyAuthReviewName
   *   A fully-qualified path representing MultiPartyAuthReview resource.
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromMultiPartyAuthReviewName(
    multiPartyAuthReviewName: string,
  ) {
    return this.pathTemplates.multiPartyAuthReviewPathTemplate.match(
      multiPartyAuthReviewName,
    ).customer_id;
  }

  /**
   * Parse the customer_invitation_id from MultiPartyAuthReview resource.
   *
   * @param {string} multiPartyAuthReviewName
   *   A fully-qualified path representing MultiPartyAuthReview resource.
   * @returns {string} A string representing the customer_invitation_id.
   */
  matchCustomerInvitationIdFromMultiPartyAuthReviewName(
    multiPartyAuthReviewName: string,
  ) {
    return this.pathTemplates.multiPartyAuthReviewPathTemplate.match(
      multiPartyAuthReviewName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromOfflineConversionUploadClientSummaryName(
    offlineConversionUploadClientSummaryName: string,
  ) {
    return this.pathTemplates.offlineConversionUploadClientSummaryPathTemplate.match(
      offlineConversionUploadClientSummaryName,
    ).customer_id;
  }
   ...
   */
  matchClientFromOfflineConversionUploadClientSummaryName(
    offlineConversionUploadClientSummaryName: string,
  ) {
    return this.pathTemplates.offlineConversionUploadClientSummaryPathTemplate.match(
      offlineConversionUploadClientSummaryName,
   ...
   * @returns {string} Resource name string.
   */
  offlineConversionUploadConversionActionSummaryPath(
    customerId: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromOfflineConversionUploadConversionActionSummaryName(
    offlineConversionUploadConversionActionSummaryName: string,
  ) {
    return this.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.match(
   ...
   */
  matchConversionTypeIdFromOfflineConversionUploadConversionActionSummaryName(
    offlineConversionUploadConversionActionSummaryName: string,
  ) {
    return this.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.match(
      offlineConversionUploadConversionActionSummaryName,
   ...
   * @returns {string} A string representing the client.
   */
  matchClientFromOfflineConversionUploadConversionActionSummaryName(
    offlineConversionUploadConversionActionSummaryName: string,
  ) {
    return this.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.match(
      offlineConversionUploadConversionActionSummaryName,
  ...
  matchCustomerIdFromOfflineUserDataJobName(offlineUserDataJobName: string) {
    return this.pathTemplates.offlineUserDataJobPathTemplate.match(
   ...
   */
  matchOfflineUserDataUpdateIdFromOfflineUserDataJobName(
    offlineUserDataJobName: string,
  ) {
    return this.pathTemplates.offlineUserDataJobPathTemplate.match(
      offlineUserDataJobName,
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromOperatingSystemVersionConstantName(
    operatingSystemVersionConstantName: string,
  ) {
    return this.pathTemplates.operatingSystemVersionConstantPathTemplate.match(
      operatingSystemVersionConstantName,
    ).criterion_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromPaidOrganicSearchTermViewName(
    paidOrganicSearchTermViewName: string,
  ) {
    return this.pathTemplates.paidOrganicSearchTermViewPathTemplate.match(
      paidOrganicSearchTermViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromPaidOrganicSearchTermViewName(
    paidOrganicSearchTermViewName: string,
  ) {
    return this.pathTemplates.paidOrganicSearchTermViewPathTemplate.match(
      paidOrganicSearchTermViewName,
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromPaidOrganicSearchTermViewName(
    paidOrganicSearchTermViewName: string,
  ) {
    return this.pathTemplates.paidOrganicSearchTermViewPathTemplate.match(
      paidOrganicSearchTermViewName,
  ...
  matchCustomerIdFromParentalStatusViewName(parentalStatusViewName: string) {
    return this.pathTemplates.parentalStatusViewPathTemplate.match(
  ...
  matchCustomerIdFromPaymentsAccountName(paymentsAccountName: string) {
    return this.pathTemplates.paymentsAccountPathTemplate.match(
      paymentsAccountName,
    ).customer_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  performanceMaxPlacementViewPath(customerId: string) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromPerformanceMaxPlacementViewName(
    performanceMaxPlacementViewName: string,
  ) {
    return this.pathTemplates.performanceMaxPlacementViewPathTemplate.match(
      performanceMaxPlacementViewName,
    ).customer_id;
  }
   ...
   */
  matchLevelFromProductCategoryConstantName(
    productCategoryConstantName: string,
  ) {
    return this.pathTemplates.productCategoryConstantPathTemplate.match(
      productCategoryConstantName,
    ).level;
  }
   ...
   */
  matchCategoryIdFromProductCategoryConstantName(
    productCategoryConstantName: string,
  ) {
    return this.pathTemplates.productCategoryConstantPathTemplate.match(
      productCategoryConstantName,
  ...
  matchCustomerIdFromProductGroupViewName(productGroupViewName: string) {
    return this.pathTemplates.productGroupViewPathTemplate.match(
      productGroupViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromProductLinkInvitationName(
    productLinkInvitationName: string,
  ) {
    return this.pathTemplates.productLinkInvitationPathTemplate.match(
      productLinkInvitationName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_invitation_id.
   */
  matchCustomerInvitationIdFromProductLinkInvitationName(
    productLinkInvitationName: string,
  ) {
    return this.pathTemplates.productLinkInvitationPathTemplate.match(
      productLinkInvitationName,
   ...
   */
  matchQualifyingQuestionIdFromQualifyingQuestionName(
    qualifyingQuestionName: string,
  ) {
    return this.pathTemplates.qualifyingQuestionPathTemplate.match(
      qualifyingQuestionName,
   ...
   * @returns {string} Resource name string.
   */
  recommendationSubscriptionPath(
    customerId: string,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromRecommendationSubscriptionName(
    recommendationSubscriptionName: string,
  ) {
    return this.pathTemplates.recommendationSubscriptionPathTemplate.match(
      recommendationSubscriptionName,
    ).customer_id;
  }
   ...
   */
  matchRecommendationTypeFromRecommendationSubscriptionName(
    recommendationSubscriptionName: string,
  ) {
    return this.pathTemplates.recommendationSubscriptionPathTemplate.match(
      recommendationSubscriptionName,
  ...
  matchCustomerIdFromRemarketingActionName(remarketingActionName: string) {
    return this.pathTemplates.remarketingActionPathTemplate.match(
   ...
   */
  matchRemarketingActionIdFromRemarketingActionName(
    remarketingActionName: string,
  ) {
    return this.pathTemplates.remarketingActionPathTemplate.match(
      remarketingActionName,
  ...
  matchCustomerIdFromSearchTermViewName(searchTermViewName: string) {
    return this.pathTemplates.searchTermViewPathTemplate.match(
      searchTermViewName,
    ).customer_id;
  }
  ...
  matchCustomerIdFromSharedCriterionName(sharedCriterionName: string) {
    return this.pathTemplates.sharedCriterionPathTemplate.match(
      sharedCriterionName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromShoppingPerformanceViewName(
    shoppingPerformanceViewName: string,
  ) {
    return this.pathTemplates.shoppingPerformanceViewPathTemplate.match(
      shoppingPerformanceViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromShoppingProductName(shoppingProductName: string) {
    return this.pathTemplates.shoppingProductPathTemplate.match(
      shoppingProductName,
    ).customer_id;
  }
   ...
   */
  matchMerchantCenterIdFromShoppingProductName(shoppingProductName: string) {
    return this.pathTemplates.shoppingProductPathTemplate.match(
      shoppingProductName,
    ).merchant_center_id;
  }
   ...
   */
  matchChannelFromShoppingProductName(shoppingProductName: string) {
    return this.pathTemplates.shoppingProductPathTemplate.match(
      shoppingProductName,
    ).channel;
  }
   ...
   * @returns {string} A string representing the language_code.
   */
  matchLanguageCodeFromShoppingProductName(shoppingProductName: string) {
    return this.pathTemplates.shoppingProductPathTemplate.match(
      shoppingProductName,
    ).language_code;
  }
   ...
   */
  matchFeedLabelFromShoppingProductName(shoppingProductName: string) {
    return this.pathTemplates.shoppingProductPathTemplate.match(
      shoppingProductName,
    ).feed_label;
  }
   ...
   */
  matchItemIdFromShoppingProductName(shoppingProductName: string) {
    return this.pathTemplates.shoppingProductPathTemplate.match(
      shoppingProductName,
    ).item_id;
  }
   ...
   * @returns {string} Resource name string.
   */
  smartCampaignSearchTermViewPath(
    customerId: string,
    campaignId: string,
    query: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromSmartCampaignSearchTermViewName(
    smartCampaignSearchTermViewName: string,
  ) {
    return this.pathTemplates.smartCampaignSearchTermViewPathTemplate.match(
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromSmartCampaignSearchTermViewName(
    smartCampaignSearchTermViewName: string,
  ) {
    return this.pathTemplates.smartCampaignSearchTermViewPathTemplate.match(
      smartCampaignSearchTermViewName,
   ...
   * @returns {string} A string representing the query.
   */
  matchQueryFromSmartCampaignSearchTermViewName(
    smartCampaignSearchTermViewName: string,
  ) {
    return this.pathTemplates.smartCampaignSearchTermViewPathTemplate.match(
      smartCampaignSearchTermViewName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromSmartCampaignSettingName(
    smartCampaignSettingName: string,
  ) {
    return this.pathTemplates.smartCampaignSettingPathTemplate.match(
      smartCampaignSettingName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromSmartCampaignSettingName(
    smartCampaignSettingName: string,
  ) {
    return this.pathTemplates.smartCampaignSettingPathTemplate.match(
      smartCampaignSettingName,
   ...
   * @returns {string} Resource name string.
   */
  targetingExpansionViewPath(
    customerId: string,
    campaignId: string,
    targetingExpansionType: string,
  ) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromTargetingExpansionViewName(
    targetingExpansionViewName: string,
  ) {
    return this.pathTemplates.targetingExpansionViewPathTemplate.match(
      targetingExpansionViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the campaign_id.
   */
  matchCampaignIdFromTargetingExpansionViewName(
    targetingExpansionViewName: string,
  ) {
    return this.pathTemplates.targetingExpansionViewPathTemplate.match(
      targetingExpansionViewName,
   ...
   */
  matchTargetingExpansionTypeFromTargetingExpansionViewName(
    targetingExpansionViewName: string,
  ) {
    return this.pathTemplates.targetingExpansionViewPathTemplate.match(
      targetingExpansionViewName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromThirdPartyAppAnalyticsLinkName(
    thirdPartyAppAnalyticsLinkName: string,
  ) {
    return this.pathTemplates.thirdPartyAppAnalyticsLinkPathTemplate.match(
      thirdPartyAppAnalyticsLinkName,
    ).customer_id;
  }
   ...
   */
  matchCustomerLinkIdFromThirdPartyAppAnalyticsLinkName(
    thirdPartyAppAnalyticsLinkName: string,
  ) {
    return this.pathTemplates.thirdPartyAppAnalyticsLinkPathTemplate.match(
      thirdPartyAppAnalyticsLinkName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromTravelActivityGroupViewName(
    travelActivityGroupViewName: string,
  ) {
    return this.pathTemplates.travelActivityGroupViewPathTemplate.match(
      travelActivityGroupViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the ad_group_id.
   */
  matchAdGroupIdFromTravelActivityGroupViewName(
    travelActivityGroupViewName: string,
  ) {
    return this.pathTemplates.travelActivityGroupViewPathTemplate.match(
      travelActivityGroupViewName,
   ...
   * @returns {string} A string representing the criterion_id.
   */
  matchCriterionIdFromTravelActivityGroupViewName(
    travelActivityGroupViewName: string,
  ) {
    return this.pathTemplates.travelActivityGroupViewPathTemplate.match(
      travelActivityGroupViewName,
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromTravelActivityPerformanceViewName(
    travelActivityPerformanceViewName: string,
  ) {
    return this.pathTemplates.travelActivityPerformanceViewPathTemplate.match(
      travelActivityPerformanceViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromUserListCustomerTypeName(
    userListCustomerTypeName: string,
  ) {
    return this.pathTemplates.userListCustomerTypePathTemplate.match(
   ...
   * @returns {string} A string representing the user_list_id.
   */
  matchUserListIdFromUserListCustomerTypeName(
    userListCustomerTypeName: string,
  ) {
    return this.pathTemplates.userListCustomerTypePathTemplate.match(
      userListCustomerTypeName,
   ...
   */
  matchSemanticLabelFromUserListCustomerTypeName(
    userListCustomerTypeName: string,
  ) {
    return this.pathTemplates.userListCustomerTypePathTemplate.match(
      userListCustomerTypeName,
  ...
  matchCustomerIdFromUserLocationViewName(userLocationViewName: string) {
    return this.pathTemplates.userLocationViewPathTemplate.match(
      userLocationViewName,
    ).customer_id;
  }
   ...
   * @returns {string} A string representing the country_criterion_id.
   */
  matchCountryCriterionIdFromUserLocationViewName(
    userLocationViewName: string,
  ) {
    return this.pathTemplates.userLocationViewPathTemplate.match(
      userLocationViewName,
    ).country_criterion_id;
   ...
   */
  matchIsTargetingLocationFromUserLocationViewName(
    userLocationViewName: string,
  ) {
    return this.pathTemplates.userLocationViewPathTemplate.match(
      userLocationViewName,
   ...
   * @returns {string} Resource name string.
   */
  videoEnhancementPath(customerId: string, videoEnhancement: string) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromVideoEnhancementName(videoEnhancementName: string) {
    return this.pathTemplates.videoEnhancementPathTemplate.match(
      videoEnhancementName,
    ).customer_id;
  }
   ...
   */
  matchVideoEnhancementFromVideoEnhancementName(videoEnhancementName: string) {
    return this.pathTemplates.videoEnhancementPathTemplate.match(
      videoEnhancementName,
    ).video_enhancement;
  }
   ...
   * @returns {string} Resource name string.
   */
  youTubeVideoUploadPath(customerId: string, videoUploadId: string) {
   ...
   * @returns {string} A string representing the customer_id.
   */
  matchCustomerIdFromYouTubeVideoUploadName(youTubeVideoUploadName: string) {
    return this.pathTemplates.youTubeVideoUploadPathTemplate.match(
      youTubeVideoUploadName,
    ).customer_id;
  }
   ...
   */
  matchVideoUploadIdFromYouTubeVideoUploadName(youTubeVideoUploadName: string) {
    return this.pathTemplates.youTubeVideoUploadPathTemplate.match(
      youTubeVideoUploadName,
    ).video_upload_id;
  }
