 ...
 * `src/v25/goal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './goal_service_client_config.json';
...
export class GoalServiceClient {
  ...
  goalServiceStub?: Promise<{ [name: string]: Function }>;
  ...
  constructor(
    ...
    const staticMembers = this.constructor as typeof GoalServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.GoalService',
  ...
  initialize() {
    ...
    // google.ads.googleads.v25.services.GoalService.
    this.goalServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.googleads.v25.services.GoalService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v25.services.GoalService,
      this._opts,
      this._providedCustomServicePath,
    ...
    for (const methodName of goalServiceStubMethods) {
      const callPromise = this.goalServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.MutateGoalsResponse|MutateGoalsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/goal_service.mutate_goals.js</caption>
   * region_tag:googleads_v25_generated_GoalService_MutateGoals_async
   */
  mutateGoals(
    request?: protos.google.ads.googleads.v25.services.IMutateGoalsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IMutateGoalsResponse,
      protos.google.ads.googleads.v25.services.IMutateGoalsRequest | undefined,
      {} | undefined,
    ]
  >;
  mutateGoals(
    ...
    callback: Callback<
      protos.google.ads.googleads.v25.services.IMutateGoalsResponse,
      | protos.google.ads.googleads.v25.services.IMutateGoalsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
