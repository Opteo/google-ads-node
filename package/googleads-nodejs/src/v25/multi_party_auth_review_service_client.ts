 ...
 * `src/v25/multi_party_auth_review_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './multi_party_auth_review_service_client_config.json';
 ...
 * @memberof v25
 */
export class MultiPartyAuthReviewServiceClient {
  ...
  multiPartyAuthReviewServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of MultiPartyAuthReviewServiceClient.
   *
   ...
   *     const client = new MultiPartyAuthReviewServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof MultiPartyAuthReviewServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.MultiPartyAuthReviewService',
  ...
  initialize() {
    ...
    if (this.multiPartyAuthReviewServiceStub) {
      return this.multiPartyAuthReviewServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.googleads.v25.services.MultiPartyAuthReviewService.
    this.multiPartyAuthReviewServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    const multiPartyAuthReviewServiceStubMethods = [
      'resolveMultiPartyAuthReview',
    ];
    for (const methodName of multiPartyAuthReviewServiceStubMethods) {
      const callPromise = this.multiPartyAuthReviewServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.ResolveMultiPartyAuthReviewResponse|ResolveMultiPartyAuthReviewResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/multi_party_auth_review_service.resolve_multi_party_auth_review.js</caption>
   * region_tag:googleads_v25_generated_MultiPartyAuthReviewService_ResolveMultiPartyAuthReview_async
   */
  resolveMultiPartyAuthReview(
    request?: protos.google.ads.googleads.v25.services.IResolveMultiPartyAuthReviewRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.IResolveMultiPartyAuthReviewResponse,
      (
        | protos.google.ads.googleads.v25.services.IResolveMultiPartyAuthReviewRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('resolveMultiPartyAuthReview request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('resolveMultiPartyAuthReview response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .resolveMultiPartyAuthReview(request, options, wrappedCallback)
      ?.then(
   ...
   */
  close(): Promise<void> {
    if (this.multiPartyAuthReviewServiceStub && !this._terminated) {
      return this.multiPartyAuthReviewServiceStub.then((stub) => {
