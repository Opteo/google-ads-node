 ...
 * `src/v25/geo_target_constant_service_client_config.json`.
...
export class GeoTargetConstantServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof GeoTargetConstantServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.googleads.v25.services.GeoTargetConstantService',
   ...
   * @param {google.ads.googleads.v25.services.SuggestGeoTargetConstantsRequest.LocationNames} request.locationNames
   *   The location names to search by. At most 25 names can be set.
   * @param {google.ads.googleads.v25.services.SuggestGeoTargetConstantsRequest.GeoTargets} request.geoTargets
   *   The geo target constant resource names to filter by.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.googleads.v25.services.SuggestGeoTargetConstantsResponse|SuggestGeoTargetConstantsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v25/geo_target_constant_service.suggest_geo_target_constants.js</caption>
   * region_tag:googleads_v25_generated_GeoTargetConstantService_SuggestGeoTargetConstants_async
   */
  suggestGeoTargetConstants(
    request?: protos.google.ads.googleads.v25.services.ISuggestGeoTargetConstantsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.googleads.v25.services.ISuggestGeoTargetConstantsResponse,
      (
        | protos.google.ads.googleads.v25.services.ISuggestGeoTargetConstantsRequest
        | undefined
      ),
      {} | undefined,
    ]
