 ...
 * `src/v12/customer_user_access_invitation_service_client_config.json`.
...
export class CustomerUserAccessInvitationServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v12.services.CustomerUserAccessInvitationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerUserAccessInvitationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v12.services.CustomerUserAccessInvitationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v12.services.CustomerUserAccessInvitationService,
 ...
 * @param {google.ads.googleads.v12.services.CustomerUserAccessInvitationOperation} request.operation
 *   Required. The operation to perform on the access invitation
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomerUserAccessInvitationResponse]{@link google.ads.googleads.v12.services.MutateCustomerUserAccessInvitationResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v12/customer_user_access_invitation_service.mutate_customer_user_access_invitation.js</caption>
 * region_tag:googleads_v12_generated_CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_async
 */
  mutateCustomerUserAccessInvitation(
      request?: protos.google.ads.googleads.v12.services.IMutateCustomerUserAccessInvitationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v12.services.IMutateCustomerUserAccessInvitationResponse,
        protos.google.ads.googleads.v12.services.IMutateCustomerUserAccessInvitationRequest|undefined, {}|undefined
      ]>;
  mutateCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v12.services.IMutateCustomerUserAccessInvitationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v12.services.IMutateCustomerUserAccessInvitationResponse,
          protos.google.ads.googleads.v12.services.IMutateCustomerUserAccessInvitationRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v12.services.IMutateCustomerUserAccessInvitationRequest,
      callback: Callback<
