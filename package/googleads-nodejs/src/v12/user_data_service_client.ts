 ...
 * `src/v12/user_data_service_client_config.json`.
...
export class UserDataServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v12.services.UserDataService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.userDataServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v12.services.UserDataService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v12.services.UserDataService,
 ...
 * @param {google.ads.googleads.v12.common.CustomerMatchUserListMetadata} request.customerMatchUserListMetadata
 *   Metadata for data updates to a Customer Match user list.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [UploadUserDataResponse]{@link google.ads.googleads.v12.services.UploadUserDataResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v12/user_data_service.upload_user_data.js</caption>
 * region_tag:googleads_v12_generated_UserDataService_UploadUserData_async
 */
  uploadUserData(
      request?: protos.google.ads.googleads.v12.services.IUploadUserDataRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v12.services.IUploadUserDataResponse,
        protos.google.ads.googleads.v12.services.IUploadUserDataRequest|undefined, {}|undefined
      ]>;
  uploadUserData(
      request: protos.google.ads.googleads.v12.services.IUploadUserDataRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v12.services.IUploadUserDataResponse,
          protos.google.ads.googleads.v12.services.IUploadUserDataRequest|null|undefined,
          {}|null|undefined>): void;
  uploadUserData(
      request: protos.google.ads.googleads.v12.services.IUploadUserDataRequest,
      callback: Callback<
