...
import * as displaykeywordviewserviceModule from '../src';
...
describe('v6.DisplayKeywordViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = displaykeywordviewserviceModule.v6.DisplayKeywordViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = displaykeywordviewserviceModule.v6.DisplayKeywordViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = displaykeywordviewserviceModule.v6.DisplayKeywordViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new displaykeywordviewserviceModule.v6.DisplayKeywordViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.displayKeywordViewServiceStub, undefined);
        await client.initialize();
        assert(client.displayKeywordViewServiceStub);
    });
    ...
    describe('getDisplayKeywordView', () => {
        it('invokes getDisplayKeywordView without error', async () => {
            const client = new displaykeywordviewserviceModule.v6.DisplayKeywordViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetDisplayKeywordViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.DisplayKeywordView());
            client.innerApiCalls.getDisplayKeywordView = stubSimpleCall(expectedResponse);
            const [response] = await client.getDisplayKeywordView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getDisplayKeywordView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getDisplayKeywordView without error using callback', async () => {
            const client = new displaykeywordviewserviceModule.v6.DisplayKeywordViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.DisplayKeywordView());
            client.innerApiCalls.getDisplayKeywordView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDisplayKeywordView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IDisplayKeywordView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDisplayKeywordView with error', async () => {
            const client = new displaykeywordviewserviceModule.v6.DisplayKeywordViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDisplayKeywordView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDisplayKeywordView(request), expectedError);
            assert((client.innerApiCalls.getDisplayKeywordView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
