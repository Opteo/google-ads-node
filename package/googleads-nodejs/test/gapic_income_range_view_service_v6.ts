...
import * as incomerangeviewserviceModule from '../src';
...
describe('v6.IncomeRangeViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = incomerangeviewserviceModule.v6.IncomeRangeViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = incomerangeviewserviceModule.v6.IncomeRangeViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = incomerangeviewserviceModule.v6.IncomeRangeViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new incomerangeviewserviceModule.v6.IncomeRangeViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.incomeRangeViewServiceStub, undefined);
        await client.initialize();
        assert(client.incomeRangeViewServiceStub);
    });
    ...
    describe('getIncomeRangeView', () => {
        it('invokes getIncomeRangeView without error', async () => {
            const client = new incomerangeviewserviceModule.v6.IncomeRangeViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetIncomeRangeViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.IncomeRangeView());
            client.innerApiCalls.getIncomeRangeView = stubSimpleCall(expectedResponse);
            const [response] = await client.getIncomeRangeView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getIncomeRangeView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getIncomeRangeView without error using callback', async () => {
            const client = new incomerangeviewserviceModule.v6.IncomeRangeViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.IncomeRangeView());
            client.innerApiCalls.getIncomeRangeView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getIncomeRangeView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IIncomeRangeView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getIncomeRangeView with error', async () => {
            const client = new incomerangeviewserviceModule.v6.IncomeRangeViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getIncomeRangeView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getIncomeRangeView(request), expectedError);
            assert((client.innerApiCalls.getIncomeRangeView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
