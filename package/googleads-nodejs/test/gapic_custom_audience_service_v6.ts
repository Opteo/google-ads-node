...
import * as customaudienceserviceModule from '../src';
...
describe('v6.CustomAudienceServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customaudienceserviceModule.v6.CustomAudienceServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customaudienceserviceModule.v6.CustomAudienceServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customaudienceserviceModule.v6.CustomAudienceServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customaudienceserviceModule.v6.CustomAudienceServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customAudienceServiceStub, undefined);
        await client.initialize();
        assert(client.customAudienceServiceStub);
    });
    ...
    describe('getCustomAudience', () => {
        it('invokes getCustomAudience without error', async () => {
            const client = new customaudienceserviceModule.v6.CustomAudienceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetCustomAudienceRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CustomAudience());
            client.innerApiCalls.getCustomAudience = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomAudience(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomAudience as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCustomAudience without error using callback', async () => {
            const client = new customaudienceserviceModule.v6.CustomAudienceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CustomAudience());
            client.innerApiCalls.getCustomAudience = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomAudience(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ICustomAudience|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomAudience with error', async () => {
            const client = new customaudienceserviceModule.v6.CustomAudienceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCustomAudience = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomAudience(request), expectedError);
            assert((client.innerApiCalls.getCustomAudience as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCustomAudiences', () => {
        it('invokes mutateCustomAudiences without error', async () => {
            const client = new customaudienceserviceModule.v6.CustomAudienceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomAudiencesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomAudiencesResponse());
            client.innerApiCalls.mutateCustomAudiences = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomAudiences(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomAudiences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomAudiences without error using callback', async () => {
            const client = new customaudienceserviceModule.v6.CustomAudienceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomAudiencesResponse());
            client.innerApiCalls.mutateCustomAudiences = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomAudiences(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateCustomAudiencesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomAudiences with error', async () => {
            const client = new customaudienceserviceModule.v6.CustomAudienceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomAudiences = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomAudiences(request), expectedError);
            assert((client.innerApiCalls.mutateCustomAudiences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
