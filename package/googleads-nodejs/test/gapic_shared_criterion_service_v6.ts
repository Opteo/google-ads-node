...
import * as sharedcriterionserviceModule from '../src';
...
describe('v6.SharedCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = sharedcriterionserviceModule.v6.SharedCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = sharedcriterionserviceModule.v6.SharedCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = sharedcriterionserviceModule.v6.SharedCriterionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new sharedcriterionserviceModule.v6.SharedCriterionServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.sharedCriterionServiceStub, undefined);
        await client.initialize();
        assert(client.sharedCriterionServiceStub);
    });
    ...
    describe('getSharedCriterion', () => {
        it('invokes getSharedCriterion without error', async () => {
            const client = new sharedcriterionserviceModule.v6.SharedCriterionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetSharedCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.SharedCriterion());
            client.innerApiCalls.getSharedCriterion = stubSimpleCall(expectedResponse);
            const [response] = await client.getSharedCriterion(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSharedCriterion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getSharedCriterion without error using callback', async () => {
            const client = new sharedcriterionserviceModule.v6.SharedCriterionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.SharedCriterion());
            client.innerApiCalls.getSharedCriterion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSharedCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ISharedCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSharedCriterion with error', async () => {
            const client = new sharedcriterionserviceModule.v6.SharedCriterionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getSharedCriterion = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getSharedCriterion(request), expectedError);
            assert((client.innerApiCalls.getSharedCriterion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateSharedCriteria', () => {
        it('invokes mutateSharedCriteria without error', async () => {
            const client = new sharedcriterionserviceModule.v6.SharedCriterionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateSharedCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateSharedCriteriaResponse());
            client.innerApiCalls.mutateSharedCriteria = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateSharedCriteria(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateSharedCriteria as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateSharedCriteria without error using callback', async () => {
            const client = new sharedcriterionserviceModule.v6.SharedCriterionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateSharedCriteriaResponse());
            client.innerApiCalls.mutateSharedCriteria = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateSharedCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateSharedCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateSharedCriteria with error', async () => {
            const client = new sharedcriterionserviceModule.v6.SharedCriterionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateSharedCriteria = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateSharedCriteria(request), expectedError);
            assert((client.innerApiCalls.mutateSharedCriteria as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
