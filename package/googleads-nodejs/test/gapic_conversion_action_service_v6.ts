...
import * as conversionactionserviceModule from '../src';
...
describe('v6.ConversionActionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionactionserviceModule.v6.ConversionActionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionactionserviceModule.v6.ConversionActionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionactionserviceModule.v6.ConversionActionServiceClient.port;
        assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.conversionActionServiceStub);
    });
    ...
    describe('getConversionAction', () => {
        it('invokes getConversionAction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetConversionActionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.ConversionAction());
            client.innerApiCalls.getConversionAction = stubSimpleCall(expectedResponse);
            const [response] = await client.getConversionAction(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getConversionAction as SinonStub)
        ...
        it('invokes getConversionAction without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.ConversionAction());
            client.innerApiCalls.getConversionAction = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConversionAction(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IConversionAction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConversionAction with error', async () => {
            ...
            client.innerApiCalls.getConversionAction = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getConversionAction(request), expectedError);
            assert((client.innerApiCalls.getConversionAction as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateConversionActions', () => {
        it('invokes mutateConversionActions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateConversionActionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateConversionActionsResponse());
            client.innerApiCalls.mutateConversionActions = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateConversionActions(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateConversionActions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateConversionActions without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateConversionActionsResponse());
            client.innerApiCalls.mutateConversionActions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionActions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateConversionActionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateConversionActions with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateConversionActions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateConversionActions(request), expectedError);
            assert((client.innerApiCalls.mutateConversionActions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
