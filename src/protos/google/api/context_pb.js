...
proto.google.api.ContextRule.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    requestedList: jspb.Message.getRepeatedField(msg, 2),
    providedList: jspb.Message.getRepeatedField(msg, 3),
    allowedRequestExtensionsList: jspb.Message.getRepeatedField(msg, 4),
    allowedResponseExtensionsList: jspb.Message.getRepeatedField(msg, 5)
  };
...
proto.google.api.ContextRule.prototype.clearAllowedRequestExtensionsList = function() {
  this.setAllowedRequestExtensionsList([]);
};
...
proto.google.api.ContextRule.prototype.clearAllowedResponseExtensionsList = function() {
  this.setAllowedResponseExtensionsList([]);
};
