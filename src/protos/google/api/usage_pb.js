...
proto.google.api.Usage.toObject = function(includeInstance, msg) {
  var f, obj = {
    requirementsList: jspb.Message.getRepeatedField(msg, 1),
...
proto.google.api.UsageRule.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    allowUnregisteredCalls: jspb.Message.getFieldWithDefault(msg, 2, false),
    skipServiceControl: jspb.Message.getFieldWithDefault(msg, 3, false)
  };
