...
// file: google/ads/googleads/v4/common/ad_asset.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_served_asset_field_type_pb from "../../../../../google/ads/googleads/v4/enums/served_asset_field_type_pb";
...
export class AdTextAsset extends jspb.Message {
  ...
  getPinnedField(): google_ads_googleads_v4_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap[keyof google_ads_googleads_v4_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap];
  setPinnedField(value: google_ads_googleads_v4_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap[keyof google_ads_googleads_v4_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap]): void;
...
export namespace AdTextAsset {
  export type AsObject = {
    ...
    pinnedField: google_ads_googleads_v4_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap[keyof google_ads_googleads_v4_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap],
  }
}
