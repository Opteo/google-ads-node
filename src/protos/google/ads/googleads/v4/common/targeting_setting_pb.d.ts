...
// file: google/ads/googleads/v4/common/targeting_setting.proto
...
export class TargetRestriction extends jspb.Message {
  getTargetingDimension(): google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap[keyof google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap];
  setTargetingDimension(value: google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap[keyof google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap]): void;
...
export namespace TargetRestriction {
  export type AsObject = {
    targetingDimension: google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap[keyof google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap],
