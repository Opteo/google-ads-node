...
// file: google/ads/googleads/v4/common/metrics.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_interaction_event_type_pb from "../../../../../google/ads/googleads/v4/enums/interaction_event_type_pb";
...
export class Metrics extends jspb.Message {
  ...
  hasHotelEligibleImpressions(): boolean;
  clearHotelEligibleImpressions(): void;
  getHotelEligibleImpressions(): google_protobuf_wrappers_pb.Int64Value | undefined;
  setHotelEligibleImpressions(value?: google_protobuf_wrappers_pb.Int64Value): void;

  getHistoricalCreativeQualityScore(): google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap];
  setHistoricalCreativeQualityScore(value: google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap]): void;

  getHistoricalLandingPageQualityScore(): google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap];
  setHistoricalLandingPageQualityScore(value: google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap]): void;
  ...
  getHistoricalSearchPredictedCtr(): google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap];
  setHistoricalSearchPredictedCtr(value: google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap]): void;
  ...
  getInteractionEventTypesList(): Array<google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap[keyof google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap]>;
  setInteractionEventTypesList(value: Array<google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap[keyof google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap]>): void;
  addInteractionEventTypes(value: google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap[keyof google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap], index?: number): google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap[keyof google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap];
...
export namespace Metrics {
  export type AsObject = {
    ...
    hotelEligibleImpressions?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    historicalCreativeQualityScore: google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap],
    historicalLandingPageQualityScore: google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap],
    historicalQualityScore?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    historicalSearchPredictedCtr: google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v4_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap],
    ...
    interactionEventTypesList: Array<google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap[keyof google_ads_googleads_v4_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventTypeMap]>,
