...
// file: google/ads/googleads/v4/common/matching_function.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_matching_function_context_type_pb from "../../../../../google/ads/googleads/v4/enums/matching_function_context_type_pb";
import * as google_ads_googleads_v4_enums_matching_function_operator_pb from "../../../../../google/ads/googleads/v4/enums/matching_function_operator_pb";
...
export class MatchingFunction extends jspb.Message {
  ...
  getOperator(): google_ads_googleads_v4_enums_matching_function_operator_pb.MatchingFunctionOperatorEnum.MatchingFunctionOperatorMap[keyof google_ads_googleads_v4_enums_matching_function_operator_pb.MatchingFunctionOperatorEnum.MatchingFunctionOperatorMap];
  setOperator(value: google_ads_googleads_v4_enums_matching_function_operator_pb.MatchingFunctionOperatorEnum.MatchingFunctionOperatorMap[keyof google_ads_googleads_v4_enums_matching_function_operator_pb.MatchingFunctionOperatorEnum.MatchingFunctionOperatorMap]): void;
...
export namespace MatchingFunction {
  export type AsObject = {
    ...
    operator: google_ads_googleads_v4_enums_matching_function_operator_pb.MatchingFunctionOperatorEnum.MatchingFunctionOperatorMap[keyof google_ads_googleads_v4_enums_matching_function_operator_pb.MatchingFunctionOperatorEnum.MatchingFunctionOperatorMap],
...
export namespace Operand {
  ...
  export class RequestContextOperand extends jspb.Message {
    getContextType(): google_ads_googleads_v4_enums_matching_function_context_type_pb.MatchingFunctionContextTypeEnum.MatchingFunctionContextTypeMap[keyof google_ads_googleads_v4_enums_matching_function_context_type_pb.MatchingFunctionContextTypeEnum.MatchingFunctionContextTypeMap];
    setContextType(value: google_ads_googleads_v4_enums_matching_function_context_type_pb.MatchingFunctionContextTypeEnum.MatchingFunctionContextTypeMap[keyof google_ads_googleads_v4_enums_matching_function_context_type_pb.MatchingFunctionContextTypeEnum.MatchingFunctionContextTypeMap]): void;
  ...
  export namespace RequestContextOperand {
    export type AsObject = {
      contextType: google_ads_googleads_v4_enums_matching_function_context_type_pb.MatchingFunctionContextTypeEnum.MatchingFunctionContextTypeMap[keyof google_ads_googleads_v4_enums_matching_function_context_type_pb.MatchingFunctionContextTypeEnum.MatchingFunctionContextTypeMap],
    }
  }
