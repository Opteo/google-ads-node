...
// file: google/ads/googleads/v4/common/bidding.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_target_impression_share_location_pb from "../../../../../google/ads/googleads/v4/enums/target_impression_share_location_pb";
...
export class TargetImpressionShare extends jspb.Message {
  getLocation(): google_ads_googleads_v4_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap[keyof google_ads_googleads_v4_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap];
  setLocation(value: google_ads_googleads_v4_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap[keyof google_ads_googleads_v4_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap]): void;
...
export namespace TargetImpressionShare {
  export type AsObject = {
    location: google_ads_googleads_v4_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap[keyof google_ads_googleads_v4_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap],
