...
// file: google/ads/googleads/v4/common/user_lists.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_customer_match_upload_key_type_pb from "../../../../../google/ads/googleads/v4/enums/customer_match_upload_key_type_pb";
import * as google_ads_googleads_v4_enums_user_list_combined_rule_operator_pb from "../../../../../google/ads/googleads/v4/enums/user_list_combined_rule_operator_pb";
import * as google_ads_googleads_v4_enums_user_list_crm_data_source_type_pb from "../../../../../google/ads/googleads/v4/enums/user_list_crm_data_source_type_pb";
import * as google_ads_googleads_v4_enums_user_list_date_rule_item_operator_pb from "../../../../../google/ads/googleads/v4/enums/user_list_date_rule_item_operator_pb";
import * as google_ads_googleads_v4_enums_user_list_logical_rule_operator_pb from "../../../../../google/ads/googleads/v4/enums/user_list_logical_rule_operator_pb";
import * as google_ads_googleads_v4_enums_user_list_number_rule_item_operator_pb from "../../../../../google/ads/googleads/v4/enums/user_list_number_rule_item_operator_pb";
import * as google_ads_googleads_v4_enums_user_list_prepopulation_status_pb from "../../../../../google/ads/googleads/v4/enums/user_list_prepopulation_status_pb";
import * as google_ads_googleads_v4_enums_user_list_rule_type_pb from "../../../../../google/ads/googleads/v4/enums/user_list_rule_type_pb";
import * as google_ads_googleads_v4_enums_user_list_string_rule_item_operator_pb from "../../../../../google/ads/googleads/v4/enums/user_list_string_rule_item_operator_pb";
...
export class CrmBasedUserListInfo extends jspb.Message {
  ...
  getUploadKeyType(): google_ads_googleads_v4_enums_customer_match_upload_key_type_pb.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyTypeMap[keyof google_ads_googleads_v4_enums_customer_match_upload_key_type_pb.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyTypeMap];
  setUploadKeyType(value: google_ads_googleads_v4_enums_customer_match_upload_key_type_pb.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyTypeMap[keyof google_ads_googleads_v4_enums_customer_match_upload_key_type_pb.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyTypeMap]): void;

  getDataSourceType(): google_ads_googleads_v4_enums_user_list_crm_data_source_type_pb.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceTypeMap[keyof google_ads_googleads_v4_enums_user_list_crm_data_source_type_pb.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceTypeMap];
  setDataSourceType(value: google_ads_googleads_v4_enums_user_list_crm_data_source_type_pb.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceTypeMap[keyof google_ads_googleads_v4_enums_user_list_crm_data_source_type_pb.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceTypeMap]): void;
...
export namespace CrmBasedUserListInfo {
  export type AsObject = {
    ...
    uploadKeyType: google_ads_googleads_v4_enums_customer_match_upload_key_type_pb.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyTypeMap[keyof google_ads_googleads_v4_enums_customer_match_upload_key_type_pb.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyTypeMap],
    dataSourceType: google_ads_googleads_v4_enums_user_list_crm_data_source_type_pb.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceTypeMap[keyof google_ads_googleads_v4_enums_user_list_crm_data_source_type_pb.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceTypeMap],
  }
}

export class UserListRuleInfo extends jspb.Message {
  getRuleType(): google_ads_googleads_v4_enums_user_list_rule_type_pb.UserListRuleTypeEnum.UserListRuleTypeMap[keyof google_ads_googleads_v4_enums_user_list_rule_type_pb.UserListRuleTypeEnum.UserListRuleTypeMap];
  setRuleType(value: google_ads_googleads_v4_enums_user_list_rule_type_pb.UserListRuleTypeEnum.UserListRuleTypeMap[keyof google_ads_googleads_v4_enums_user_list_rule_type_pb.UserListRuleTypeEnum.UserListRuleTypeMap]): void;
...
export namespace UserListRuleInfo {
  export type AsObject = {
    ruleType: google_ads_googleads_v4_enums_user_list_rule_type_pb.UserListRuleTypeEnum.UserListRuleTypeMap[keyof google_ads_googleads_v4_enums_user_list_rule_type_pb.UserListRuleTypeEnum.UserListRuleTypeMap],
...
export class UserListDateRuleItemInfo extends jspb.Message {
  getOperator(): google_ads_googleads_v4_enums_user_list_date_rule_item_operator_pb.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperatorMap[keyof google_ads_googleads_v4_enums_user_list_date_rule_item_operator_pb.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperatorMap];
  setOperator(value: google_ads_googleads_v4_enums_user_list_date_rule_item_operator_pb.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperatorMap[keyof google_ads_googleads_v4_enums_user_list_date_rule_item_operator_pb.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperatorMap]): void;
...
export namespace UserListDateRuleItemInfo {
  export type AsObject = {
    operator: google_ads_googleads_v4_enums_user_list_date_rule_item_operator_pb.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperatorMap[keyof google_ads_googleads_v4_enums_user_list_date_rule_item_operator_pb.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperatorMap],
...
export class UserListNumberRuleItemInfo extends jspb.Message {
  getOperator(): google_ads_googleads_v4_enums_user_list_number_rule_item_operator_pb.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperatorMap[keyof google_ads_googleads_v4_enums_user_list_number_rule_item_operator_pb.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperatorMap];
  setOperator(value: google_ads_googleads_v4_enums_user_list_number_rule_item_operator_pb.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperatorMap[keyof google_ads_googleads_v4_enums_user_list_number_rule_item_operator_pb.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperatorMap]): void;
...
export namespace UserListNumberRuleItemInfo {
  export type AsObject = {
    operator: google_ads_googleads_v4_enums_user_list_number_rule_item_operator_pb.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperatorMap[keyof google_ads_googleads_v4_enums_user_list_number_rule_item_operator_pb.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperatorMap],
    value?: google_protobuf_wrappers_pb.DoubleValue.AsObject,
  }
}

export class UserListStringRuleItemInfo extends jspb.Message {
  getOperator(): google_ads_googleads_v4_enums_user_list_string_rule_item_operator_pb.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperatorMap[keyof google_ads_googleads_v4_enums_user_list_string_rule_item_operator_pb.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperatorMap];
  setOperator(value: google_ads_googleads_v4_enums_user_list_string_rule_item_operator_pb.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperatorMap[keyof google_ads_googleads_v4_enums_user_list_string_rule_item_operator_pb.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperatorMap]): void;
...
export namespace UserListStringRuleItemInfo {
  export type AsObject = {
    operator: google_ads_googleads_v4_enums_user_list_string_rule_item_operator_pb.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperatorMap[keyof google_ads_googleads_v4_enums_user_list_string_rule_item_operator_pb.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperatorMap],
    value?: google_protobuf_wrappers_pb.StringValue.AsObject,
  }
}
...
export class CombinedRuleUserListInfo extends jspb.Message {
  ...
  getRuleOperator(): google_ads_googleads_v4_enums_user_list_combined_rule_operator_pb.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperatorMap[keyof google_ads_googleads_v4_enums_user_list_combined_rule_operator_pb.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperatorMap];
  setRuleOperator(value: google_ads_googleads_v4_enums_user_list_combined_rule_operator_pb.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperatorMap[keyof google_ads_googleads_v4_enums_user_list_combined_rule_operator_pb.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperatorMap]): void;
...
export namespace CombinedRuleUserListInfo {
  export type AsObject = {
    ...
    ruleOperator: google_ads_googleads_v4_enums_user_list_combined_rule_operator_pb.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperatorMap[keyof google_ads_googleads_v4_enums_user_list_combined_rule_operator_pb.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperatorMap],
  }
}
...
export class RuleBasedUserListInfo extends jspb.Message {
  getPrepopulationStatus(): google_ads_googleads_v4_enums_user_list_prepopulation_status_pb.UserListPrepopulationStatusEnum.UserListPrepopulationStatusMap[keyof google_ads_googleads_v4_enums_user_list_prepopulation_status_pb.UserListPrepopulationStatusEnum.UserListPrepopulationStatusMap];
  setPrepopulationStatus(value: google_ads_googleads_v4_enums_user_list_prepopulation_status_pb.UserListPrepopulationStatusEnum.UserListPrepopulationStatusMap[keyof google_ads_googleads_v4_enums_user_list_prepopulation_status_pb.UserListPrepopulationStatusEnum.UserListPrepopulationStatusMap]): void;
...
export namespace RuleBasedUserListInfo {
  export type AsObject = {
    prepopulationStatus: google_ads_googleads_v4_enums_user_list_prepopulation_status_pb.UserListPrepopulationStatusEnum.UserListPrepopulationStatusMap[keyof google_ads_googleads_v4_enums_user_list_prepopulation_status_pb.UserListPrepopulationStatusEnum.UserListPrepopulationStatusMap],
...
export class UserListLogicalRuleInfo extends jspb.Message {
  getOperator(): google_ads_googleads_v4_enums_user_list_logical_rule_operator_pb.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperatorMap[keyof google_ads_googleads_v4_enums_user_list_logical_rule_operator_pb.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperatorMap];
  setOperator(value: google_ads_googleads_v4_enums_user_list_logical_rule_operator_pb.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperatorMap[keyof google_ads_googleads_v4_enums_user_list_logical_rule_operator_pb.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperatorMap]): void;
...
export namespace UserListLogicalRuleInfo {
  export type AsObject = {
    operator: google_ads_googleads_v4_enums_user_list_logical_rule_operator_pb.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperatorMap[keyof google_ads_googleads_v4_enums_user_list_logical_rule_operator_pb.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperatorMap],
