...
// file: google/ads/googleads/v4/common/asset_types.proto
...
export class BookOnGoogleAsset extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): BookOnGoogleAsset.AsObject;
  static toObject(includeInstance: boolean, msg: BookOnGoogleAsset): BookOnGoogleAsset.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: BookOnGoogleAsset, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): BookOnGoogleAsset;
  static deserializeBinaryFromReader(message: BookOnGoogleAsset, reader: jspb.BinaryReader): BookOnGoogleAsset;
}

export namespace BookOnGoogleAsset {
  export type AsObject = {
  }
}
