...
// file: google/ads/googleads/v4/common/simulation.proto
...
export class TargetRoasSimulationPointList extends jspb.Message {
  clearPointsList(): void;
  getPointsList(): Array<TargetRoasSimulationPoint>;
  setPointsList(value: Array<TargetRoasSimulationPoint>): void;
  addPoints(value?: TargetRoasSimulationPoint, index?: number): TargetRoasSimulationPoint;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): TargetRoasSimulationPointList.AsObject;
  static toObject(includeInstance: boolean, msg: TargetRoasSimulationPointList): TargetRoasSimulationPointList.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: TargetRoasSimulationPointList, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): TargetRoasSimulationPointList;
  static deserializeBinaryFromReader(message: TargetRoasSimulationPointList, reader: jspb.BinaryReader): TargetRoasSimulationPointList;
}

export namespace TargetRoasSimulationPointList {
  export type AsObject = {
    pointsList: Array<TargetRoasSimulationPoint.AsObject>,
  }
}
...
export class TargetRoasSimulationPoint extends jspb.Message {
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): TargetRoasSimulationPoint.AsObject;
  static toObject(includeInstance: boolean, msg: TargetRoasSimulationPoint): TargetRoasSimulationPoint.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: TargetRoasSimulationPoint, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): TargetRoasSimulationPoint;
  static deserializeBinaryFromReader(message: TargetRoasSimulationPoint, reader: jspb.BinaryReader): TargetRoasSimulationPoint;
}

export namespace TargetRoasSimulationPoint {
  export type AsObject = {
