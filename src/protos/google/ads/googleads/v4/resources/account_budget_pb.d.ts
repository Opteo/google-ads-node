...
// file: google/ads/googleads/v4/resources/account_budget.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_account_budget_proposal_type_pb from "../../../../../google/ads/googleads/v4/enums/account_budget_proposal_type_pb";
import * as google_ads_googleads_v4_enums_account_budget_status_pb from "../../../../../google/ads/googleads/v4/enums/account_budget_status_pb";
import * as google_ads_googleads_v4_enums_spending_limit_type_pb from "../../../../../google/ads/googleads/v4/enums/spending_limit_type_pb";
import * as google_ads_googleads_v4_enums_time_type_pb from "../../../../../google/ads/googleads/v4/enums/time_type_pb";
...
export class AccountBudget extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v4_enums_account_budget_status_pb.AccountBudgetStatusEnum.AccountBudgetStatusMap[keyof google_ads_googleads_v4_enums_account_budget_status_pb.AccountBudgetStatusEnum.AccountBudgetStatusMap];
  setStatus(value: google_ads_googleads_v4_enums_account_budget_status_pb.AccountBudgetStatusEnum.AccountBudgetStatusMap[keyof google_ads_googleads_v4_enums_account_budget_status_pb.AccountBudgetStatusEnum.AccountBudgetStatusMap]): void;
  ...
  getProposedEndTimeType(): google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap];
  setProposedEndTimeType(value: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap]): void;
  ...
  getApprovedEndTimeType(): google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap];
  setApprovedEndTimeType(value: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap]): void;
  ...
  getProposedSpendingLimitType(): google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap];
  setProposedSpendingLimitType(value: google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap]): void;
  ...
  getApprovedSpendingLimitType(): google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap];
  setApprovedSpendingLimitType(value: google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap]): void;
  ...
  getAdjustedSpendingLimitType(): google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap];
  setAdjustedSpendingLimitType(value: google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap]): void;
...
export namespace AccountBudget {
  export type AsObject = {
    ...
    status: google_ads_googleads_v4_enums_account_budget_status_pb.AccountBudgetStatusEnum.AccountBudgetStatusMap[keyof google_ads_googleads_v4_enums_account_budget_status_pb.AccountBudgetStatusEnum.AccountBudgetStatusMap],
    ...
    proposedEndTimeType: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap],
    approvedEndDateTime?: google_protobuf_wrappers_pb.StringValue.AsObject,
    approvedEndTimeType: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap],
    proposedSpendingLimitMicros?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    proposedSpendingLimitType: google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap],
    approvedSpendingLimitMicros?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    approvedSpendingLimitType: google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap],
    adjustedSpendingLimitMicros?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    adjustedSpendingLimitType: google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap],
  }
  ...
  export class PendingAccountBudgetProposal extends jspb.Message {
    ...
    getProposalType(): google_ads_googleads_v4_enums_account_budget_proposal_type_pb.AccountBudgetProposalTypeEnum.AccountBudgetProposalTypeMap[keyof google_ads_googleads_v4_enums_account_budget_proposal_type_pb.AccountBudgetProposalTypeEnum.AccountBudgetProposalTypeMap];
    setProposalType(value: google_ads_googleads_v4_enums_account_budget_proposal_type_pb.AccountBudgetProposalTypeEnum.AccountBudgetProposalTypeMap[keyof google_ads_googleads_v4_enums_account_budget_proposal_type_pb.AccountBudgetProposalTypeEnum.AccountBudgetProposalTypeMap]): void;
    ...
    getEndTimeType(): google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap];
    setEndTimeType(value: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap]): void;
    ...
    getSpendingLimitType(): google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap];
    setSpendingLimitType(value: google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap]): void;
  ...
  export namespace PendingAccountBudgetProposal {
    export type AsObject = {
      ...
      proposalType: google_ads_googleads_v4_enums_account_budget_proposal_type_pb.AccountBudgetProposalTypeEnum.AccountBudgetProposalTypeMap[keyof google_ads_googleads_v4_enums_account_budget_proposal_type_pb.AccountBudgetProposalTypeEnum.AccountBudgetProposalTypeMap],
      name?: google_protobuf_wrappers_pb.StringValue.AsObject,
      ...
      endTimeType: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap],
      spendingLimitMicros?: google_protobuf_wrappers_pb.Int64Value.AsObject,
      spendingLimitType: google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap[keyof google_ads_googleads_v4_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitTypeMap],
    }
