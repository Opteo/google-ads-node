...
// file: google/ads/googleads/v4/resources/billing_setup.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_billing_setup_status_pb from "../../../../../google/ads/googleads/v4/enums/billing_setup_status_pb";
...
export class BillingSetup extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v4_enums_billing_setup_status_pb.BillingSetupStatusEnum.BillingSetupStatusMap[keyof google_ads_googleads_v4_enums_billing_setup_status_pb.BillingSetupStatusEnum.BillingSetupStatusMap];
  setStatus(value: google_ads_googleads_v4_enums_billing_setup_status_pb.BillingSetupStatusEnum.BillingSetupStatusMap[keyof google_ads_googleads_v4_enums_billing_setup_status_pb.BillingSetupStatusEnum.BillingSetupStatusMap]): void;
  ...
  getStartTimeType(): google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap];
  setStartTimeType(value: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap]): void;
...
export namespace BillingSetup {
  export type AsObject = {
    ...
    status: google_ads_googleads_v4_enums_billing_setup_status_pb.BillingSetupStatusEnum.BillingSetupStatusMap[keyof google_ads_googleads_v4_enums_billing_setup_status_pb.BillingSetupStatusEnum.BillingSetupStatusMap],
    ...
    startTimeType: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap],
