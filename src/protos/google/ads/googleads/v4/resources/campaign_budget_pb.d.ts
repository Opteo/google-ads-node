...
// file: google/ads/googleads/v4/resources/campaign_budget.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_budget_delivery_method_pb from "../../../../../google/ads/googleads/v4/enums/budget_delivery_method_pb";
import * as google_ads_googleads_v4_enums_budget_period_pb from "../../../../../google/ads/googleads/v4/enums/budget_period_pb";
import * as google_ads_googleads_v4_enums_budget_status_pb from "../../../../../google/ads/googleads/v4/enums/budget_status_pb";
import * as google_ads_googleads_v4_enums_budget_type_pb from "../../../../../google/ads/googleads/v4/enums/budget_type_pb";
...
export class CampaignBudget extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v4_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap[keyof google_ads_googleads_v4_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap];
  setStatus(value: google_ads_googleads_v4_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap[keyof google_ads_googleads_v4_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap]): void;

  getDeliveryMethod(): google_ads_googleads_v4_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap[keyof google_ads_googleads_v4_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap];
  setDeliveryMethod(value: google_ads_googleads_v4_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap[keyof google_ads_googleads_v4_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap]): void;
  ...
  getPeriod(): google_ads_googleads_v4_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap[keyof google_ads_googleads_v4_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap];
  setPeriod(value: google_ads_googleads_v4_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap[keyof google_ads_googleads_v4_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap]): void;
  ...
  getType(): google_ads_googleads_v4_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap[keyof google_ads_googleads_v4_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap];
  setType(value: google_ads_googleads_v4_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap[keyof google_ads_googleads_v4_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap]): void;
...
export namespace CampaignBudget {
  export type AsObject = {
    ...
    status: google_ads_googleads_v4_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap[keyof google_ads_googleads_v4_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap],
    deliveryMethod: google_ads_googleads_v4_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap[keyof google_ads_googleads_v4_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap],
    ...
    period: google_ads_googleads_v4_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap[keyof google_ads_googleads_v4_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap],
    ...
    type: google_ads_googleads_v4_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap[keyof google_ads_googleads_v4_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap],
  }
}
