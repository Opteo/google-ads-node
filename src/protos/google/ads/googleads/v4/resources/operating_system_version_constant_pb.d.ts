...
// file: google/ads/googleads/v4/resources/operating_system_version_constant.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_operating_system_version_operator_type_pb from "../../../../../google/ads/googleads/v4/enums/operating_system_version_operator_type_pb";
...
export class OperatingSystemVersionConstant extends jspb.Message {
  ...
  getOperatorType(): google_ads_googleads_v4_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap[keyof google_ads_googleads_v4_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap];
  setOperatorType(value: google_ads_googleads_v4_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap[keyof google_ads_googleads_v4_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap]): void;
...
export namespace OperatingSystemVersionConstant {
  export type AsObject = {
    ...
    operatorType: google_ads_googleads_v4_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap[keyof google_ads_googleads_v4_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap],
  }
}
