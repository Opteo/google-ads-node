...
// file: google/ads/googleads/v4/resources/campaign_experiment.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_campaign_experiment_status_pb from "../../../../../google/ads/googleads/v4/enums/campaign_experiment_status_pb";
import * as google_ads_googleads_v4_enums_campaign_experiment_traffic_split_type_pb from "../../../../../google/ads/googleads/v4/enums/campaign_experiment_traffic_split_type_pb";
...
export class CampaignExperiment extends jspb.Message {
  ...
  getTrafficSplitType(): google_ads_googleads_v4_enums_campaign_experiment_traffic_split_type_pb.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitTypeMap[keyof google_ads_googleads_v4_enums_campaign_experiment_traffic_split_type_pb.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitTypeMap];
  setTrafficSplitType(value: google_ads_googleads_v4_enums_campaign_experiment_traffic_split_type_pb.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitTypeMap[keyof google_ads_googleads_v4_enums_campaign_experiment_traffic_split_type_pb.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitTypeMap]): void;
  ...
  getStatus(): google_ads_googleads_v4_enums_campaign_experiment_status_pb.CampaignExperimentStatusEnum.CampaignExperimentStatusMap[keyof google_ads_googleads_v4_enums_campaign_experiment_status_pb.CampaignExperimentStatusEnum.CampaignExperimentStatusMap];
  setStatus(value: google_ads_googleads_v4_enums_campaign_experiment_status_pb.CampaignExperimentStatusEnum.CampaignExperimentStatusMap[keyof google_ads_googleads_v4_enums_campaign_experiment_status_pb.CampaignExperimentStatusEnum.CampaignExperimentStatusMap]): void;
...
export namespace CampaignExperiment {
  export type AsObject = {
    ...
    trafficSplitType: google_ads_googleads_v4_enums_campaign_experiment_traffic_split_type_pb.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitTypeMap[keyof google_ads_googleads_v4_enums_campaign_experiment_traffic_split_type_pb.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitTypeMap],
    experimentCampaign?: google_protobuf_wrappers_pb.StringValue.AsObject,
    status: google_ads_googleads_v4_enums_campaign_experiment_status_pb.CampaignExperimentStatusEnum.CampaignExperimentStatusMap[keyof google_ads_googleads_v4_enums_campaign_experiment_status_pb.CampaignExperimentStatusEnum.CampaignExperimentStatusMap],
