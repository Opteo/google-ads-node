...
// file: google/ads/googleads/v4/resources/ad_group.proto
...
import * as google_ads_googleads_v4_common_explorer_auto_optimizer_setting_pb from "../../../../../google/ads/googleads/v4/common/explorer_auto_optimizer_setting_pb";
import * as google_ads_googleads_v4_common_targeting_setting_pb from "../../../../../google/ads/googleads/v4/common/targeting_setting_pb";
import * as google_ads_googleads_v4_enums_ad_group_ad_rotation_mode_pb from "../../../../../google/ads/googleads/v4/enums/ad_group_ad_rotation_mode_pb";
import * as google_ads_googleads_v4_enums_ad_group_status_pb from "../../../../../google/ads/googleads/v4/enums/ad_group_status_pb";
import * as google_ads_googleads_v4_enums_ad_group_type_pb from "../../../../../google/ads/googleads/v4/enums/ad_group_type_pb";
import * as google_ads_googleads_v4_enums_bidding_source_pb from "../../../../../google/ads/googleads/v4/enums/bidding_source_pb";
import * as google_ads_googleads_v4_enums_targeting_dimension_pb from "../../../../../google/ads/googleads/v4/enums/targeting_dimension_pb";
...
export class AdGroup extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v4_enums_ad_group_status_pb.AdGroupStatusEnum.AdGroupStatusMap[keyof google_ads_googleads_v4_enums_ad_group_status_pb.AdGroupStatusEnum.AdGroupStatusMap];
  setStatus(value: google_ads_googleads_v4_enums_ad_group_status_pb.AdGroupStatusEnum.AdGroupStatusMap[keyof google_ads_googleads_v4_enums_ad_group_status_pb.AdGroupStatusEnum.AdGroupStatusMap]): void;

  getType(): google_ads_googleads_v4_enums_ad_group_type_pb.AdGroupTypeEnum.AdGroupTypeMap[keyof google_ads_googleads_v4_enums_ad_group_type_pb.AdGroupTypeEnum.AdGroupTypeMap];
  setType(value: google_ads_googleads_v4_enums_ad_group_type_pb.AdGroupTypeEnum.AdGroupTypeMap[keyof google_ads_googleads_v4_enums_ad_group_type_pb.AdGroupTypeEnum.AdGroupTypeMap]): void;

  getAdRotationMode(): google_ads_googleads_v4_enums_ad_group_ad_rotation_mode_pb.AdGroupAdRotationModeEnum.AdGroupAdRotationModeMap[keyof google_ads_googleads_v4_enums_ad_group_ad_rotation_mode_pb.AdGroupAdRotationModeEnum.AdGroupAdRotationModeMap];
  setAdRotationMode(value: google_ads_googleads_v4_enums_ad_group_ad_rotation_mode_pb.AdGroupAdRotationModeEnum.AdGroupAdRotationModeMap[keyof google_ads_googleads_v4_enums_ad_group_ad_rotation_mode_pb.AdGroupAdRotationModeEnum.AdGroupAdRotationModeMap]): void;
  ...
  getExplorerAutoOptimizerSetting(): google_ads_googleads_v4_common_explorer_auto_optimizer_setting_pb.ExplorerAutoOptimizerSetting | undefined;
  setExplorerAutoOptimizerSetting(value?: google_ads_googleads_v4_common_explorer_auto_optimizer_setting_pb.ExplorerAutoOptimizerSetting): void;

  getDisplayCustomBidDimension(): google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap[keyof google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap];
  setDisplayCustomBidDimension(value: google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap[keyof google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap]): void;
  ...
  getEffectiveTargetCpaSource(): google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap];
  setEffectiveTargetCpaSource(value: google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap]): void;
  ...
  getEffectiveTargetRoasSource(): google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap];
  setEffectiveTargetRoasSource(value: google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap]): void;
...
export namespace AdGroup {
  export type AsObject = {
    ...
    status: google_ads_googleads_v4_enums_ad_group_status_pb.AdGroupStatusEnum.AdGroupStatusMap[keyof google_ads_googleads_v4_enums_ad_group_status_pb.AdGroupStatusEnum.AdGroupStatusMap],
    type: google_ads_googleads_v4_enums_ad_group_type_pb.AdGroupTypeEnum.AdGroupTypeMap[keyof google_ads_googleads_v4_enums_ad_group_type_pb.AdGroupTypeEnum.AdGroupTypeMap],
    adRotationMode: google_ads_googleads_v4_enums_ad_group_ad_rotation_mode_pb.AdGroupAdRotationModeEnum.AdGroupAdRotationModeMap[keyof google_ads_googleads_v4_enums_ad_group_ad_rotation_mode_pb.AdGroupAdRotationModeEnum.AdGroupAdRotationModeMap],
    ...
    explorerAutoOptimizerSetting?: google_ads_googleads_v4_common_explorer_auto_optimizer_setting_pb.ExplorerAutoOptimizerSetting.AsObject,
    displayCustomBidDimension: google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap[keyof google_ads_googleads_v4_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimensionMap],
    ...
    effectiveTargetCpaSource: google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap],
    effectiveTargetRoas?: google_protobuf_wrappers_pb.DoubleValue.AsObject,
    effectiveTargetRoasSource: google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v4_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap],
