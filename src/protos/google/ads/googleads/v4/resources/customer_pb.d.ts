...
// file: google/ads/googleads/v4/resources/customer.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb from "../../../../../google/ads/googleads/v4/enums/customer_pay_per_conversion_eligibility_failure_reason_pb";
...
export class Customer extends jspb.Message {
  ...
  getPayPerConversionEligibilityFailureReasonsList(): Array<google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap[keyof google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap]>;
  setPayPerConversionEligibilityFailureReasonsList(value: Array<google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap[keyof google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap]>): void;
  addPayPerConversionEligibilityFailureReasons(value: google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap[keyof google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap], index?: number): google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap[keyof google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap];
...
export namespace Customer {
  export type AsObject = {
    ...
    payPerConversionEligibilityFailureReasonsList: Array<google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap[keyof google_ads_googleads_v4_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonMap]>,
