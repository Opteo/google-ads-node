...
// file: google/ads/googleads/v4/resources/campaign_draft.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_campaign_draft_status_pb from "../../../../../google/ads/googleads/v4/enums/campaign_draft_status_pb";
...
export class CampaignDraft extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v4_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap[keyof google_ads_googleads_v4_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap];
  setStatus(value: google_ads_googleads_v4_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap[keyof google_ads_googleads_v4_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap]): void;
...
export namespace CampaignDraft {
  export type AsObject = {
    ...
    status: google_ads_googleads_v4_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap[keyof google_ads_googleads_v4_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap],
