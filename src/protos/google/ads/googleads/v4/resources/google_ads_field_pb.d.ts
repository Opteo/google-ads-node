...
// file: google/ads/googleads/v4/resources/google_ads_field.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_google_ads_field_category_pb from "../../../../../google/ads/googleads/v4/enums/google_ads_field_category_pb";
import * as google_ads_googleads_v4_enums_google_ads_field_data_type_pb from "../../../../../google/ads/googleads/v4/enums/google_ads_field_data_type_pb";
...
export class GoogleAdsField extends jspb.Message {
  ...
  getCategory(): google_ads_googleads_v4_enums_google_ads_field_category_pb.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategoryMap[keyof google_ads_googleads_v4_enums_google_ads_field_category_pb.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategoryMap];
  setCategory(value: google_ads_googleads_v4_enums_google_ads_field_category_pb.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategoryMap[keyof google_ads_googleads_v4_enums_google_ads_field_category_pb.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategoryMap]): void;
  ...
  getDataType(): google_ads_googleads_v4_enums_google_ads_field_data_type_pb.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataTypeMap[keyof google_ads_googleads_v4_enums_google_ads_field_data_type_pb.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataTypeMap];
  setDataType(value: google_ads_googleads_v4_enums_google_ads_field_data_type_pb.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataTypeMap[keyof google_ads_googleads_v4_enums_google_ads_field_data_type_pb.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataTypeMap]): void;
...
export namespace GoogleAdsField {
  export type AsObject = {
    ...
    category: google_ads_googleads_v4_enums_google_ads_field_category_pb.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategoryMap[keyof google_ads_googleads_v4_enums_google_ads_field_category_pb.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategoryMap],
    ...
    dataType: google_ads_googleads_v4_enums_google_ads_field_data_type_pb.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataTypeMap[keyof google_ads_googleads_v4_enums_google_ads_field_data_type_pb.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataTypeMap],
