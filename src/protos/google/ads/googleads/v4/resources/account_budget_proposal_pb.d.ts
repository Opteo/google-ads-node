...
// file: google/ads/googleads/v4/resources/account_budget_proposal.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_account_budget_proposal_status_pb from "../../../../../google/ads/googleads/v4/enums/account_budget_proposal_status_pb";
...
export class AccountBudgetProposal extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v4_enums_account_budget_proposal_status_pb.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatusMap[keyof google_ads_googleads_v4_enums_account_budget_proposal_status_pb.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatusMap];
  setStatus(value: google_ads_googleads_v4_enums_account_budget_proposal_status_pb.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatusMap[keyof google_ads_googleads_v4_enums_account_budget_proposal_status_pb.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatusMap]): void;
  ...
  getProposedStartTimeType(): google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap];
  setProposedStartTimeType(value: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap]): void;
...
export namespace AccountBudgetProposal {
  export type AsObject = {
    ...
    status: google_ads_googleads_v4_enums_account_budget_proposal_status_pb.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatusMap[keyof google_ads_googleads_v4_enums_account_budget_proposal_status_pb.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatusMap],
    ...
    proposedStartTimeType: google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap[keyof google_ads_googleads_v4_enums_time_type_pb.TimeTypeEnum.TimeTypeMap],
