...
// file: google/ads/googleads/v4/resources/feed.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_affiliate_location_feed_relationship_type_pb from "../../../../../google/ads/googleads/v4/enums/affiliate_location_feed_relationship_type_pb";
import * as google_ads_googleads_v4_enums_feed_attribute_type_pb from "../../../../../google/ads/googleads/v4/enums/feed_attribute_type_pb";
import * as google_ads_googleads_v4_enums_feed_origin_pb from "../../../../../google/ads/googleads/v4/enums/feed_origin_pb";
import * as google_ads_googleads_v4_enums_feed_status_pb from "../../../../../google/ads/googleads/v4/enums/feed_status_pb";
...
export class Feed extends jspb.Message {
  ...
  getOrigin(): google_ads_googleads_v4_enums_feed_origin_pb.FeedOriginEnum.FeedOriginMap[keyof google_ads_googleads_v4_enums_feed_origin_pb.FeedOriginEnum.FeedOriginMap];
  setOrigin(value: google_ads_googleads_v4_enums_feed_origin_pb.FeedOriginEnum.FeedOriginMap[keyof google_ads_googleads_v4_enums_feed_origin_pb.FeedOriginEnum.FeedOriginMap]): void;

  getStatus(): google_ads_googleads_v4_enums_feed_status_pb.FeedStatusEnum.FeedStatusMap[keyof google_ads_googleads_v4_enums_feed_status_pb.FeedStatusEnum.FeedStatusMap];
  setStatus(value: google_ads_googleads_v4_enums_feed_status_pb.FeedStatusEnum.FeedStatusMap[keyof google_ads_googleads_v4_enums_feed_status_pb.FeedStatusEnum.FeedStatusMap]): void;
...
export namespace Feed {
  export type AsObject = {
    ...
    origin: google_ads_googleads_v4_enums_feed_origin_pb.FeedOriginEnum.FeedOriginMap[keyof google_ads_googleads_v4_enums_feed_origin_pb.FeedOriginEnum.FeedOriginMap],
    status: google_ads_googleads_v4_enums_feed_status_pb.FeedStatusEnum.FeedStatusMap[keyof google_ads_googleads_v4_enums_feed_status_pb.FeedStatusEnum.FeedStatusMap],
  ...
  export class AffiliateLocationFeedData extends jspb.Message {
    ...
    getRelationshipType(): google_ads_googleads_v4_enums_affiliate_location_feed_relationship_type_pb.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipTypeMap[keyof google_ads_googleads_v4_enums_affiliate_location_feed_relationship_type_pb.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipTypeMap];
    setRelationshipType(value: google_ads_googleads_v4_enums_affiliate_location_feed_relationship_type_pb.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipTypeMap[keyof google_ads_googleads_v4_enums_affiliate_location_feed_relationship_type_pb.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipTypeMap]): void;
  ...
  export namespace AffiliateLocationFeedData {
    export type AsObject = {
      ...
      relationshipType: google_ads_googleads_v4_enums_affiliate_location_feed_relationship_type_pb.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipTypeMap[keyof google_ads_googleads_v4_enums_affiliate_location_feed_relationship_type_pb.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipTypeMap],
    }
  }
...
export class FeedAttribute extends jspb.Message {
  ...
  getType(): google_ads_googleads_v4_enums_feed_attribute_type_pb.FeedAttributeTypeEnum.FeedAttributeTypeMap[keyof google_ads_googleads_v4_enums_feed_attribute_type_pb.FeedAttributeTypeEnum.FeedAttributeTypeMap];
  setType(value: google_ads_googleads_v4_enums_feed_attribute_type_pb.FeedAttributeTypeEnum.FeedAttributeTypeMap[keyof google_ads_googleads_v4_enums_feed_attribute_type_pb.FeedAttributeTypeEnum.FeedAttributeTypeMap]): void;
...
export namespace FeedAttribute {
  export type AsObject = {
    id?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    name?: google_protobuf_wrappers_pb.StringValue.AsObject,
    type: google_ads_googleads_v4_enums_feed_attribute_type_pb.FeedAttributeTypeEnum.FeedAttributeTypeMap[keyof google_ads_googleads_v4_enums_feed_attribute_type_pb.FeedAttributeTypeEnum.FeedAttributeTypeMap],
