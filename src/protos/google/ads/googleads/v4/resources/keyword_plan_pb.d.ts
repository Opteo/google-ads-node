...
// file: google/ads/googleads/v4/resources/keyword_plan.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_common_dates_pb from "../../../../../google/ads/googleads/v4/common/dates_pb";
import * as google_ads_googleads_v4_enums_keyword_plan_forecast_interval_pb from "../../../../../google/ads/googleads/v4/enums/keyword_plan_forecast_interval_pb";
...
export class KeywordPlanForecastPeriod extends jspb.Message {
  ...
  getDateInterval(): google_ads_googleads_v4_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap[keyof google_ads_googleads_v4_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap];
  setDateInterval(value: google_ads_googleads_v4_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap[keyof google_ads_googleads_v4_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap]): void;

  hasDateRange(): boolean;
  clearDateRange(): void;
  getDateRange(): google_ads_googleads_v4_common_dates_pb.DateRange | undefined;
  setDateRange(value?: google_ads_googleads_v4_common_dates_pb.DateRange): void;
...
export namespace KeywordPlanForecastPeriod {
  export type AsObject = {
    dateInterval: google_ads_googleads_v4_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap[keyof google_ads_googleads_v4_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap],
    dateRange?: google_ads_googleads_v4_common_dates_pb.DateRange.AsObject,
  }
