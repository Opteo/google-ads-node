...
// file: google/ads/googleads/v4/services/ad_group_extension_setting_service.proto
...
export class AdGroupExtensionSettingOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_ad_group_extension_setting_pb.AdGroupExtensionSetting | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_ad_group_extension_setting_pb.AdGroupExtensionSetting): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_ad_group_extension_setting_pb.AdGroupExtensionSetting | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_ad_group_extension_setting_pb.AdGroupExtensionSetting): void;
...
export namespace AdGroupExtensionSettingOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_ad_group_extension_setting_pb.AdGroupExtensionSetting.AsObject,
    update?: google_ads_googleads_v4_resources_ad_group_extension_setting_pb.AdGroupExtensionSetting.AsObject,
    remove: string,
  }
