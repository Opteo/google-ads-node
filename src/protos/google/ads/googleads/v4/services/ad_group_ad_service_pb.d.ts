...
// file: google/ads/googleads/v4/services/ad_group_ad_service.proto
...
export class AdGroupAdOperation extends jspb.Message {
  ...
  getPolicyValidationParameter(): google_ads_googleads_v4_common_policy_pb.PolicyValidationParameter | undefined;
  setPolicyValidationParameter(value?: google_ads_googleads_v4_common_policy_pb.PolicyValidationParameter): void;

  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_ad_group_ad_pb.AdGroupAd | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_ad_group_ad_pb.AdGroupAd): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_ad_group_ad_pb.AdGroupAd | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_ad_group_ad_pb.AdGroupAd): void;
...
export namespace AdGroupAdOperation {
  export type AsObject = {
    ...
    policyValidationParameter?: google_ads_googleads_v4_common_policy_pb.PolicyValidationParameter.AsObject,
    create?: google_ads_googleads_v4_resources_ad_group_ad_pb.AdGroupAd.AsObject,
    update?: google_ads_googleads_v4_resources_ad_group_ad_pb.AdGroupAd.AsObject,
    remove: string,
  }
