...
// file: google/ads/googleads/v4/services/campaign_shared_set_service.proto
...
export class CampaignSharedSetOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_campaign_shared_set_pb.CampaignSharedSet | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_campaign_shared_set_pb.CampaignSharedSet): void;
...
export namespace CampaignSharedSetOperation {
  export type AsObject = {
    create?: google_ads_googleads_v4_resources_campaign_shared_set_pb.CampaignSharedSet.AsObject,
    remove: string,
  }
