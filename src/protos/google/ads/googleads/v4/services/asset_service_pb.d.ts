...
// file: google/ads/googleads/v4/services/asset_service.proto
...
export class AssetOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_asset_pb.Asset | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_asset_pb.Asset): void;
...
export namespace AssetOperation {
  export type AsObject = {
    create?: google_ads_googleads_v4_resources_asset_pb.Asset.AsObject,
  }
