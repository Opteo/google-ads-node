...
// file: google/ads/googleads/v4/services/conversion_adjustment_upload_service.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_conversion_adjustment_type_pb from "../../../../../google/ads/googleads/v4/enums/conversion_adjustment_type_pb";
...
export class ConversionAdjustment extends jspb.Message {
  ...
  getAdjustmentType(): google_ads_googleads_v4_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap[keyof google_ads_googleads_v4_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap];
  setAdjustmentType(value: google_ads_googleads_v4_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap[keyof google_ads_googleads_v4_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap]): void;
...
export namespace ConversionAdjustment {
  export type AsObject = {
    ...
    adjustmentType: google_ads_googleads_v4_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap[keyof google_ads_googleads_v4_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap],
