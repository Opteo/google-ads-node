...
// file: google/ads/googleads/v4/services/user_list_service.proto
...
export class UserListOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_user_list_pb.UserList | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_user_list_pb.UserList): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_user_list_pb.UserList | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_user_list_pb.UserList): void;
...
export namespace UserListOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_user_list_pb.UserList.AsObject,
    update?: google_ads_googleads_v4_resources_user_list_pb.UserList.AsObject,
    remove: string,
  }
