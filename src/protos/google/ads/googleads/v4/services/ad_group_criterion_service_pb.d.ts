...
// file: google/ads/googleads/v4/services/ad_group_criterion_service.proto
...
export class AdGroupCriterionOperation extends jspb.Message {
  ...
  getExemptPolicyViolationKeysList(): Array<google_ads_googleads_v4_common_policy_pb.PolicyViolationKey>;
  setExemptPolicyViolationKeysList(value: Array<google_ads_googleads_v4_common_policy_pb.PolicyViolationKey>): void;
  addExemptPolicyViolationKeys(value?: google_ads_googleads_v4_common_policy_pb.PolicyViolationKey, index?: number): google_ads_googleads_v4_common_policy_pb.PolicyViolationKey;

  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_ad_group_criterion_pb.AdGroupCriterion | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_ad_group_criterion_pb.AdGroupCriterion): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_ad_group_criterion_pb.AdGroupCriterion | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_ad_group_criterion_pb.AdGroupCriterion): void;
...
export namespace AdGroupCriterionOperation {
  export type AsObject = {
    ...
    exemptPolicyViolationKeysList: Array<google_ads_googleads_v4_common_policy_pb.PolicyViolationKey.AsObject>,
    create?: google_ads_googleads_v4_resources_ad_group_criterion_pb.AdGroupCriterion.AsObject,
    update?: google_ads_googleads_v4_resources_ad_group_criterion_pb.AdGroupCriterion.AsObject,
    remove: string,
  }
