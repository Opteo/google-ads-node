...
// file: google/ads/googleads/v4/services/bidding_strategy_service.proto
...
export class BiddingStrategyOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_bidding_strategy_pb.BiddingStrategy | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_bidding_strategy_pb.BiddingStrategy): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_bidding_strategy_pb.BiddingStrategy | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_bidding_strategy_pb.BiddingStrategy): void;
...
export namespace BiddingStrategyOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_bidding_strategy_pb.BiddingStrategy.AsObject,
    update?: google_ads_googleads_v4_resources_bidding_strategy_pb.BiddingStrategy.AsObject,
    remove: string,
  }
