...
// file: google/ads/googleads/v4/services/customer_service.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_access_role_pb from "../../../../../google/ads/googleads/v4/enums/access_role_pb";
...
export class CreateCustomerClientRequest extends jspb.Message {
  ...
  getCustomerClient(): google_ads_googleads_v4_resources_customer_pb.Customer | undefined;
  setCustomerClient(value?: google_ads_googleads_v4_resources_customer_pb.Customer): void;
  ...
  getAccessRole(): google_ads_googleads_v4_enums_access_role_pb.AccessRoleEnum.AccessRoleMap[keyof google_ads_googleads_v4_enums_access_role_pb.AccessRoleEnum.AccessRoleMap];
  setAccessRole(value: google_ads_googleads_v4_enums_access_role_pb.AccessRoleEnum.AccessRoleMap[keyof google_ads_googleads_v4_enums_access_role_pb.AccessRoleEnum.AccessRoleMap]): void;
...
export namespace CreateCustomerClientRequest {
  export type AsObject = {
    customerId: string,
    customerClient?: google_ads_googleads_v4_resources_customer_pb.Customer.AsObject,
    emailAddress?: google_protobuf_wrappers_pb.StringValue.AsObject,
    accessRole: google_ads_googleads_v4_enums_access_role_pb.AccessRoleEnum.AccessRoleMap[keyof google_ads_googleads_v4_enums_access_role_pb.AccessRoleEnum.AccessRoleMap],
  }
}
...
export class CustomerOperation extends jspb.Message {
  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_customer_pb.Customer | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_customer_pb.Customer): void;
...
export namespace CustomerOperation {
  export type AsObject = {
    update?: google_ads_googleads_v4_resources_customer_pb.Customer.AsObject,
...
export class CreateCustomerClientResponse extends jspb.Message {
  ...
  setInvitationLink(value: string): void;
