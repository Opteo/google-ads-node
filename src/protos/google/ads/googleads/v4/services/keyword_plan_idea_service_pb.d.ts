...
// file: google/ads/googleads/v4/services/keyword_plan_idea_service.proto
...
import * as google_ads_googleads_v4_enums_keyword_plan_network_pb from "../../../../../google/ads/googleads/v4/enums/keyword_plan_network_pb";
...
export class GenerateKeywordIdeasRequest extends jspb.Message {
  ...
  getIncludeAdultKeywords(): boolean;
  setIncludeAdultKeywords(value: boolean): void;
  ...
  getKeywordPlanNetwork(): google_ads_googleads_v4_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap[keyof google_ads_googleads_v4_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap];
  setKeywordPlanNetwork(value: google_ads_googleads_v4_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap[keyof google_ads_googleads_v4_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap]): void;
  ...
  hasSiteSeed(): boolean;
  clearSiteSeed(): void;
  getSiteSeed(): SiteSeed | undefined;
  setSiteSeed(value?: SiteSeed): void;
...
export namespace GenerateKeywordIdeasRequest {
  export type AsObject = {
    ...
    pageToken: string,
    pageSize: number,
    keywordPlanNetwork: google_ads_googleads_v4_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap[keyof google_ads_googleads_v4_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap],
    keywordAndUrlSeed?: KeywordAndUrlSeed.AsObject,
    keywordSeed?: KeywordSeed.AsObject,
    urlSeed?: UrlSeed.AsObject,
    siteSeed?: SiteSeed.AsObject,
  }
...
export class SiteSeed extends jspb.Message {
  hasSite(): boolean;
  clearSite(): void;
  getSite(): google_protobuf_wrappers_pb.StringValue | undefined;
  setSite(value?: google_protobuf_wrappers_pb.StringValue): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SiteSeed.AsObject;
  static toObject(includeInstance: boolean, msg: SiteSeed): SiteSeed.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: SiteSeed, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SiteSeed;
  static deserializeBinaryFromReader(message: SiteSeed, reader: jspb.BinaryReader): SiteSeed;
}

export namespace SiteSeed {
  export type AsObject = {
    site?: google_protobuf_wrappers_pb.StringValue.AsObject,
  }
}
...
export class GenerateKeywordIdeaResult extends jspb.Message {
  ...
  getKeywordIdeaMetrics(): google_ads_googleads_v4_common_keyword_plan_common_pb.KeywordPlanHistoricalMetrics | undefined;
  setKeywordIdeaMetrics(value?: google_ads_googleads_v4_common_keyword_plan_common_pb.KeywordPlanHistoricalMetrics): void;
...
export namespace GenerateKeywordIdeaResult {
  export type AsObject = {
    ...
    keywordIdeaMetrics?: google_ads_googleads_v4_common_keyword_plan_common_pb.KeywordPlanHistoricalMetrics.AsObject,
  }
}
