...
// file: google/ads/googleads/v4/services/ad_service.proto
...
export class AdOperation extends jspb.Message {
  ...
  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_ad_pb.Ad | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_ad_pb.Ad): void;
...
export namespace AdOperation {
  export type AsObject = {
    ...
    update?: google_ads_googleads_v4_resources_ad_pb.Ad.AsObject,
  }
