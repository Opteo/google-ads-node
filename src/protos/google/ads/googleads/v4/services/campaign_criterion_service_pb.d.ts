...
// file: google/ads/googleads/v4/services/campaign_criterion_service.proto
...
export class CampaignCriterionOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_campaign_criterion_pb.CampaignCriterion | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_campaign_criterion_pb.CampaignCriterion): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_campaign_criterion_pb.CampaignCriterion | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_campaign_criterion_pb.CampaignCriterion): void;
...
export namespace CampaignCriterionOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_campaign_criterion_pb.CampaignCriterion.AsObject,
    update?: google_ads_googleads_v4_resources_campaign_criterion_pb.CampaignCriterion.AsObject,
    remove: string,
  }
