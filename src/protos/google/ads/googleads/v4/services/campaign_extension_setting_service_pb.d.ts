...
// file: google/ads/googleads/v4/services/campaign_extension_setting_service.proto
...
export class CampaignExtensionSettingOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_campaign_extension_setting_pb.CampaignExtensionSetting | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_campaign_extension_setting_pb.CampaignExtensionSetting): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_campaign_extension_setting_pb.CampaignExtensionSetting | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_campaign_extension_setting_pb.CampaignExtensionSetting): void;
...
export namespace CampaignExtensionSettingOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_campaign_extension_setting_pb.CampaignExtensionSetting.AsObject,
    update?: google_ads_googleads_v4_resources_campaign_extension_setting_pb.CampaignExtensionSetting.AsObject,
    remove: string,
  }
