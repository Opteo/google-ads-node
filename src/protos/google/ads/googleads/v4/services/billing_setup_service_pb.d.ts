...
// file: google/ads/googleads/v4/services/billing_setup_service.proto
...
export class BillingSetupOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_billing_setup_pb.BillingSetup | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_billing_setup_pb.BillingSetup): void;
...
export namespace BillingSetupOperation {
  export type AsObject = {
    create?: google_ads_googleads_v4_resources_billing_setup_pb.BillingSetup.AsObject,
    remove: string,
  }
