...
// file: google/ads/googleads/v4/services/account_budget_proposal_service.proto
...
export class AccountBudgetProposalOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_account_budget_proposal_pb.AccountBudgetProposal | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_account_budget_proposal_pb.AccountBudgetProposal): void;
...
export namespace AccountBudgetProposalOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_account_budget_proposal_pb.AccountBudgetProposal.AsObject,
    remove: string,
  }
