...
// file: google/ads/googleads/v4/services/shared_set_service.proto
...
export class SharedSetOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_shared_set_pb.SharedSet | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_shared_set_pb.SharedSet): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_shared_set_pb.SharedSet | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_shared_set_pb.SharedSet): void;
...
export namespace SharedSetOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_shared_set_pb.SharedSet.AsObject,
    update?: google_ads_googleads_v4_resources_shared_set_pb.SharedSet.AsObject,
    remove: string,
  }
