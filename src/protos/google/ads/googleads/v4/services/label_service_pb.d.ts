...
// file: google/ads/googleads/v4/services/label_service.proto
...
export class LabelOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_label_pb.Label | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_label_pb.Label): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_label_pb.Label | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_label_pb.Label): void;
...
export namespace LabelOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_label_pb.Label.AsObject,
    update?: google_ads_googleads_v4_resources_label_pb.Label.AsObject,
    remove: string,
  }
