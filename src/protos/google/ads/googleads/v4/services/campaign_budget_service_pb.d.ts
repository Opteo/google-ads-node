...
// file: google/ads/googleads/v4/services/campaign_budget_service.proto
...
export class CampaignBudgetOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_campaign_budget_pb.CampaignBudget | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_campaign_budget_pb.CampaignBudget): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_campaign_budget_pb.CampaignBudget | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_campaign_budget_pb.CampaignBudget): void;
...
export namespace CampaignBudgetOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_campaign_budget_pb.CampaignBudget.AsObject,
    update?: google_ads_googleads_v4_resources_campaign_budget_pb.CampaignBudget.AsObject,
    remove: string,
  }
