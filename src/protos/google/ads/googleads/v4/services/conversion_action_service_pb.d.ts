...
// file: google/ads/googleads/v4/services/conversion_action_service.proto
...
export class ConversionActionOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_conversion_action_pb.ConversionAction | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_conversion_action_pb.ConversionAction): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_conversion_action_pb.ConversionAction | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_conversion_action_pb.ConversionAction): void;
...
export namespace ConversionActionOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_conversion_action_pb.ConversionAction.AsObject,
    update?: google_ads_googleads_v4_resources_conversion_action_pb.ConversionAction.AsObject,
    remove: string,
  }
