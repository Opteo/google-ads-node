...
// file: google/ads/googleads/v4/services/keyword_plan_campaign_service.proto
...
export class KeywordPlanCampaignOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_keyword_plan_campaign_pb.KeywordPlanCampaign | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_keyword_plan_campaign_pb.KeywordPlanCampaign): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_keyword_plan_campaign_pb.KeywordPlanCampaign | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_keyword_plan_campaign_pb.KeywordPlanCampaign): void;
...
export namespace KeywordPlanCampaignOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_keyword_plan_campaign_pb.KeywordPlanCampaign.AsObject,
    update?: google_ads_googleads_v4_resources_keyword_plan_campaign_pb.KeywordPlanCampaign.AsObject,
    remove: string,
  }
