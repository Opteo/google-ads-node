...
// file: google/ads/googleads/v4/services/ad_group_ad_label_service.proto
...
export class AdGroupAdLabelOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_ad_group_ad_label_pb.AdGroupAdLabel | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_ad_group_ad_label_pb.AdGroupAdLabel): void;
...
export namespace AdGroupAdLabelOperation {
  export type AsObject = {
    create?: google_ads_googleads_v4_resources_ad_group_ad_label_pb.AdGroupAdLabel.AsObject,
    remove: string,
  }
