...
// file: google/ads/googleads/v4/services/ad_group_label_service.proto
...
export class AdGroupLabelOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_ad_group_label_pb.AdGroupLabel | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_ad_group_label_pb.AdGroupLabel): void;
...
export namespace AdGroupLabelOperation {
  export type AsObject = {
    create?: google_ads_googleads_v4_resources_ad_group_label_pb.AdGroupLabel.AsObject,
    remove: string,
  }
