...
// file: google/ads/googleads/v4/services/invoice_service.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_enums_month_of_year_pb from "../../../../../google/ads/googleads/v4/enums/month_of_year_pb";
import * as google_ads_googleads_v4_resources_invoice_pb from "../../../../../google/ads/googleads/v4/resources/invoice_pb";
...
export class ListInvoicesRequest extends jspb.Message {
  ...
  getIssueMonth(): google_ads_googleads_v4_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap[keyof google_ads_googleads_v4_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap];
  setIssueMonth(value: google_ads_googleads_v4_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap[keyof google_ads_googleads_v4_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap]): void;
...
export namespace ListInvoicesRequest {
  export type AsObject = {
    ...
    billingSetup: string,
    issueYear: string,
    issueMonth: google_ads_googleads_v4_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap[keyof google_ads_googleads_v4_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap],
  }
}

export class ListInvoicesResponse extends jspb.Message {
  clearInvoicesList(): void;
  getInvoicesList(): Array<google_ads_googleads_v4_resources_invoice_pb.Invoice>;
  setInvoicesList(value: Array<google_ads_googleads_v4_resources_invoice_pb.Invoice>): void;
  addInvoices(value?: google_ads_googleads_v4_resources_invoice_pb.Invoice, index?: number): google_ads_googleads_v4_resources_invoice_pb.Invoice;
...
export namespace ListInvoicesResponse {
  export type AsObject = {
    invoicesList: Array<google_ads_googleads_v4_resources_invoice_pb.Invoice.AsObject>,
  }
}
