...
// file: google/ads/googleads/v4/services/keyword_plan_service.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v4_common_keyword_plan_common_pb from "../../../../../google/ads/googleads/v4/common/keyword_plan_common_pb";
...
export class KeywordPlanOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_keyword_plan_pb.KeywordPlan | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_keyword_plan_pb.KeywordPlan): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_keyword_plan_pb.KeywordPlan | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_keyword_plan_pb.KeywordPlan): void;
...
export namespace KeywordPlanOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_keyword_plan_pb.KeywordPlan.AsObject,
    update?: google_ads_googleads_v4_resources_keyword_plan_pb.KeywordPlan.AsObject,
    remove: string,
  }
...
export class GenerateForecastCurveRequest extends jspb.Message {
  getKeywordPlan(): string;
  setKeywordPlan(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GenerateForecastCurveRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GenerateForecastCurveRequest): GenerateForecastCurveRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GenerateForecastCurveRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GenerateForecastCurveRequest;
  static deserializeBinaryFromReader(message: GenerateForecastCurveRequest, reader: jspb.BinaryReader): GenerateForecastCurveRequest;
}

export namespace GenerateForecastCurveRequest {
  export type AsObject = {
    keywordPlan: string,
  }
}

export class GenerateForecastCurveResponse extends jspb.Message {
  clearCampaignForecastCurvesList(): void;
  getCampaignForecastCurvesList(): Array<KeywordPlanCampaignForecastCurve>;
  setCampaignForecastCurvesList(value: Array<KeywordPlanCampaignForecastCurve>): void;
  addCampaignForecastCurves(value?: KeywordPlanCampaignForecastCurve, index?: number): KeywordPlanCampaignForecastCurve;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GenerateForecastCurveResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GenerateForecastCurveResponse): GenerateForecastCurveResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GenerateForecastCurveResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GenerateForecastCurveResponse;
  static deserializeBinaryFromReader(message: GenerateForecastCurveResponse, reader: jspb.BinaryReader): GenerateForecastCurveResponse;
}

export namespace GenerateForecastCurveResponse {
  export type AsObject = {
    campaignForecastCurvesList: Array<KeywordPlanCampaignForecastCurve.AsObject>,
  }
}
...
export class KeywordPlanCampaignForecastCurve extends jspb.Message {
  hasKeywordPlanCampaign(): boolean;
  clearKeywordPlanCampaign(): void;
  getKeywordPlanCampaign(): google_protobuf_wrappers_pb.StringValue | undefined;
  setKeywordPlanCampaign(value?: google_protobuf_wrappers_pb.StringValue): void;

  hasMaxCpcBidForecastCurve(): boolean;
  clearMaxCpcBidForecastCurve(): void;
  getMaxCpcBidForecastCurve(): KeywordPlanMaxCpcBidForecastCurve | undefined;
  setMaxCpcBidForecastCurve(value?: KeywordPlanMaxCpcBidForecastCurve): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): KeywordPlanCampaignForecastCurve.AsObject;
  static toObject(includeInstance: boolean, msg: KeywordPlanCampaignForecastCurve): KeywordPlanCampaignForecastCurve.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: KeywordPlanCampaignForecastCurve, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): KeywordPlanCampaignForecastCurve;
  static deserializeBinaryFromReader(message: KeywordPlanCampaignForecastCurve, reader: jspb.BinaryReader): KeywordPlanCampaignForecastCurve;
}

export namespace KeywordPlanCampaignForecastCurve {
  export type AsObject = {
    keywordPlanCampaign?: google_protobuf_wrappers_pb.StringValue.AsObject,
    maxCpcBidForecastCurve?: KeywordPlanMaxCpcBidForecastCurve.AsObject,
  }
}

export class KeywordPlanMaxCpcBidForecastCurve extends jspb.Message {
  clearMaxCpcBidForecastsList(): void;
  getMaxCpcBidForecastsList(): Array<KeywordPlanMaxCpcBidForecast>;
  setMaxCpcBidForecastsList(value: Array<KeywordPlanMaxCpcBidForecast>): void;
  addMaxCpcBidForecasts(value?: KeywordPlanMaxCpcBidForecast, index?: number): KeywordPlanMaxCpcBidForecast;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): KeywordPlanMaxCpcBidForecastCurve.AsObject;
  static toObject(includeInstance: boolean, msg: KeywordPlanMaxCpcBidForecastCurve): KeywordPlanMaxCpcBidForecastCurve.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: KeywordPlanMaxCpcBidForecastCurve, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): KeywordPlanMaxCpcBidForecastCurve;
  static deserializeBinaryFromReader(message: KeywordPlanMaxCpcBidForecastCurve, reader: jspb.BinaryReader): KeywordPlanMaxCpcBidForecastCurve;
}

export namespace KeywordPlanMaxCpcBidForecastCurve {
  export type AsObject = {
    maxCpcBidForecastsList: Array<KeywordPlanMaxCpcBidForecast.AsObject>,
  }
}

export class KeywordPlanMaxCpcBidForecast extends jspb.Message {
  hasMaxCpcBidMicros(): boolean;
  clearMaxCpcBidMicros(): void;
  getMaxCpcBidMicros(): google_protobuf_wrappers_pb.Int64Value | undefined;
  setMaxCpcBidMicros(value?: google_protobuf_wrappers_pb.Int64Value): void;

  hasMaxCpcBidForecast(): boolean;
  clearMaxCpcBidForecast(): void;
  getMaxCpcBidForecast(): ForecastMetrics | undefined;
  setMaxCpcBidForecast(value?: ForecastMetrics): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): KeywordPlanMaxCpcBidForecast.AsObject;
  static toObject(includeInstance: boolean, msg: KeywordPlanMaxCpcBidForecast): KeywordPlanMaxCpcBidForecast.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: KeywordPlanMaxCpcBidForecast, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): KeywordPlanMaxCpcBidForecast;
  static deserializeBinaryFromReader(message: KeywordPlanMaxCpcBidForecast, reader: jspb.BinaryReader): KeywordPlanMaxCpcBidForecast;
}

export namespace KeywordPlanMaxCpcBidForecast {
  export type AsObject = {
    maxCpcBidMicros?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    maxCpcBidForecast?: ForecastMetrics.AsObject,
  }
}
...
export class KeywordPlanKeywordHistoricalMetrics extends jspb.Message {
  ...
  getKeywordMetrics(): google_ads_googleads_v4_common_keyword_plan_common_pb.KeywordPlanHistoricalMetrics | undefined;
  setKeywordMetrics(value?: google_ads_googleads_v4_common_keyword_plan_common_pb.KeywordPlanHistoricalMetrics): void;
...
export namespace KeywordPlanKeywordHistoricalMetrics {
  export type AsObject = {
    ...
    keywordMetrics?: google_ads_googleads_v4_common_keyword_plan_common_pb.KeywordPlanHistoricalMetrics.AsObject,
  }
}
