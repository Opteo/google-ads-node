...
// file: google/ads/googleads/v4/services/recommendation_service.proto
...
export namespace ApplyRecommendationOperation {
  ...
  export class CalloutExtensionParameters extends jspb.Message {
    ...
    getCalloutExtensionsList(): Array<google_ads_googleads_v4_common_extensions_pb.CalloutFeedItem>;
    setCalloutExtensionsList(value: Array<google_ads_googleads_v4_common_extensions_pb.CalloutFeedItem>): void;
    addCalloutExtensions(value?: google_ads_googleads_v4_common_extensions_pb.CalloutFeedItem, index?: number): google_ads_googleads_v4_common_extensions_pb.CalloutFeedItem;
  ...
  export namespace CalloutExtensionParameters {
    export type AsObject = {
      calloutExtensionsList: Array<google_ads_googleads_v4_common_extensions_pb.CalloutFeedItem.AsObject>,
    }
  }

  export class CallExtensionParameters extends jspb.Message {
    clearCallExtensionsList(): void;
    getCallExtensionsList(): Array<google_ads_googleads_v4_common_extensions_pb.CallFeedItem>;
    setCallExtensionsList(value: Array<google_ads_googleads_v4_common_extensions_pb.CallFeedItem>): void;
    addCallExtensions(value?: google_ads_googleads_v4_common_extensions_pb.CallFeedItem, index?: number): google_ads_googleads_v4_common_extensions_pb.CallFeedItem;
  ...
  export namespace CallExtensionParameters {
    export type AsObject = {
      callExtensionsList: Array<google_ads_googleads_v4_common_extensions_pb.CallFeedItem.AsObject>,
    }
  }

  export class SitelinkExtensionParameters extends jspb.Message {
    clearSitelinkExtensionsList(): void;
    getSitelinkExtensionsList(): Array<google_ads_googleads_v4_common_extensions_pb.SitelinkFeedItem>;
    setSitelinkExtensionsList(value: Array<google_ads_googleads_v4_common_extensions_pb.SitelinkFeedItem>): void;
    addSitelinkExtensions(value?: google_ads_googleads_v4_common_extensions_pb.SitelinkFeedItem, index?: number): google_ads_googleads_v4_common_extensions_pb.SitelinkFeedItem;
  ...
  export namespace SitelinkExtensionParameters {
    export type AsObject = {
      sitelinkExtensionsList: Array<google_ads_googleads_v4_common_extensions_pb.SitelinkFeedItem.AsObject>,
    }
  }
