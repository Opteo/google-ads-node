...
// file: google/ads/googleads/v4/services/feed_item_target_service.proto
...
export class FeedItemTargetOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_feed_item_target_pb.FeedItemTarget | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_feed_item_target_pb.FeedItemTarget): void;
...
export namespace FeedItemTargetOperation {
  export type AsObject = {
    create?: google_ads_googleads_v4_resources_feed_item_target_pb.FeedItemTarget.AsObject,
    remove: string,
  }
