...
// file: google/ads/googleads/v4/services/customer_extension_setting_service.proto
...
export class CustomerExtensionSettingOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_customer_extension_setting_pb.CustomerExtensionSetting | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_customer_extension_setting_pb.CustomerExtensionSetting): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_customer_extension_setting_pb.CustomerExtensionSetting | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_customer_extension_setting_pb.CustomerExtensionSetting): void;
...
export namespace CustomerExtensionSettingOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_customer_extension_setting_pb.CustomerExtensionSetting.AsObject,
    update?: google_ads_googleads_v4_resources_customer_extension_setting_pb.CustomerExtensionSetting.AsObject,
    remove: string,
  }
