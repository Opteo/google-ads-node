...
// file: google/ads/googleads/v4/services/ad_group_service.proto
...
export class AdGroupOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_ad_group_pb.AdGroup | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_ad_group_pb.AdGroup): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_ad_group_pb.AdGroup | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_ad_group_pb.AdGroup): void;
...
export namespace AdGroupOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_ad_group_pb.AdGroup.AsObject,
    update?: google_ads_googleads_v4_resources_ad_group_pb.AdGroup.AsObject,
    remove: string,
  }
