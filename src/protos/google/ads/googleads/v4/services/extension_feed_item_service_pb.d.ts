...
// file: google/ads/googleads/v4/services/extension_feed_item_service.proto
...
export class ExtensionFeedItemOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_extension_feed_item_pb.ExtensionFeedItem | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_extension_feed_item_pb.ExtensionFeedItem): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_extension_feed_item_pb.ExtensionFeedItem | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_extension_feed_item_pb.ExtensionFeedItem): void;
...
export namespace ExtensionFeedItemOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_extension_feed_item_pb.ExtensionFeedItem.AsObject,
    update?: google_ads_googleads_v4_resources_extension_feed_item_pb.ExtensionFeedItem.AsObject,
    remove: string,
  }
