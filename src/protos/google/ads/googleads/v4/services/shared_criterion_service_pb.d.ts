...
// file: google/ads/googleads/v4/services/shared_criterion_service.proto
...
export class SharedCriterionOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_shared_criterion_pb.SharedCriterion | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_shared_criterion_pb.SharedCriterion): void;
...
export namespace SharedCriterionOperation {
  export type AsObject = {
    create?: google_ads_googleads_v4_resources_shared_criterion_pb.SharedCriterion.AsObject,
    remove: string,
  }
