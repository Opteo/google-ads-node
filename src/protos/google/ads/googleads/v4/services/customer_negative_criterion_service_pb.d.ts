...
// file: google/ads/googleads/v4/services/customer_negative_criterion_service.proto
...
export class CustomerNegativeCriterionOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_customer_negative_criterion_pb.CustomerNegativeCriterion | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_customer_negative_criterion_pb.CustomerNegativeCriterion): void;
...
export namespace CustomerNegativeCriterionOperation {
  export type AsObject = {
    create?: google_ads_googleads_v4_resources_customer_negative_criterion_pb.CustomerNegativeCriterion.AsObject,
    remove: string,
  }
