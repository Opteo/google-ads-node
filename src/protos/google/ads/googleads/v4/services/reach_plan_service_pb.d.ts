...
// file: google/ads/googleads/v4/services/reach_plan_service.proto
...
import * as google_ads_googleads_v4_enums_reach_plan_ad_length_pb from "../../../../../google/ads/googleads/v4/enums/reach_plan_ad_length_pb";
import * as google_ads_googleads_v4_enums_reach_plan_age_range_pb from "../../../../../google/ads/googleads/v4/enums/reach_plan_age_range_pb";
import * as google_ads_googleads_v4_enums_reach_plan_network_pb from "../../../../../google/ads/googleads/v4/enums/reach_plan_network_pb";
...
export class PlannableTargeting extends jspb.Message {
  ...
  getAgeRangesList(): Array<google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap]>;
  setAgeRangesList(value: Array<google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap]>): void;
  addAgeRanges(value: google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap], index?: number): google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap];

  clearGendersList(): void;
  getGendersList(): Array<google_ads_googleads_v4_common_criteria_pb.GenderInfo>;
  setGendersList(value: Array<google_ads_googleads_v4_common_criteria_pb.GenderInfo>): void;
  addGenders(value?: google_ads_googleads_v4_common_criteria_pb.GenderInfo, index?: number): google_ads_googleads_v4_common_criteria_pb.GenderInfo;

  clearDevicesList(): void;
  getDevicesList(): Array<google_ads_googleads_v4_common_criteria_pb.DeviceInfo>;
  setDevicesList(value: Array<google_ads_googleads_v4_common_criteria_pb.DeviceInfo>): void;
  addDevices(value?: google_ads_googleads_v4_common_criteria_pb.DeviceInfo, index?: number): google_ads_googleads_v4_common_criteria_pb.DeviceInfo;

  clearNetworksList(): void;
  getNetworksList(): Array<google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap[keyof google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap]>;
  setNetworksList(value: Array<google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap[keyof google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap]>): void;
  addNetworks(value: google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap[keyof google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap], index?: number): google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap[keyof google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap];
...
export namespace PlannableTargeting {
  export type AsObject = {
    ageRangesList: Array<google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap]>,
    gendersList: Array<google_ads_googleads_v4_common_criteria_pb.GenderInfo.AsObject>,
    devicesList: Array<google_ads_googleads_v4_common_criteria_pb.DeviceInfo.AsObject>,
    networksList: Array<google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap[keyof google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap]>,
  }
}
...
export class Preferences extends jspb.Message {
  ...
  getAdLength(): google_ads_googleads_v4_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap[keyof google_ads_googleads_v4_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap];
  setAdLength(value: google_ads_googleads_v4_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap[keyof google_ads_googleads_v4_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap]): void;
...
export namespace Preferences {
  export type AsObject = {
    ...
    adLength: google_ads_googleads_v4_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap[keyof google_ads_googleads_v4_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap],
...
export class GenerateReachForecastRequest extends jspb.Message {
  ...
  hasCookieFrequencyCapSetting(): boolean;
  clearCookieFrequencyCapSetting(): void;
  getCookieFrequencyCapSetting(): FrequencyCap | undefined;
  setCookieFrequencyCapSetting(value?: FrequencyCap): void;
...
export namespace GenerateReachForecastRequest {
  export type AsObject = {
    ...
    cookieFrequencyCapSetting?: FrequencyCap.AsObject,
...
export class FrequencyCap extends jspb.Message {
  hasImpressions(): boolean;
  clearImpressions(): void;
  getImpressions(): google_protobuf_wrappers_pb.Int32Value | undefined;
  setImpressions(value?: google_protobuf_wrappers_pb.Int32Value): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): FrequencyCap.AsObject;
  static toObject(includeInstance: boolean, msg: FrequencyCap): FrequencyCap.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: FrequencyCap, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): FrequencyCap;
  static deserializeBinaryFromReader(message: FrequencyCap, reader: jspb.BinaryReader): FrequencyCap;
}

export namespace FrequencyCap {
  export type AsObject = {
    impressions?: google_protobuf_wrappers_pb.Int32Value.AsObject,
...
export class Targeting extends jspb.Message {
  ...
  getAgeRange(): google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap];
  setAgeRange(value: google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap]): void;
  ...
  getNetwork(): google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap[keyof google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap];
  setNetwork(value: google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap[keyof google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap]): void;
...
export namespace Targeting {
  export type AsObject = {
    plannableLocationId?: google_protobuf_wrappers_pb.StringValue.AsObject,
    ageRange: google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v4_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap],
    gendersList: Array<google_ads_googleads_v4_common_criteria_pb.GenderInfo.AsObject>,
    devicesList: Array<google_ads_googleads_v4_common_criteria_pb.DeviceInfo.AsObject>,
    network: google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap[keyof google_ads_googleads_v4_enums_reach_plan_network_pb.ReachPlanNetworkEnum.ReachPlanNetworkMap],
  }
}
