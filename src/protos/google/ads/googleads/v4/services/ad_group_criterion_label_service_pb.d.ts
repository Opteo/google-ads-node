...
// file: google/ads/googleads/v4/services/ad_group_criterion_label_service.proto
...
export class AdGroupCriterionLabelOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_ad_group_criterion_label_pb.AdGroupCriterionLabel | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_ad_group_criterion_label_pb.AdGroupCriterionLabel): void;
...
export namespace AdGroupCriterionLabelOperation {
  export type AsObject = {
    create?: google_ads_googleads_v4_resources_ad_group_criterion_label_pb.AdGroupCriterionLabel.AsObject,
    remove: string,
  }
