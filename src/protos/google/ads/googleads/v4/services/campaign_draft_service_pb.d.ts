...
// file: google/ads/googleads/v4/services/campaign_draft_service.proto
...
export class CampaignDraftOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v4_resources_campaign_draft_pb.CampaignDraft | undefined;
  setCreate(value?: google_ads_googleads_v4_resources_campaign_draft_pb.CampaignDraft): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v4_resources_campaign_draft_pb.CampaignDraft | undefined;
  setUpdate(value?: google_ads_googleads_v4_resources_campaign_draft_pb.CampaignDraft): void;
...
export namespace CampaignDraftOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v4_resources_campaign_draft_pb.CampaignDraft.AsObject,
    update?: google_ads_googleads_v4_resources_campaign_draft_pb.CampaignDraft.AsObject,
    remove: string,
  }
