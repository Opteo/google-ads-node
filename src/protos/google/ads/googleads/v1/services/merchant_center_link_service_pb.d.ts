...
export class ListMerchantCenterLinksResponse extends jspb.Message {
  ...
  getMerchantCenterLinksList(): Array<google_ads_googleads_v1_resources_merchant_center_link_pb.MerchantCenterLink>;
  setMerchantCenterLinksList(value: Array<google_ads_googleads_v1_resources_merchant_center_link_pb.MerchantCenterLink>): void;
  addMerchantCenterLinks(value?: google_ads_googleads_v1_resources_merchant_center_link_pb.MerchantCenterLink, index?: number): google_ads_googleads_v1_resources_merchant_center_link_pb.MerchantCenterLink;
...
export namespace ListMerchantCenterLinksResponse {
  export type AsObject = {
    merchantCenterLinksList: Array<google_ads_googleads_v1_resources_merchant_center_link_pb.MerchantCenterLink.AsObject>,
  }
}
...
export class MerchantCenterLinkOperation extends jspb.Message {
  ...
  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v1_resources_merchant_center_link_pb.MerchantCenterLink | undefined;
  setUpdate(value?: google_ads_googleads_v1_resources_merchant_center_link_pb.MerchantCenterLink): void;
...
export namespace MerchantCenterLinkOperation {
  export type AsObject = {
    ...
    update?: google_ads_googleads_v1_resources_merchant_center_link_pb.MerchantCenterLink.AsObject,
    remove: string,
  }
