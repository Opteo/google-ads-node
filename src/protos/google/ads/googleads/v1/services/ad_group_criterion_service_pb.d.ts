...
export class AdGroupCriterionOperation extends jspb.Message {
  ...
  setCreate(value?: google_ads_googleads_v1_resources_ad_group_criterion_pb.AdGroupCriterion): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v1_resources_ad_group_criterion_pb.AdGroupCriterion | undefined;
  setUpdate(value?: google_ads_googleads_v1_resources_ad_group_criterion_pb.AdGroupCriterion): void;
