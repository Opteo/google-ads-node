...
export class AdParameterOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v1_resources_ad_parameter_pb.AdParameter | undefined;
  setCreate(value?: google_ads_googleads_v1_resources_ad_parameter_pb.AdParameter): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v1_resources_ad_parameter_pb.AdParameter | undefined;
  setUpdate(value?: google_ads_googleads_v1_resources_ad_parameter_pb.AdParameter): void;
...
export namespace AdParameterOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v1_resources_ad_parameter_pb.AdParameter.AsObject,
    update?: google_ads_googleads_v1_resources_ad_parameter_pb.AdParameter.AsObject,
    remove: string,
  }
