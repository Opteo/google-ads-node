...
// file: google/ads/googleads/v1/services/mutate_job_service.proto
...
export class AddMutateJobOperationsRequest extends jspb.Message {
  ...
  getMutateOperationsList(): Array<google_ads_googleads_v1_services_google_ads_service_pb.MutateOperation>;
  setMutateOperationsList(value: Array<google_ads_googleads_v1_services_google_ads_service_pb.MutateOperation>): void;
  addMutateOperations(value?: google_ads_googleads_v1_services_google_ads_service_pb.MutateOperation, index?: number): google_ads_googleads_v1_services_google_ads_service_pb.MutateOperation;
...
export namespace AddMutateJobOperationsRequest {
  export type AsObject = {
    ...
    mutateOperationsList: Array<google_ads_googleads_v1_services_google_ads_service_pb.MutateOperation.AsObject>,
  }
}
...
export class MutateJobResult extends jspb.Message {
  ...
  getMutateOperationResponse(): google_ads_googleads_v1_services_google_ads_service_pb.MutateOperationResponse | undefined;
  setMutateOperationResponse(value?: google_ads_googleads_v1_services_google_ads_service_pb.MutateOperationResponse): void;
...
export namespace MutateJobResult {
  export type AsObject = {
    ...
    mutateOperationResponse?: google_ads_googleads_v1_services_google_ads_service_pb.MutateOperationResponse.AsObject,
