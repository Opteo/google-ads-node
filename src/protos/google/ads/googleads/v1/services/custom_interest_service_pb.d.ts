...
// file: google/ads/googleads/v1/services/custom_interest_service.proto
...
export class CustomInterestOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v1_resources_custom_interest_pb.CustomInterest | undefined;
  setCreate(value?: google_ads_googleads_v1_resources_custom_interest_pb.CustomInterest): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v1_resources_custom_interest_pb.CustomInterest | undefined;
  setUpdate(value?: google_ads_googleads_v1_resources_custom_interest_pb.CustomInterest): void;
...
export namespace CustomInterestOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v1_resources_custom_interest_pb.CustomInterest.AsObject,
    update?: google_ads_googleads_v1_resources_custom_interest_pb.CustomInterest.AsObject,
  }
