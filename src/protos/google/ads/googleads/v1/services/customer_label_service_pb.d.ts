...
export class CustomerLabelOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v1_resources_customer_label_pb.CustomerLabel | undefined;
  setCreate(value?: google_ads_googleads_v1_resources_customer_label_pb.CustomerLabel): void;
...
export namespace CustomerLabelOperation {
  export type AsObject = {
    create?: google_ads_googleads_v1_resources_customer_label_pb.CustomerLabel.AsObject,
    remove: string,
  }
