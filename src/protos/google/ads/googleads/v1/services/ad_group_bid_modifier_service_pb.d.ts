...
export class AdGroupBidModifierOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v1_resources_ad_group_bid_modifier_pb.AdGroupBidModifier | undefined;
  setCreate(value?: google_ads_googleads_v1_resources_ad_group_bid_modifier_pb.AdGroupBidModifier): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v1_resources_ad_group_bid_modifier_pb.AdGroupBidModifier | undefined;
  setUpdate(value?: google_ads_googleads_v1_resources_ad_group_bid_modifier_pb.AdGroupBidModifier): void;
...
export namespace AdGroupBidModifierOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v1_resources_ad_group_bid_modifier_pb.AdGroupBidModifier.AsObject,
    update?: google_ads_googleads_v1_resources_ad_group_bid_modifier_pb.AdGroupBidModifier.AsObject,
    remove: string,
  }
