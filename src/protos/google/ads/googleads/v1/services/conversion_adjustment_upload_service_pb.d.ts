...
import * as google_ads_googleads_v1_enums_conversion_adjustment_type_pb from "../../../../../google/ads/googleads/v1/enums/conversion_adjustment_type_pb";
...
export class ConversionAdjustment extends jspb.Message {
  ...
  getAdjustmentType(): google_ads_googleads_v1_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentType;
  setAdjustmentType(value: google_ads_googleads_v1_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentType): void;
...
export namespace ConversionAdjustment {
  export type AsObject = {
    ...
    adjustmentType: google_ads_googleads_v1_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentType,
