...
export class KeywordPlanOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v1_resources_keyword_plan_pb.KeywordPlan | undefined;
  setCreate(value?: google_ads_googleads_v1_resources_keyword_plan_pb.KeywordPlan): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v1_resources_keyword_plan_pb.KeywordPlan | undefined;
  setUpdate(value?: google_ads_googleads_v1_resources_keyword_plan_pb.KeywordPlan): void;
...
export namespace KeywordPlanOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v1_resources_keyword_plan_pb.KeywordPlan.AsObject,
    update?: google_ads_googleads_v1_resources_keyword_plan_pb.KeywordPlan.AsObject,
    remove: string,
  }
...
export class KeywordPlanKeywordHistoricalMetrics extends jspb.Message {
  ...
  getKeywordMetrics(): google_ads_googleads_v1_common_keyword_plan_common_pb.KeywordPlanHistoricalMetrics | undefined;
  setKeywordMetrics(value?: google_ads_googleads_v1_common_keyword_plan_common_pb.KeywordPlanHistoricalMetrics): void;
...
export namespace KeywordPlanKeywordHistoricalMetrics {
  export type AsObject = {
    ...
    keywordMetrics?: google_ads_googleads_v1_common_keyword_plan_common_pb.KeywordPlanHistoricalMetrics.AsObject,
  }
}
