...
// file: google/ads/googleads/v1/common/user_lists.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_enums_customer_match_upload_key_type_pb from "../../../../../google/ads/googleads/v1/enums/customer_match_upload_key_type_pb";
import * as google_ads_googleads_v1_enums_user_list_combined_rule_operator_pb from "../../../../../google/ads/googleads/v1/enums/user_list_combined_rule_operator_pb";
import * as google_ads_googleads_v1_enums_user_list_crm_data_source_type_pb from "../../../../../google/ads/googleads/v1/enums/user_list_crm_data_source_type_pb";
import * as google_ads_googleads_v1_enums_user_list_date_rule_item_operator_pb from "../../../../../google/ads/googleads/v1/enums/user_list_date_rule_item_operator_pb";
import * as google_ads_googleads_v1_enums_user_list_logical_rule_operator_pb from "../../../../../google/ads/googleads/v1/enums/user_list_logical_rule_operator_pb";
import * as google_ads_googleads_v1_enums_user_list_number_rule_item_operator_pb from "../../../../../google/ads/googleads/v1/enums/user_list_number_rule_item_operator_pb";
import * as google_ads_googleads_v1_enums_user_list_prepopulation_status_pb from "../../../../../google/ads/googleads/v1/enums/user_list_prepopulation_status_pb";
import * as google_ads_googleads_v1_enums_user_list_rule_type_pb from "../../../../../google/ads/googleads/v1/enums/user_list_rule_type_pb";
import * as google_ads_googleads_v1_enums_user_list_string_rule_item_operator_pb from "../../../../../google/ads/googleads/v1/enums/user_list_string_rule_item_operator_pb";
...
export class CrmBasedUserListInfo extends jspb.Message {
  ...
  getUploadKeyType(): google_ads_googleads_v1_enums_customer_match_upload_key_type_pb.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType;
  setUploadKeyType(value: google_ads_googleads_v1_enums_customer_match_upload_key_type_pb.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType): void;

  getDataSourceType(): google_ads_googleads_v1_enums_user_list_crm_data_source_type_pb.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType;
  setDataSourceType(value: google_ads_googleads_v1_enums_user_list_crm_data_source_type_pb.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType): void;
...
export namespace CrmBasedUserListInfo {
  export type AsObject = {
    ...
    uploadKeyType: google_ads_googleads_v1_enums_customer_match_upload_key_type_pb.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType,
    dataSourceType: google_ads_googleads_v1_enums_user_list_crm_data_source_type_pb.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType,
  }
}

export class UserListRuleInfo extends jspb.Message {
  getRuleType(): google_ads_googleads_v1_enums_user_list_rule_type_pb.UserListRuleTypeEnum.UserListRuleType;
  setRuleType(value: google_ads_googleads_v1_enums_user_list_rule_type_pb.UserListRuleTypeEnum.UserListRuleType): void;
...
export namespace UserListRuleInfo {
  export type AsObject = {
    ruleType: google_ads_googleads_v1_enums_user_list_rule_type_pb.UserListRuleTypeEnum.UserListRuleType,
...
export class UserListDateRuleItemInfo extends jspb.Message {
  getOperator(): google_ads_googleads_v1_enums_user_list_date_rule_item_operator_pb.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator;
  setOperator(value: google_ads_googleads_v1_enums_user_list_date_rule_item_operator_pb.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator): void;
...
export namespace UserListDateRuleItemInfo {
  export type AsObject = {
    operator: google_ads_googleads_v1_enums_user_list_date_rule_item_operator_pb.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator,
...
export class UserListNumberRuleItemInfo extends jspb.Message {
  getOperator(): google_ads_googleads_v1_enums_user_list_number_rule_item_operator_pb.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator;
  setOperator(value: google_ads_googleads_v1_enums_user_list_number_rule_item_operator_pb.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator): void;
...
export namespace UserListNumberRuleItemInfo {
  export type AsObject = {
    operator: google_ads_googleads_v1_enums_user_list_number_rule_item_operator_pb.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator,
    value?: google_protobuf_wrappers_pb.DoubleValue.AsObject,
  }
}

export class UserListStringRuleItemInfo extends jspb.Message {
  getOperator(): google_ads_googleads_v1_enums_user_list_string_rule_item_operator_pb.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator;
  setOperator(value: google_ads_googleads_v1_enums_user_list_string_rule_item_operator_pb.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator): void;
...
export namespace UserListStringRuleItemInfo {
  export type AsObject = {
    operator: google_ads_googleads_v1_enums_user_list_string_rule_item_operator_pb.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator,
    value?: google_protobuf_wrappers_pb.StringValue.AsObject,
  }
}
...
export class CombinedRuleUserListInfo extends jspb.Message {
  ...
  getRuleOperator(): google_ads_googleads_v1_enums_user_list_combined_rule_operator_pb.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator;
  setRuleOperator(value: google_ads_googleads_v1_enums_user_list_combined_rule_operator_pb.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator): void;
...
export namespace CombinedRuleUserListInfo {
  export type AsObject = {
    ...
    ruleOperator: google_ads_googleads_v1_enums_user_list_combined_rule_operator_pb.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator,
  }
}
...
export class RuleBasedUserListInfo extends jspb.Message {
  getPrepopulationStatus(): google_ads_googleads_v1_enums_user_list_prepopulation_status_pb.UserListPrepopulationStatusEnum.UserListPrepopulationStatus;
  setPrepopulationStatus(value: google_ads_googleads_v1_enums_user_list_prepopulation_status_pb.UserListPrepopulationStatusEnum.UserListPrepopulationStatus): void;
...
export namespace RuleBasedUserListInfo {
  export type AsObject = {
    prepopulationStatus: google_ads_googleads_v1_enums_user_list_prepopulation_status_pb.UserListPrepopulationStatusEnum.UserListPrepopulationStatus,
...
export class UserListLogicalRuleInfo extends jspb.Message {
  getOperator(): google_ads_googleads_v1_enums_user_list_logical_rule_operator_pb.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator;
  setOperator(value: google_ads_googleads_v1_enums_user_list_logical_rule_operator_pb.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator): void;
...
export namespace UserListLogicalRuleInfo {
  export type AsObject = {
    operator: google_ads_googleads_v1_enums_user_list_logical_rule_operator_pb.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator,
