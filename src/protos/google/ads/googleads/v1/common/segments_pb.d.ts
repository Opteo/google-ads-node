...
// file: google/ads/googleads/v1/common/segments.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_common_criteria_pb from "../../../../../google/ads/googleads/v1/common/criteria_pb";
import * as google_ads_googleads_v1_enums_ad_network_type_pb from "../../../../../google/ads/googleads/v1/enums/ad_network_type_pb";
import * as google_ads_googleads_v1_enums_click_type_pb from "../../../../../google/ads/googleads/v1/enums/click_type_pb";
...
import * as google_ads_googleads_v1_enums_conversion_attribution_event_type_pb from "../../../../../google/ads/googleads/v1/enums/conversion_attribution_event_type_pb";
import * as google_ads_googleads_v1_enums_conversion_lag_bucket_pb from "../../../../../google/ads/googleads/v1/enums/conversion_lag_bucket_pb";
import * as google_ads_googleads_v1_enums_conversion_or_adjustment_lag_bucket_pb from "../../../../../google/ads/googleads/v1/enums/conversion_or_adjustment_lag_bucket_pb";
...
export class Segments extends jspb.Message {
  getAdNetworkType(): google_ads_googleads_v1_enums_ad_network_type_pb.AdNetworkTypeEnum.AdNetworkType;
  setAdNetworkType(value: google_ads_googleads_v1_enums_ad_network_type_pb.AdNetworkTypeEnum.AdNetworkType): void;

  getClickType(): google_ads_googleads_v1_enums_click_type_pb.ClickTypeEnum.ClickType;
  setClickType(value: google_ads_googleads_v1_enums_click_type_pb.ClickTypeEnum.ClickType): void;
  ...
  getConversionActionCategory(): google_ads_googleads_v1_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategory;
  setConversionActionCategory(value: google_ads_googleads_v1_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategory): void;
  ...
  getConversionAttributionEventType(): google_ads_googleads_v1_enums_conversion_attribution_event_type_pb.ConversionAttributionEventTypeEnum.ConversionAttributionEventType;
  setConversionAttributionEventType(value: google_ads_googleads_v1_enums_conversion_attribution_event_type_pb.ConversionAttributionEventTypeEnum.ConversionAttributionEventType): void;

  getConversionLagBucket(): google_ads_googleads_v1_enums_conversion_lag_bucket_pb.ConversionLagBucketEnum.ConversionLagBucket;
  setConversionLagBucket(value: google_ads_googleads_v1_enums_conversion_lag_bucket_pb.ConversionLagBucketEnum.ConversionLagBucket): void;

  getConversionOrAdjustmentLagBucket(): google_ads_googleads_v1_enums_conversion_or_adjustment_lag_bucket_pb.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket;
  setConversionOrAdjustmentLagBucket(value: google_ads_googleads_v1_enums_conversion_or_adjustment_lag_bucket_pb.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket): void;
  ...
  getDevice(): google_ads_googleads_v1_enums_device_pb.DeviceEnum.Device;
  setDevice(value: google_ads_googleads_v1_enums_device_pb.DeviceEnum.Device): void;
  ...
  getHotelCheckInDayOfWeek(): google_ads_googleads_v1_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeek;
  setHotelCheckInDayOfWeek(value: google_ads_googleads_v1_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeek): void;
  ...
  getHotelDateSelectionType(): google_ads_googleads_v1_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionType;
  setHotelDateSelectionType(value: google_ads_googleads_v1_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionType): void;
  ...
  getMonthOfYear(): google_ads_googleads_v1_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYear;
  setMonthOfYear(value: google_ads_googleads_v1_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYear): void;
  ...
  getProductChannel(): google_ads_googleads_v1_enums_product_channel_pb.ProductChannelEnum.ProductChannel;
  setProductChannel(value: google_ads_googleads_v1_enums_product_channel_pb.ProductChannelEnum.ProductChannel): void;

  getProductChannelExclusivity(): google_ads_googleads_v1_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivity;
  setProductChannelExclusivity(value: google_ads_googleads_v1_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivity): void;

  getProductCondition(): google_ads_googleads_v1_enums_product_condition_pb.ProductConditionEnum.ProductCondition;
  setProductCondition(value: google_ads_googleads_v1_enums_product_condition_pb.ProductConditionEnum.ProductCondition): void;
...
export namespace Segments {
  export type AsObject = {
    adNetworkType: google_ads_googleads_v1_enums_ad_network_type_pb.AdNetworkTypeEnum.AdNetworkType,
    clickType: google_ads_googleads_v1_enums_click_type_pb.ClickTypeEnum.ClickType,
    conversionAction?: google_protobuf_wrappers_pb.StringValue.AsObject,
    conversionActionCategory: google_ads_googleads_v1_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategory,
    ...
    conversionAttributionEventType: google_ads_googleads_v1_enums_conversion_attribution_event_type_pb.ConversionAttributionEventTypeEnum.ConversionAttributionEventType,
    conversionLagBucket: google_ads_googleads_v1_enums_conversion_lag_bucket_pb.ConversionLagBucketEnum.ConversionLagBucket,
    conversionOrAdjustmentLagBucket: google_ads_googleads_v1_enums_conversion_or_adjustment_lag_bucket_pb.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket,
    ...
    hotelCheckInDayOfWeek: google_ads_googleads_v1_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeek,
    ...
    monthOfYear: google_ads_googleads_v1_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYear,
    ...
    productChannel: google_ads_googleads_v1_enums_product_channel_pb.ProductChannelEnum.ProductChannel,
    productChannelExclusivity: google_ads_googleads_v1_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivity,
    productCondition: google_ads_googleads_v1_enums_product_condition_pb.ProductConditionEnum.ProductCondition,
...
export class Keyword extends jspb.Message {
  ...
  hasInfo(): boolean;
  clearInfo(): void;
  getInfo(): google_ads_googleads_v1_common_criteria_pb.KeywordInfo | undefined;
  setInfo(value?: google_ads_googleads_v1_common_criteria_pb.KeywordInfo): void;
...
export namespace Keyword {
  export type AsObject = {
    ...
    info?: google_ads_googleads_v1_common_criteria_pb.KeywordInfo.AsObject,
  }
}
