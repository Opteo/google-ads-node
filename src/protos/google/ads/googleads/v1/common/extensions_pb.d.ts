...
// file: google/ads/googleads/v1/common/extensions.proto
...
import * as google_ads_googleads_v1_enums_app_store_pb from "../../../../../google/ads/googleads/v1/enums/app_store_pb";
...
import * as google_ads_googleads_v1_enums_price_extension_price_qualifier_pb from "../../../../../google/ads/googleads/v1/enums/price_extension_price_qualifier_pb";
import * as google_ads_googleads_v1_enums_price_extension_price_unit_pb from "../../../../../google/ads/googleads/v1/enums/price_extension_price_unit_pb";
import * as google_ads_googleads_v1_enums_price_extension_type_pb from "../../../../../google/ads/googleads/v1/enums/price_extension_type_pb";
import * as google_ads_googleads_v1_enums_promotion_extension_discount_modifier_pb from "../../../../../google/ads/googleads/v1/enums/promotion_extension_discount_modifier_pb";
import * as google_ads_googleads_v1_enums_promotion_extension_occasion_pb from "../../../../../google/ads/googleads/v1/enums/promotion_extension_occasion_pb";
...
export class AppFeedItem extends jspb.Message {
  ...
  getAppStore(): google_ads_googleads_v1_enums_app_store_pb.AppStoreEnum.AppStore;
  setAppStore(value: google_ads_googleads_v1_enums_app_store_pb.AppStoreEnum.AppStore): void;
...
export namespace AppFeedItem {
  export type AsObject = {
    ...
    appStore: google_ads_googleads_v1_enums_app_store_pb.AppStoreEnum.AppStore,
...
export class CallFeedItem extends jspb.Message {
  ...
  getCallConversionReportingState(): google_ads_googleads_v1_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingState;
  setCallConversionReportingState(value: google_ads_googleads_v1_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingState): void;
...
export namespace CallFeedItem {
  export type AsObject = {
    ...
    callConversionReportingState: google_ads_googleads_v1_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingState,
  }
}
...
export class PriceFeedItem extends jspb.Message {
  getType(): google_ads_googleads_v1_enums_price_extension_type_pb.PriceExtensionTypeEnum.PriceExtensionType;
  setType(value: google_ads_googleads_v1_enums_price_extension_type_pb.PriceExtensionTypeEnum.PriceExtensionType): void;

  getPriceQualifier(): google_ads_googleads_v1_enums_price_extension_price_qualifier_pb.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier;
  setPriceQualifier(value: google_ads_googleads_v1_enums_price_extension_price_qualifier_pb.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier): void;
...
export namespace PriceFeedItem {
  export type AsObject = {
    type: google_ads_googleads_v1_enums_price_extension_type_pb.PriceExtensionTypeEnum.PriceExtensionType,
    priceQualifier: google_ads_googleads_v1_enums_price_extension_price_qualifier_pb.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier,
    trackingUrlTemplate?: google_protobuf_wrappers_pb.StringValue.AsObject,
...
export class PriceOffer extends jspb.Message {
  ...
  hasPrice(): boolean;
  clearPrice(): void;
  getPrice(): google_ads_googleads_v1_common_feed_common_pb.Money | undefined;
  setPrice(value?: google_ads_googleads_v1_common_feed_common_pb.Money): void;

  getUnit(): google_ads_googleads_v1_enums_price_extension_price_unit_pb.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit;
  setUnit(value: google_ads_googleads_v1_enums_price_extension_price_unit_pb.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit): void;
...
export namespace PriceOffer {
  export type AsObject = {
    ...
    price?: google_ads_googleads_v1_common_feed_common_pb.Money.AsObject,
    unit: google_ads_googleads_v1_enums_price_extension_price_unit_pb.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit,
    finalUrlsList: Array<google_protobuf_wrappers_pb.StringValue.AsObject>,
    finalMobileUrlsList: Array<google_protobuf_wrappers_pb.StringValue.AsObject>,
  }
}
...
export class PromotionFeedItem extends jspb.Message {
  ...
  getDiscountModifier(): google_ads_googleads_v1_enums_promotion_extension_discount_modifier_pb.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier;
  setDiscountModifier(value: google_ads_googleads_v1_enums_promotion_extension_discount_modifier_pb.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier): void;
  ...
  getOccasion(): google_ads_googleads_v1_enums_promotion_extension_occasion_pb.PromotionExtensionOccasionEnum.PromotionExtensionOccasion;
  setOccasion(value: google_ads_googleads_v1_enums_promotion_extension_occasion_pb.PromotionExtensionOccasionEnum.PromotionExtensionOccasion): void;
  ...
  getMoneyAmountOff(): google_ads_googleads_v1_common_feed_common_pb.Money | undefined;
  setMoneyAmountOff(value?: google_ads_googleads_v1_common_feed_common_pb.Money): void;
  ...
  getOrdersOverAmount(): google_ads_googleads_v1_common_feed_common_pb.Money | undefined;
  setOrdersOverAmount(value?: google_ads_googleads_v1_common_feed_common_pb.Money): void;
...
export namespace PromotionFeedItem {
  export type AsObject = {
    ...
    discountModifier: google_ads_googleads_v1_enums_promotion_extension_discount_modifier_pb.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier,
    ...
    occasion: google_ads_googleads_v1_enums_promotion_extension_occasion_pb.PromotionExtensionOccasionEnum.PromotionExtensionOccasion,
    finalUrlsList: Array<google_protobuf_wrappers_pb.StringValue.AsObject>,
    finalMobileUrlsList: Array<google_protobuf_wrappers_pb.StringValue.AsObject>,
    trackingUrlTemplate?: google_protobuf_wrappers_pb.StringValue.AsObject,
    urlCustomParametersList: Array<google_ads_googleads_v1_common_custom_parameter_pb.CustomParameter.AsObject>,
    ...
    moneyAmountOff?: google_ads_googleads_v1_common_feed_common_pb.Money.AsObject,
    promotionCode?: google_protobuf_wrappers_pb.StringValue.AsObject,
    ordersOverAmount?: google_ads_googleads_v1_common_feed_common_pb.Money.AsObject,
  }
