...
// file: google/ads/googleads/v1/common/frequency_cap.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_enums_frequency_cap_event_type_pb from "../../../../../google/ads/googleads/v1/enums/frequency_cap_event_type_pb";
import * as google_ads_googleads_v1_enums_frequency_cap_level_pb from "../../../../../google/ads/googleads/v1/enums/frequency_cap_level_pb";
import * as google_ads_googleads_v1_enums_frequency_cap_time_unit_pb from "../../../../../google/ads/googleads/v1/enums/frequency_cap_time_unit_pb";
...
export class FrequencyCapKey extends jspb.Message {
  getLevel(): google_ads_googleads_v1_enums_frequency_cap_level_pb.FrequencyCapLevelEnum.FrequencyCapLevel;
  setLevel(value: google_ads_googleads_v1_enums_frequency_cap_level_pb.FrequencyCapLevelEnum.FrequencyCapLevel): void;

  getEventType(): google_ads_googleads_v1_enums_frequency_cap_event_type_pb.FrequencyCapEventTypeEnum.FrequencyCapEventType;
  setEventType(value: google_ads_googleads_v1_enums_frequency_cap_event_type_pb.FrequencyCapEventTypeEnum.FrequencyCapEventType): void;

  getTimeUnit(): google_ads_googleads_v1_enums_frequency_cap_time_unit_pb.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit;
  setTimeUnit(value: google_ads_googleads_v1_enums_frequency_cap_time_unit_pb.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit): void;
...
export namespace FrequencyCapKey {
  export type AsObject = {
    level: google_ads_googleads_v1_enums_frequency_cap_level_pb.FrequencyCapLevelEnum.FrequencyCapLevel,
    eventType: google_ads_googleads_v1_enums_frequency_cap_event_type_pb.FrequencyCapEventTypeEnum.FrequencyCapEventType,
    timeUnit: google_ads_googleads_v1_enums_frequency_cap_time_unit_pb.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit,
