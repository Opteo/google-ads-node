...
// file: google/ads/googleads/v1/resources/keyword_plan.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_common_dates_pb from "../../../../../google/ads/googleads/v1/common/dates_pb";
import * as google_ads_googleads_v1_enums_keyword_plan_forecast_interval_pb from "../../../../../google/ads/googleads/v1/enums/keyword_plan_forecast_interval_pb";
...
export class KeywordPlanForecastPeriod extends jspb.Message {
  ...
  getDateInterval(): google_ads_googleads_v1_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval;
  setDateInterval(value: google_ads_googleads_v1_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval): void;

  hasDateRange(): boolean;
  clearDateRange(): void;
  getDateRange(): google_ads_googleads_v1_common_dates_pb.DateRange | undefined;
  setDateRange(value?: google_ads_googleads_v1_common_dates_pb.DateRange): void;
...
export namespace KeywordPlanForecastPeriod {
  export type AsObject = {
    dateInterval: google_ads_googleads_v1_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval,
    dateRange?: google_ads_googleads_v1_common_dates_pb.DateRange.AsObject,
  }
