...
// file: google/ads/googleads/v1/resources/feed_item_target.proto
...
import * as google_ads_googleads_v1_enums_feed_item_target_type_pb from "../../../../../google/ads/googleads/v1/enums/feed_item_target_type_pb";
...
export class FeedItemTarget extends jspb.Message {
  ...
  getFeedItemTargetType(): google_ads_googleads_v1_enums_feed_item_target_type_pb.FeedItemTargetTypeEnum.FeedItemTargetType;
  setFeedItemTargetType(value: google_ads_googleads_v1_enums_feed_item_target_type_pb.FeedItemTargetTypeEnum.FeedItemTargetType): void;
...
export namespace FeedItemTarget {
  export type AsObject = {
    ...
    feedItemTargetType: google_ads_googleads_v1_enums_feed_item_target_type_pb.FeedItemTargetTypeEnum.FeedItemTargetType,
