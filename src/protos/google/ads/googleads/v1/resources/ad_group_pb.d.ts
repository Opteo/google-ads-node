...
// file: google/ads/googleads/v1/resources/ad_group.proto
...
import * as google_ads_googleads_v1_common_explorer_auto_optimizer_setting_pb from "../../../../../google/ads/googleads/v1/common/explorer_auto_optimizer_setting_pb";
import * as google_ads_googleads_v1_common_targeting_setting_pb from "../../../../../google/ads/googleads/v1/common/targeting_setting_pb";
import * as google_ads_googleads_v1_enums_ad_group_ad_rotation_mode_pb from "../../../../../google/ads/googleads/v1/enums/ad_group_ad_rotation_mode_pb";
import * as google_ads_googleads_v1_enums_ad_group_status_pb from "../../../../../google/ads/googleads/v1/enums/ad_group_status_pb";
import * as google_ads_googleads_v1_enums_ad_group_type_pb from "../../../../../google/ads/googleads/v1/enums/ad_group_type_pb";
...
export class AdGroup extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_ad_group_status_pb.AdGroupStatusEnum.AdGroupStatus;
  setStatus(value: google_ads_googleads_v1_enums_ad_group_status_pb.AdGroupStatusEnum.AdGroupStatus): void;

  getType(): google_ads_googleads_v1_enums_ad_group_type_pb.AdGroupTypeEnum.AdGroupType;
  setType(value: google_ads_googleads_v1_enums_ad_group_type_pb.AdGroupTypeEnum.AdGroupType): void;
  ...
  getExplorerAutoOptimizerSetting(): google_ads_googleads_v1_common_explorer_auto_optimizer_setting_pb.ExplorerAutoOptimizerSetting | undefined;
  setExplorerAutoOptimizerSetting(value?: google_ads_googleads_v1_common_explorer_auto_optimizer_setting_pb.ExplorerAutoOptimizerSetting): void;

  getDisplayCustomBidDimension(): google_ads_googleads_v1_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimension;
  setDisplayCustomBidDimension(value: google_ads_googleads_v1_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimension): void;
  ...
  getEffectiveTargetCpaSource(): google_ads_googleads_v1_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource;
  setEffectiveTargetCpaSource(value: google_ads_googleads_v1_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource): void;
  ...
  getEffectiveTargetRoasSource(): google_ads_googleads_v1_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource;
  setEffectiveTargetRoasSource(value: google_ads_googleads_v1_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource): void;
...
export namespace AdGroup {
  export type AsObject = {
    ...
    explorerAutoOptimizerSetting?: google_ads_googleads_v1_common_explorer_auto_optimizer_setting_pb.ExplorerAutoOptimizerSetting.AsObject,
    displayCustomBidDimension: google_ads_googleads_v1_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimension,
    ...
    effectiveTargetCpaSource: google_ads_googleads_v1_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource,
    effectiveTargetRoas?: google_protobuf_wrappers_pb.DoubleValue.AsObject,
    effectiveTargetRoasSource: google_ads_googleads_v1_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource,
  }
}
