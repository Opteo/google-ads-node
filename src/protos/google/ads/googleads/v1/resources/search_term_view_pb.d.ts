...
// file: google/ads/googleads/v1/resources/search_term_view.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_enums_search_term_targeting_status_pb from "../../../../../google/ads/googleads/v1/enums/search_term_targeting_status_pb";
...
export class SearchTermView extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_search_term_targeting_status_pb.SearchTermTargetingStatusEnum.SearchTermTargetingStatus;
  setStatus(value: google_ads_googleads_v1_enums_search_term_targeting_status_pb.SearchTermTargetingStatusEnum.SearchTermTargetingStatus): void;
...
export namespace SearchTermView {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_search_term_targeting_status_pb.SearchTermTargetingStatusEnum.SearchTermTargetingStatus,
  }
}
