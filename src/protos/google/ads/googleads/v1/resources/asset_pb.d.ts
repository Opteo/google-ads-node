...
// file: google/ads/googleads/v1/resources/asset.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_common_asset_types_pb from "../../../../../google/ads/googleads/v1/common/asset_types_pb";
import * as google_ads_googleads_v1_enums_asset_type_pb from "../../../../../google/ads/googleads/v1/enums/asset_type_pb";
...
export class Asset extends jspb.Message {
  ...
  getType(): google_ads_googleads_v1_enums_asset_type_pb.AssetTypeEnum.AssetType;
  setType(value: google_ads_googleads_v1_enums_asset_type_pb.AssetTypeEnum.AssetType): void;

  hasYoutubeVideoAsset(): boolean;
  clearYoutubeVideoAsset(): void;
  getYoutubeVideoAsset(): google_ads_googleads_v1_common_asset_types_pb.YoutubeVideoAsset | undefined;
  setYoutubeVideoAsset(value?: google_ads_googleads_v1_common_asset_types_pb.YoutubeVideoAsset): void;

  hasMediaBundleAsset(): boolean;
  clearMediaBundleAsset(): void;
  getMediaBundleAsset(): google_ads_googleads_v1_common_asset_types_pb.MediaBundleAsset | undefined;
  setMediaBundleAsset(value?: google_ads_googleads_v1_common_asset_types_pb.MediaBundleAsset): void;
...
export namespace Asset {
  export type AsObject = {
    ...
    type: google_ads_googleads_v1_enums_asset_type_pb.AssetTypeEnum.AssetType,
