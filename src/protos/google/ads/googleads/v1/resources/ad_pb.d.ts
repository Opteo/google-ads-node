...
// file: google/ads/googleads/v1/resources/ad.proto
...
import * as google_ads_googleads_v1_enums_system_managed_entity_source_pb from "../../../../../google/ads/googleads/v1/enums/system_managed_entity_source_pb";
...
export class Ad extends jspb.Message {
  ...
  getType(): google_ads_googleads_v1_enums_ad_type_pb.AdTypeEnum.AdType;
  setType(value: google_ads_googleads_v1_enums_ad_type_pb.AdTypeEnum.AdType): void;
  ...
  getDevicePreference(): google_ads_googleads_v1_enums_device_pb.DeviceEnum.Device;
  setDevicePreference(value: google_ads_googleads_v1_enums_device_pb.DeviceEnum.Device): void;

  clearUrlCollectionsList(): void;
  getUrlCollectionsList(): Array<google_ads_googleads_v1_common_url_collection_pb.UrlCollection>;
  setUrlCollectionsList(value: Array<google_ads_googleads_v1_common_url_collection_pb.UrlCollection>): void;
  addUrlCollections(value?: google_ads_googleads_v1_common_url_collection_pb.UrlCollection, index?: number): google_ads_googleads_v1_common_url_collection_pb.UrlCollection;
  ...
  getSystemManagedResourceSource(): google_ads_googleads_v1_enums_system_managed_entity_source_pb.SystemManagedResourceSourceEnum.SystemManagedResourceSource;
  setSystemManagedResourceSource(value: google_ads_googleads_v1_enums_system_managed_entity_source_pb.SystemManagedResourceSourceEnum.SystemManagedResourceSource): void;

  hasTextAd(): boolean;
  clearTextAd(): void;
  getTextAd(): google_ads_googleads_v1_common_ad_type_infos_pb.TextAdInfo | undefined;
  setTextAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.TextAdInfo): void;

  hasExpandedTextAd(): boolean;
  clearExpandedTextAd(): void;
  getExpandedTextAd(): google_ads_googleads_v1_common_ad_type_infos_pb.ExpandedTextAdInfo | undefined;
  setExpandedTextAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.ExpandedTextAdInfo): void;

  hasCallOnlyAd(): boolean;
  clearCallOnlyAd(): void;
  getCallOnlyAd(): google_ads_googleads_v1_common_ad_type_infos_pb.CallOnlyAdInfo | undefined;
  setCallOnlyAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.CallOnlyAdInfo): void;

  hasExpandedDynamicSearchAd(): boolean;
  clearExpandedDynamicSearchAd(): void;
  getExpandedDynamicSearchAd(): google_ads_googleads_v1_common_ad_type_infos_pb.ExpandedDynamicSearchAdInfo | undefined;
  setExpandedDynamicSearchAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.ExpandedDynamicSearchAdInfo): void;

  hasHotelAd(): boolean;
  clearHotelAd(): void;
  getHotelAd(): google_ads_googleads_v1_common_ad_type_infos_pb.HotelAdInfo | undefined;
  setHotelAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.HotelAdInfo): void;

  hasShoppingSmartAd(): boolean;
  clearShoppingSmartAd(): void;
  getShoppingSmartAd(): google_ads_googleads_v1_common_ad_type_infos_pb.ShoppingSmartAdInfo | undefined;
  setShoppingSmartAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.ShoppingSmartAdInfo): void;

  hasShoppingProductAd(): boolean;
  clearShoppingProductAd(): void;
  getShoppingProductAd(): google_ads_googleads_v1_common_ad_type_infos_pb.ShoppingProductAdInfo | undefined;
  setShoppingProductAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.ShoppingProductAdInfo): void;

  hasGmailAd(): boolean;
  clearGmailAd(): void;
  getGmailAd(): google_ads_googleads_v1_common_ad_type_infos_pb.GmailAdInfo | undefined;
  setGmailAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.GmailAdInfo): void;

  hasImageAd(): boolean;
  clearImageAd(): void;
  getImageAd(): google_ads_googleads_v1_common_ad_type_infos_pb.ImageAdInfo | undefined;
  setImageAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.ImageAdInfo): void;

  hasVideoAd(): boolean;
  clearVideoAd(): void;
  getVideoAd(): google_ads_googleads_v1_common_ad_type_infos_pb.VideoAdInfo | undefined;
  setVideoAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.VideoAdInfo): void;

  hasResponsiveSearchAd(): boolean;
  clearResponsiveSearchAd(): void;
  getResponsiveSearchAd(): google_ads_googleads_v1_common_ad_type_infos_pb.ResponsiveSearchAdInfo | undefined;
  setResponsiveSearchAd(value?: google_ads_googleads_v1_common_ad_type_infos_pb.ResponsiveSearchAdInfo): void;
...
export namespace Ad {
  export type AsObject = {
    ...
    type: google_ads_googleads_v1_enums_ad_type_pb.AdTypeEnum.AdType,
    addedByGoogleAds?: google_protobuf_wrappers_pb.BoolValue.AsObject,
    devicePreference: google_ads_googleads_v1_enums_device_pb.DeviceEnum.Device,
    urlCollectionsList: Array<google_ads_googleads_v1_common_url_collection_pb.UrlCollection.AsObject>,
    name?: google_protobuf_wrappers_pb.StringValue.AsObject,
    systemManagedResourceSource: google_ads_googleads_v1_enums_system_managed_entity_source_pb.SystemManagedResourceSourceEnum.SystemManagedResourceSource,
    textAd?: google_ads_googleads_v1_common_ad_type_infos_pb.TextAdInfo.AsObject,
    expandedTextAd?: google_ads_googleads_v1_common_ad_type_infos_pb.ExpandedTextAdInfo.AsObject,
    callOnlyAd?: google_ads_googleads_v1_common_ad_type_infos_pb.CallOnlyAdInfo.AsObject,
    expandedDynamicSearchAd?: google_ads_googleads_v1_common_ad_type_infos_pb.ExpandedDynamicSearchAdInfo.AsObject,
    hotelAd?: google_ads_googleads_v1_common_ad_type_infos_pb.HotelAdInfo.AsObject,
    shoppingSmartAd?: google_ads_googleads_v1_common_ad_type_infos_pb.ShoppingSmartAdInfo.AsObject,
    shoppingProductAd?: google_ads_googleads_v1_common_ad_type_infos_pb.ShoppingProductAdInfo.AsObject,
    gmailAd?: google_ads_googleads_v1_common_ad_type_infos_pb.GmailAdInfo.AsObject,
    imageAd?: google_ads_googleads_v1_common_ad_type_infos_pb.ImageAdInfo.AsObject,
