...
// file: google/ads/googleads/v1/resources/recommendation.proto
...
import * as google_ads_googleads_v1_enums_recommendation_type_pb from "../../../../../google/ads/googleads/v1/enums/recommendation_type_pb";
import * as google_ads_googleads_v1_enums_target_cpa_opt_in_recommendation_goal_pb from "../../../../../google/ads/googleads/v1/enums/target_cpa_opt_in_recommendation_goal_pb";
...
export class Recommendation extends jspb.Message {
  ...
  getType(): google_ads_googleads_v1_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationType;
  setType(value: google_ads_googleads_v1_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationType): void;
...
export namespace Recommendation {
  export type AsObject = {
    resourceName: string,
    type: google_ads_googleads_v1_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationType,
  ...
  export namespace TargetCpaOptInRecommendation {
    ...
    export class TargetCpaOptInRecommendationOption extends jspb.Message {
      getGoal(): google_ads_googleads_v1_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal;
      setGoal(value: google_ads_googleads_v1_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal): void;
    ...
    export namespace TargetCpaOptInRecommendationOption {
      export type AsObject = {
        goal: google_ads_googleads_v1_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal,
  ...
  export class CallExtensionRecommendation extends jspb.Message {
    ...
    setRecommendedExtensionsList(value: Array<google_ads_googleads_v1_common_extensions_pb.CallFeedItem>): void;
    addRecommendedExtensions(value?: google_ads_googleads_v1_common_extensions_pb.CallFeedItem, index?: number): google_ads_googleads_v1_common_extensions_pb.CallFeedItem;
