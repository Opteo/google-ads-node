...
// file: google/ads/googleads/v1/resources/account_budget.proto
...
import * as google_ads_googleads_v1_enums_account_budget_status_pb from "../../../../../google/ads/googleads/v1/enums/account_budget_status_pb";
...
export class AccountBudget extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_account_budget_status_pb.AccountBudgetStatusEnum.AccountBudgetStatus;
  setStatus(value: google_ads_googleads_v1_enums_account_budget_status_pb.AccountBudgetStatusEnum.AccountBudgetStatus): void;
  ...
  getAdjustedSpendingLimitType(): google_ads_googleads_v1_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitType;
  setAdjustedSpendingLimitType(value: google_ads_googleads_v1_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitType): void;
...
export namespace AccountBudget {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_account_budget_status_pb.AccountBudgetStatusEnum.AccountBudgetStatus,
    ...
    adjustedSpendingLimitType: google_ads_googleads_v1_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitType,
  }
  ...
  export class PendingAccountBudgetProposal extends jspb.Message {
    ...
    getSpendingLimitType(): google_ads_googleads_v1_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitType;
    setSpendingLimitType(value: google_ads_googleads_v1_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitType): void;
  ...
  export namespace PendingAccountBudgetProposal {
    export type AsObject = {
      ...
      spendingLimitType: google_ads_googleads_v1_enums_spending_limit_type_pb.SpendingLimitTypeEnum.SpendingLimitType,
    }
