...
// file: google/ads/googleads/v1/resources/campaign_shared_set.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_enums_campaign_shared_set_status_pb from "../../../../../google/ads/googleads/v1/enums/campaign_shared_set_status_pb";
...
export class CampaignSharedSet extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_campaign_shared_set_status_pb.CampaignSharedSetStatusEnum.CampaignSharedSetStatus;
  setStatus(value: google_ads_googleads_v1_enums_campaign_shared_set_status_pb.CampaignSharedSetStatusEnum.CampaignSharedSetStatus): void;
...
export namespace CampaignSharedSet {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_campaign_shared_set_status_pb.CampaignSharedSetStatusEnum.CampaignSharedSetStatus,
  }
}
