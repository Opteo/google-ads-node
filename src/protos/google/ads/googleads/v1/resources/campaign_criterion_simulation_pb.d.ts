...
// file: google/ads/googleads/v1/resources/campaign_criterion_simulation.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_common_simulation_pb from "../../../../../google/ads/googleads/v1/common/simulation_pb";
import * as google_ads_googleads_v1_enums_simulation_modification_method_pb from "../../../../../google/ads/googleads/v1/enums/simulation_modification_method_pb";
import * as google_ads_googleads_v1_enums_simulation_type_pb from "../../../../../google/ads/googleads/v1/enums/simulation_type_pb";
...
export class CampaignCriterionSimulation extends jspb.Message {
  ...
  getType(): google_ads_googleads_v1_enums_simulation_type_pb.SimulationTypeEnum.SimulationType;
  setType(value: google_ads_googleads_v1_enums_simulation_type_pb.SimulationTypeEnum.SimulationType): void;

  getModificationMethod(): google_ads_googleads_v1_enums_simulation_modification_method_pb.SimulationModificationMethodEnum.SimulationModificationMethod;
  setModificationMethod(value: google_ads_googleads_v1_enums_simulation_modification_method_pb.SimulationModificationMethodEnum.SimulationModificationMethod): void;
  ...
  getBidModifierPointList(): google_ads_googleads_v1_common_simulation_pb.BidModifierSimulationPointList | undefined;
  setBidModifierPointList(value?: google_ads_googleads_v1_common_simulation_pb.BidModifierSimulationPointList): void;
...
export namespace CampaignCriterionSimulation {
  export type AsObject = {
    ...
    type: google_ads_googleads_v1_enums_simulation_type_pb.SimulationTypeEnum.SimulationType,
    modificationMethod: google_ads_googleads_v1_enums_simulation_modification_method_pb.SimulationModificationMethodEnum.SimulationModificationMethod,
    startDate?: google_protobuf_wrappers_pb.StringValue.AsObject,
    endDate?: google_protobuf_wrappers_pb.StringValue.AsObject,
    bidModifierPointList?: google_ads_googleads_v1_common_simulation_pb.BidModifierSimulationPointList.AsObject,
  }
