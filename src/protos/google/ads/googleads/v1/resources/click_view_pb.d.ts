...
// file: google/ads/googleads/v1/resources/click_view.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_common_click_location_pb from "../../../../../google/ads/googleads/v1/common/click_location_pb";
...
export class ClickView extends jspb.Message {
  ...
  getAreaOfInterest(): google_ads_googleads_v1_common_click_location_pb.ClickLocation | undefined;
  setAreaOfInterest(value?: google_ads_googleads_v1_common_click_location_pb.ClickLocation): void;

  hasLocationOfPresence(): boolean;
  clearLocationOfPresence(): void;
  getLocationOfPresence(): google_ads_googleads_v1_common_click_location_pb.ClickLocation | undefined;
  setLocationOfPresence(value?: google_ads_googleads_v1_common_click_location_pb.ClickLocation): void;
...
export namespace ClickView {
  export type AsObject = {
    ...
    areaOfInterest?: google_ads_googleads_v1_common_click_location_pb.ClickLocation.AsObject,
    locationOfPresence?: google_ads_googleads_v1_common_click_location_pb.ClickLocation.AsObject,
