...
// file: google/ads/googleads/v1/resources/bidding_strategy.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v1_common_bidding_pb from "../../../../../google/ads/googleads/v1/common/bidding_pb";
import * as google_ads_googleads_v1_enums_bidding_strategy_status_pb from "../../../../../google/ads/googleads/v1/enums/bidding_strategy_status_pb";
...
export class BiddingStrategy extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_bidding_strategy_status_pb.BiddingStrategyStatusEnum.BiddingStrategyStatus;
  setStatus(value: google_ads_googleads_v1_enums_bidding_strategy_status_pb.BiddingStrategyStatusEnum.BiddingStrategyStatus): void;

  getType(): google_ads_googleads_v1_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyType;
  setType(value: google_ads_googleads_v1_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyType): void;
  ...
  getEnhancedCpc(): google_ads_googleads_v1_common_bidding_pb.EnhancedCpc | undefined;
  setEnhancedCpc(value?: google_ads_googleads_v1_common_bidding_pb.EnhancedCpc): void;

  hasPageOnePromoted(): boolean;
  clearPageOnePromoted(): void;
  getPageOnePromoted(): google_ads_googleads_v1_common_bidding_pb.PageOnePromoted | undefined;
  setPageOnePromoted(value?: google_ads_googleads_v1_common_bidding_pb.PageOnePromoted): void;
  ...
  getTargetOutrankShare(): google_ads_googleads_v1_common_bidding_pb.TargetOutrankShare | undefined;
  setTargetOutrankShare(value?: google_ads_googleads_v1_common_bidding_pb.TargetOutrankShare): void;
...
export namespace BiddingStrategy {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_bidding_strategy_status_pb.BiddingStrategyStatusEnum.BiddingStrategyStatus,
    type: google_ads_googleads_v1_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyType,
    ...
    enhancedCpc?: google_ads_googleads_v1_common_bidding_pb.EnhancedCpc.AsObject,
    pageOnePromoted?: google_ads_googleads_v1_common_bidding_pb.PageOnePromoted.AsObject,
    ...
    targetOutrankShare?: google_ads_googleads_v1_common_bidding_pb.TargetOutrankShare.AsObject,
