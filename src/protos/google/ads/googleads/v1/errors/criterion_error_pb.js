...
goog.exportSymbol('proto.google.ads.googleads.v1.errors.CriterionErrorEnum', null, global);
goog.exportSymbol('proto.google.ads.googleads.v1.errors.CriterionErrorEnum.CriterionError', null, global);
 ...
 * @constructor
 */
proto.google.ads.googleads.v1.errors.CriterionErrorEnum = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.google.ads.googleads.v1.errors.CriterionErrorEnum, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.google.ads.googleads.v1.errors.CriterionErrorEnum.displayName = 'proto.google.ads.googleads.v1.errors.CriterionErrorEnum';
}
 ...
 * @return {!Object}
 */
proto.google.ads.googleads.v1.errors.CriterionErrorEnum.prototype.toObject = function(opt_includeInstance) {
  return proto.google.ads.googleads.v1.errors.CriterionErrorEnum.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.google.ads.googleads.v1.errors.CriterionErrorEnum} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.ads.googleads.v1.errors.CriterionErrorEnum.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.google.ads.googleads.v1.errors.CriterionErrorEnum}
 */
proto.google.ads.googleads.v1.errors.CriterionErrorEnum.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.google.ads.googleads.v1.errors.CriterionErrorEnum;
  return proto.google.ads.googleads.v1.errors.CriterionErrorEnum.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.google.ads.googleads.v1.errors.CriterionErrorEnum} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.google.ads.googleads.v1.errors.CriterionErrorEnum}
 */
proto.google.ads.googleads.v1.errors.CriterionErrorEnum.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.google.ads.googleads.v1.errors.CriterionErrorEnum.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.google.ads.googleads.v1.errors.CriterionErrorEnum.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.google.ads.googleads.v1.errors.CriterionErrorEnum} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.ads.googleads.v1.errors.CriterionErrorEnum.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @enum {number}
 */
proto.google.ads.googleads.v1.errors.CriterionErrorEnum.CriterionError = {
  UNSPECIFIED: 0,
  UNKNOWN: 1,
