...
export class CampaignLabelOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v2_resources_campaign_label_pb.CampaignLabel | undefined;
  setCreate(value?: google_ads_googleads_v2_resources_campaign_label_pb.CampaignLabel): void;
...
export namespace CampaignLabelOperation {
  export type AsObject = {
    create?: google_ads_googleads_v2_resources_campaign_label_pb.CampaignLabel.AsObject,
    remove: string,
  }
