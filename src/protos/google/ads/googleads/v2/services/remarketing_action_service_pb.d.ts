...
export class RemarketingActionOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v2_resources_remarketing_action_pb.RemarketingAction | undefined;
  setCreate(value?: google_ads_googleads_v2_resources_remarketing_action_pb.RemarketingAction): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v2_resources_remarketing_action_pb.RemarketingAction | undefined;
  setUpdate(value?: google_ads_googleads_v2_resources_remarketing_action_pb.RemarketingAction): void;
...
export namespace RemarketingActionOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v2_resources_remarketing_action_pb.RemarketingAction.AsObject,
    update?: google_ads_googleads_v2_resources_remarketing_action_pb.RemarketingAction.AsObject,
  }
