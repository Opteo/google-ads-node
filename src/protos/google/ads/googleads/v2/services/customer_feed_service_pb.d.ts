...
// file: google/ads/googleads/v2/services/customer_feed_service.proto
...
export class CustomerFeedOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v2_resources_customer_feed_pb.CustomerFeed | undefined;
  setCreate(value?: google_ads_googleads_v2_resources_customer_feed_pb.CustomerFeed): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v2_resources_customer_feed_pb.CustomerFeed | undefined;
  setUpdate(value?: google_ads_googleads_v2_resources_customer_feed_pb.CustomerFeed): void;
...
export namespace CustomerFeedOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v2_resources_customer_feed_pb.CustomerFeed.AsObject,
    update?: google_ads_googleads_v2_resources_customer_feed_pb.CustomerFeed.AsObject,
    remove: string,
  }
