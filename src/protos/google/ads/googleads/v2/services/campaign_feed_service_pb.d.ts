...
export class CampaignFeedOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v2_resources_campaign_feed_pb.CampaignFeed | undefined;
  setCreate(value?: google_ads_googleads_v2_resources_campaign_feed_pb.CampaignFeed): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v2_resources_campaign_feed_pb.CampaignFeed | undefined;
  setUpdate(value?: google_ads_googleads_v2_resources_campaign_feed_pb.CampaignFeed): void;
...
export namespace CampaignFeedOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v2_resources_campaign_feed_pb.CampaignFeed.AsObject,
    update?: google_ads_googleads_v2_resources_campaign_feed_pb.CampaignFeed.AsObject,
    remove: string,
  }
