...
// file: google/ads/googleads/v2/services/campaign_service.proto
...
export class CampaignOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v2_resources_campaign_pb.Campaign | undefined;
  setCreate(value?: google_ads_googleads_v2_resources_campaign_pb.Campaign): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v2_resources_campaign_pb.Campaign | undefined;
  setUpdate(value?: google_ads_googleads_v2_resources_campaign_pb.Campaign): void;
...
export namespace CampaignOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v2_resources_campaign_pb.Campaign.AsObject,
    update?: google_ads_googleads_v2_resources_campaign_pb.Campaign.AsObject,
    remove: string,
  }
