...
// file: google/ads/googleads/v2/services/ad_group_feed_service.proto
...
export class AdGroupFeedOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v2_resources_ad_group_feed_pb.AdGroupFeed | undefined;
  setCreate(value?: google_ads_googleads_v2_resources_ad_group_feed_pb.AdGroupFeed): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v2_resources_ad_group_feed_pb.AdGroupFeed | undefined;
  setUpdate(value?: google_ads_googleads_v2_resources_ad_group_feed_pb.AdGroupFeed): void;
...
export namespace AdGroupFeedOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v2_resources_ad_group_feed_pb.AdGroupFeed.AsObject,
    update?: google_ads_googleads_v2_resources_ad_group_feed_pb.AdGroupFeed.AsObject,
    remove: string,
  }
