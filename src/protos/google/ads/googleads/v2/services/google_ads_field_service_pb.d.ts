...
// file: google/ads/googleads/v2/services/google_ads_field_service.proto
...
export class SearchGoogleAdsFieldsResponse extends jspb.Message {
  ...
  getResultsList(): Array<google_ads_googleads_v2_resources_google_ads_field_pb.GoogleAdsField>;
  setResultsList(value: Array<google_ads_googleads_v2_resources_google_ads_field_pb.GoogleAdsField>): void;
  addResults(value?: google_ads_googleads_v2_resources_google_ads_field_pb.GoogleAdsField, index?: number): google_ads_googleads_v2_resources_google_ads_field_pb.GoogleAdsField;
...
export namespace SearchGoogleAdsFieldsResponse {
  export type AsObject = {
    resultsList: Array<google_ads_googleads_v2_resources_google_ads_field_pb.GoogleAdsField.AsObject>,
