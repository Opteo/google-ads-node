...
export class FeedMappingOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v2_resources_feed_mapping_pb.FeedMapping | undefined;
  setCreate(value?: google_ads_googleads_v2_resources_feed_mapping_pb.FeedMapping): void;
...
export namespace FeedMappingOperation {
  export type AsObject = {
    create?: google_ads_googleads_v2_resources_feed_mapping_pb.FeedMapping.AsObject,
    remove: string,
  }
