...
goog.exportSymbol('proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum', null, global);
goog.exportSymbol('proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.ExtensionSettingError', null, global);
 ...
 * @constructor
 */
proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.displayName = 'proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum';
}
 ...
 * @return {!Object}
 */
proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.prototype.toObject = function(opt_includeInstance) {
  return proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum}
 */
proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum;
  return proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum}
 */
proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @enum {number}
 */
proto.google.ads.googleads.v2.errors.ExtensionSettingErrorEnum.ExtensionSettingError = {
  UNSPECIFIED: 0,
  UNKNOWN: 1,
