...
// file: google/ads/googleads/v0/common/criterion_category_availability.proto
...
import * as google_ads_googleads_v0_enums_criterion_category_channel_availability_mode_pb from "../../../../../google/ads/googleads/v0/enums/criterion_category_channel_availability_mode_pb";
import * as google_ads_googleads_v0_enums_criterion_category_locale_availability_mode_pb from "../../../../../google/ads/googleads/v0/enums/criterion_category_locale_availability_mode_pb";
...
export class CriterionCategoryChannelAvailability extends jspb.Message {
  getAvailabilityMode(): google_ads_googleads_v0_enums_criterion_category_channel_availability_mode_pb.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode;
  setAvailabilityMode(value: google_ads_googleads_v0_enums_criterion_category_channel_availability_mode_pb.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode): void;
  ...
  getAdvertisingChannelSubTypeList(): Array<google_ads_googleads_v0_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType>;
  setAdvertisingChannelSubTypeList(value: Array<google_ads_googleads_v0_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType>): void;
  addAdvertisingChannelSubType(value: google_ads_googleads_v0_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType, index?: number): google_ads_googleads_v0_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType;
...
export namespace CriterionCategoryChannelAvailability {
  export type AsObject = {
    availabilityMode: google_ads_googleads_v0_enums_criterion_category_channel_availability_mode_pb.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode,
    ...
    advertisingChannelSubTypeList: Array<google_ads_googleads_v0_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType>,
...
export class CriterionCategoryLocaleAvailability extends jspb.Message {
  getAvailabilityMode(): google_ads_googleads_v0_enums_criterion_category_locale_availability_mode_pb.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode;
  setAvailabilityMode(value: google_ads_googleads_v0_enums_criterion_category_locale_availability_mode_pb.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode): void;
...
export namespace CriterionCategoryLocaleAvailability {
  export type AsObject = {
    availabilityMode: google_ads_googleads_v0_enums_criterion_category_locale_availability_mode_pb.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode,
