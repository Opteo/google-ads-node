...
// file: google/ads/googleads/v0/common/bidding.proto
...
export class PageOnePromoted extends jspb.Message {
  ...
  setStrategyGoal(value: google_ads_googleads_v0_enums_page_one_promoted_strategy_goal_pb.PageOnePromotedStrategyGoalEnum.PageOnePromotedStrategyGoal): void;
