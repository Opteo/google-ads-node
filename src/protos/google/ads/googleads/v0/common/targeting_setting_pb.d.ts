...
// file: google/ads/googleads/v0/common/targeting_setting.proto
...
export class TargetRestriction extends jspb.Message {
  getTargetingDimension(): google_ads_googleads_v0_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimension;
  setTargetingDimension(value: google_ads_googleads_v0_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimension): void;
...
export namespace TargetRestriction {
  export type AsObject = {
    targetingDimension: google_ads_googleads_v0_enums_targeting_dimension_pb.TargetingDimensionEnum.TargetingDimension,
