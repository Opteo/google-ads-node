...
// file: google/ads/googleads/v0/common/policy.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v0_enums_policy_topic_entry_type_pb from "../../../../../google/ads/googleads/v0/enums/policy_topic_entry_type_pb";
import * as google_ads_googleads_v0_enums_policy_topic_evidence_destination_mismatch_url_type_pb from "../../../../../google/ads/googleads/v0/enums/policy_topic_evidence_destination_mismatch_url_type_pb";
...
export class PolicyTopicEntry extends jspb.Message {
  ...
  getType(): google_ads_googleads_v0_enums_policy_topic_entry_type_pb.PolicyTopicEntryTypeEnum.PolicyTopicEntryType;
  setType(value: google_ads_googleads_v0_enums_policy_topic_entry_type_pb.PolicyTopicEntryTypeEnum.PolicyTopicEntryType): void;
...
export namespace PolicyTopicEntry {
  export type AsObject = {
    ...
    type: google_ads_googleads_v0_enums_policy_topic_entry_type_pb.PolicyTopicEntryTypeEnum.PolicyTopicEntryType,
...
export namespace PolicyTopicEvidence {
  ...
  export class DestinationMismatch extends jspb.Message {
    ...
    getUrlTypesList(): Array<google_ads_googleads_v0_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType>;
    setUrlTypesList(value: Array<google_ads_googleads_v0_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType>): void;
    addUrlTypes(value: google_ads_googleads_v0_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType, index?: number): google_ads_googleads_v0_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType;
  ...
  export namespace DestinationMismatch {
    export type AsObject = {
      urlTypesList: Array<google_ads_googleads_v0_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType>,
    }
  }
