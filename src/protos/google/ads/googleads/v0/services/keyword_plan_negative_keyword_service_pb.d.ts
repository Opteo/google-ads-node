...
// file: google/ads/googleads/v0/services/keyword_plan_negative_keyword_service.proto
...
export class KeywordPlanNegativeKeywordOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v0_resources_keyword_plan_negative_keyword_pb.KeywordPlanNegativeKeyword | undefined;
  setCreate(value?: google_ads_googleads_v0_resources_keyword_plan_negative_keyword_pb.KeywordPlanNegativeKeyword): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_keyword_plan_negative_keyword_pb.KeywordPlanNegativeKeyword | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_keyword_plan_negative_keyword_pb.KeywordPlanNegativeKeyword): void;
...
export namespace KeywordPlanNegativeKeywordOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v0_resources_keyword_plan_negative_keyword_pb.KeywordPlanNegativeKeyword.AsObject,
    update?: google_ads_googleads_v0_resources_keyword_plan_negative_keyword_pb.KeywordPlanNegativeKeyword.AsObject,
    remove: string,
  }
