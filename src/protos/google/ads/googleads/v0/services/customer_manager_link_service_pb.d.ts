...
// file: google/ads/googleads/v0/services/customer_manager_link_service.proto
...
export class CustomerManagerLinkOperation extends jspb.Message {
  ...
  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_customer_manager_link_pb.CustomerManagerLink | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_customer_manager_link_pb.CustomerManagerLink): void;
...
export namespace CustomerManagerLinkOperation {
  export type AsObject = {
    ...
    update?: google_ads_googleads_v0_resources_customer_manager_link_pb.CustomerManagerLink.AsObject,
  }
