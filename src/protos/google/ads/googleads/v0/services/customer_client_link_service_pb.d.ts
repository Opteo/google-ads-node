...
// file: google/ads/googleads/v0/services/customer_client_link_service.proto
...
export class CustomerClientLinkOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v0_resources_customer_client_link_pb.CustomerClientLink | undefined;
  setCreate(value?: google_ads_googleads_v0_resources_customer_client_link_pb.CustomerClientLink): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_customer_client_link_pb.CustomerClientLink | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_customer_client_link_pb.CustomerClientLink): void;
...
export namespace CustomerClientLinkOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v0_resources_customer_client_link_pb.CustomerClientLink.AsObject,
    update?: google_ads_googleads_v0_resources_customer_client_link_pb.CustomerClientLink.AsObject,
  }
