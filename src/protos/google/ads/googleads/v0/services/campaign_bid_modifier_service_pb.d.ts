...
// file: google/ads/googleads/v0/services/campaign_bid_modifier_service.proto
...
export class CampaignBidModifierOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v0_resources_campaign_bid_modifier_pb.CampaignBidModifier | undefined;
  setCreate(value?: google_ads_googleads_v0_resources_campaign_bid_modifier_pb.CampaignBidModifier): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_campaign_bid_modifier_pb.CampaignBidModifier | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_campaign_bid_modifier_pb.CampaignBidModifier): void;
...
export namespace CampaignBidModifierOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v0_resources_campaign_bid_modifier_pb.CampaignBidModifier.AsObject,
    update?: google_ads_googleads_v0_resources_campaign_bid_modifier_pb.CampaignBidModifier.AsObject,
    remove: string,
  }
