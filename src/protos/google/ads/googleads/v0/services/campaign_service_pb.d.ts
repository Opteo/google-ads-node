...
// file: google/ads/googleads/v0/services/campaign_service.proto
...
export class CampaignOperation extends jspb.Message {
  ...
  setCreate(value?: google_ads_googleads_v0_resources_campaign_pb.Campaign): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_campaign_pb.Campaign | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_campaign_pb.Campaign): void;
