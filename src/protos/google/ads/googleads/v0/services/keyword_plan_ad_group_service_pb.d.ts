...
// file: google/ads/googleads/v0/services/keyword_plan_ad_group_service.proto
...
export class KeywordPlanAdGroupOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v0_resources_keyword_plan_ad_group_pb.KeywordPlanAdGroup | undefined;
  setCreate(value?: google_ads_googleads_v0_resources_keyword_plan_ad_group_pb.KeywordPlanAdGroup): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_keyword_plan_ad_group_pb.KeywordPlanAdGroup | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_keyword_plan_ad_group_pb.KeywordPlanAdGroup): void;
...
export namespace KeywordPlanAdGroupOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v0_resources_keyword_plan_ad_group_pb.KeywordPlanAdGroup.AsObject,
    update?: google_ads_googleads_v0_resources_keyword_plan_ad_group_pb.KeywordPlanAdGroup.AsObject,
    remove: string,
  }
