...
// file: google/ads/googleads/v0/services/ad_group_service.proto
...
export class AdGroupOperation extends jspb.Message {
  ...
  setCreate(value?: google_ads_googleads_v0_resources_ad_group_pb.AdGroup): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_ad_group_pb.AdGroup | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_ad_group_pb.AdGroup): void;
