...
// file: google/ads/googleads/v0/services/customer_service.proto
...
export class CreateCustomerClientRequest extends jspb.Message {
  ...
  getCustomerClient(): google_ads_googleads_v0_resources_customer_pb.Customer | undefined;
  setCustomerClient(value?: google_ads_googleads_v0_resources_customer_pb.Customer): void;
...
export namespace CreateCustomerClientRequest {
  export type AsObject = {
    customerId: string,
    customerClient?: google_ads_googleads_v0_resources_customer_pb.Customer.AsObject,
  }
}
...
export class CustomerOperation extends jspb.Message {
  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_customer_pb.Customer | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_customer_pb.Customer): void;
...
export namespace CustomerOperation {
  export type AsObject = {
    update?: google_ads_googleads_v0_resources_customer_pb.Customer.AsObject,
