...
// file: google/ads/googleads/v0/services/feed_item_service.proto
...
export class FeedItemOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v0_resources_feed_item_pb.FeedItem | undefined;
  setCreate(value?: google_ads_googleads_v0_resources_feed_item_pb.FeedItem): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_feed_item_pb.FeedItem | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_feed_item_pb.FeedItem): void;
...
export namespace FeedItemOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v0_resources_feed_item_pb.FeedItem.AsObject,
    update?: google_ads_googleads_v0_resources_feed_item_pb.FeedItem.AsObject,
    remove: string,
  }
