...
// file: google/ads/googleads/v0/services/feed_mapping_service.proto
...
export class FeedMappingOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v0_resources_feed_mapping_pb.FeedMapping | undefined;
  setCreate(value?: google_ads_googleads_v0_resources_feed_mapping_pb.FeedMapping): void;
...
export namespace FeedMappingOperation {
  export type AsObject = {
    create?: google_ads_googleads_v0_resources_feed_mapping_pb.FeedMapping.AsObject,
    remove: string,
  }
