...
// file: google/ads/googleads/v0/services/keyword_plan_keyword_service.proto
...
export class KeywordPlanKeywordOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v0_resources_keyword_plan_keyword_pb.KeywordPlanKeyword | undefined;
  setCreate(value?: google_ads_googleads_v0_resources_keyword_plan_keyword_pb.KeywordPlanKeyword): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_keyword_plan_keyword_pb.KeywordPlanKeyword | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_keyword_plan_keyword_pb.KeywordPlanKeyword): void;
...
export namespace KeywordPlanKeywordOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v0_resources_keyword_plan_keyword_pb.KeywordPlanKeyword.AsObject,
    update?: google_ads_googleads_v0_resources_keyword_plan_keyword_pb.KeywordPlanKeyword.AsObject,
    remove: string,
  }
