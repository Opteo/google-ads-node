...
// file: google/ads/googleads/v0/services/feed_service.proto
...
export class FeedOperation extends jspb.Message {
  ...
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v0_resources_feed_pb.Feed | undefined;
  setCreate(value?: google_ads_googleads_v0_resources_feed_pb.Feed): void;

  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v0_resources_feed_pb.Feed | undefined;
  setUpdate(value?: google_ads_googleads_v0_resources_feed_pb.Feed): void;
...
export namespace FeedOperation {
  export type AsObject = {
    ...
    create?: google_ads_googleads_v0_resources_feed_pb.Feed.AsObject,
    update?: google_ads_googleads_v0_resources_feed_pb.Feed.AsObject,
    remove: string,
  }
