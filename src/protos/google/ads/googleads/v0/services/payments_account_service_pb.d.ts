...
// file: google/ads/googleads/v0/services/payments_account_service.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v0_resources_payments_account_pb from "../../../../../google/ads/googleads/v0/resources/payments_account_pb";
...
export class ListPaymentsAccountsResponse extends jspb.Message {
  ...
  getPaymentsAccountsList(): Array<google_ads_googleads_v0_resources_payments_account_pb.PaymentsAccount>;
  setPaymentsAccountsList(value: Array<google_ads_googleads_v0_resources_payments_account_pb.PaymentsAccount>): void;
  addPaymentsAccounts(value?: google_ads_googleads_v0_resources_payments_account_pb.PaymentsAccount, index?: number): google_ads_googleads_v0_resources_payments_account_pb.PaymentsAccount;
...
export namespace ListPaymentsAccountsResponse {
  export type AsObject = {
    paymentsAccountsList: Array<google_ads_googleads_v0_resources_payments_account_pb.PaymentsAccount.AsObject>,
  }
}
