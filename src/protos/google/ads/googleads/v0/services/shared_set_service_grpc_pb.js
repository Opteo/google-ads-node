...
function serialize_google_ads_googleads_v0_resources_SharedSet(arg) {
...
function deserialize_google_ads_googleads_v0_resources_SharedSet(buffer_arg) {
  return google_ads_googleads_v0_resources_shared_set_pb.SharedSet.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_google_ads_googleads_v0_services_GetSharedSetRequest(arg) {
...
function deserialize_google_ads_googleads_v0_services_GetSharedSetRequest(buffer_arg) {
  return google_ads_googleads_v0_services_shared_set_service_pb.GetSharedSetRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_google_ads_googleads_v0_services_MutateSharedSetsRequest(arg) {
...
function deserialize_google_ads_googleads_v0_services_MutateSharedSetsRequest(buffer_arg) {
  return google_ads_googleads_v0_services_shared_set_service_pb.MutateSharedSetsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_google_ads_googleads_v0_services_MutateSharedSetsResponse(arg) {
...
function deserialize_google_ads_googleads_v0_services_MutateSharedSetsResponse(buffer_arg) {
  return google_ads_googleads_v0_services_shared_set_service_pb.MutateSharedSetsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var SharedSetServiceService = exports.SharedSetServiceService = {
  ...
  getSharedSet: {
    path: '/google.ads.googleads.v0.services.SharedSetService/GetSharedSet',
    requestStream: false,
    responseStream: false,
    requestType: google_ads_googleads_v0_services_shared_set_service_pb.GetSharedSetRequest,
    responseType: google_ads_googleads_v0_resources_shared_set_pb.SharedSet,
    requestSerialize: serialize_google_ads_googleads_v0_services_GetSharedSetRequest,
    requestDeserialize: deserialize_google_ads_googleads_v0_services_GetSharedSetRequest,
    responseSerialize: serialize_google_ads_googleads_v0_resources_SharedSet,
    responseDeserialize: deserialize_google_ads_googleads_v0_resources_SharedSet,
  },
