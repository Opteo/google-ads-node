...
// file: google/ads/googleads/v0/resources/campaign_budget.proto
...
import * as google_ads_googleads_v0_enums_budget_period_pb from "../../../../../google/ads/googleads/v0/enums/budget_period_pb";
...
export class CampaignBudget extends jspb.Message {
  ...
  setStatus(value: google_ads_googleads_v0_enums_budget_status_pb.BudgetStatusEnum.BudgetStatus): void;

  getDeliveryMethod(): google_ads_googleads_v0_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethod;
  setDeliveryMethod(value: google_ads_googleads_v0_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethod): void;
  ...
  getPeriod(): google_ads_googleads_v0_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriod;
  setPeriod(value: google_ads_googleads_v0_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriod): void;
...
export namespace CampaignBudget {
  export type AsObject = {
    ...
    period: google_ads_googleads_v0_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriod,
