...
// file: google/ads/googleads/v0/resources/conversion_action.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v0_common_tag_snippet_pb from "../../../../../google/ads/googleads/v0/common/tag_snippet_pb";
import * as google_ads_googleads_v0_enums_attribution_model_pb from "../../../../../google/ads/googleads/v0/enums/attribution_model_pb";
import * as google_ads_googleads_v0_enums_conversion_action_category_pb from "../../../../../google/ads/googleads/v0/enums/conversion_action_category_pb";
import * as google_ads_googleads_v0_enums_conversion_action_counting_type_pb from "../../../../../google/ads/googleads/v0/enums/conversion_action_counting_type_pb";
import * as google_ads_googleads_v0_enums_conversion_action_status_pb from "../../../../../google/ads/googleads/v0/enums/conversion_action_status_pb";
import * as google_ads_googleads_v0_enums_conversion_action_type_pb from "../../../../../google/ads/googleads/v0/enums/conversion_action_type_pb";
import * as google_ads_googleads_v0_enums_data_driven_model_status_pb from "../../../../../google/ads/googleads/v0/enums/data_driven_model_status_pb";
...
export class ConversionAction extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v0_enums_conversion_action_status_pb.ConversionActionStatusEnum.ConversionActionStatus;
  setStatus(value: google_ads_googleads_v0_enums_conversion_action_status_pb.ConversionActionStatusEnum.ConversionActionStatus): void;

  getType(): google_ads_googleads_v0_enums_conversion_action_type_pb.ConversionActionTypeEnum.ConversionActionType;
  setType(value: google_ads_googleads_v0_enums_conversion_action_type_pb.ConversionActionTypeEnum.ConversionActionType): void;

  getCategory(): google_ads_googleads_v0_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategory;
  setCategory(value: google_ads_googleads_v0_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategory): void;
  ...
  getCountingType(): google_ads_googleads_v0_enums_conversion_action_counting_type_pb.ConversionActionCountingTypeEnum.ConversionActionCountingType;
  setCountingType(value: google_ads_googleads_v0_enums_conversion_action_counting_type_pb.ConversionActionCountingTypeEnum.ConversionActionCountingType): void;
  ...
  getTagSnippetsList(): Array<google_ads_googleads_v0_common_tag_snippet_pb.TagSnippet>;
  setTagSnippetsList(value: Array<google_ads_googleads_v0_common_tag_snippet_pb.TagSnippet>): void;
  addTagSnippets(value?: google_ads_googleads_v0_common_tag_snippet_pb.TagSnippet, index?: number): google_ads_googleads_v0_common_tag_snippet_pb.TagSnippet;
...
export namespace ConversionAction {
  export type AsObject = {
    ...
    status: google_ads_googleads_v0_enums_conversion_action_status_pb.ConversionActionStatusEnum.ConversionActionStatus,
    type: google_ads_googleads_v0_enums_conversion_action_type_pb.ConversionActionTypeEnum.ConversionActionType,
    category: google_ads_googleads_v0_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategory,
    ...
    countingType: google_ads_googleads_v0_enums_conversion_action_counting_type_pb.ConversionActionCountingTypeEnum.ConversionActionCountingType,
    attributionModelSettings?: ConversionAction.AttributionModelSettings.AsObject,
    tagSnippetsList: Array<google_ads_googleads_v0_common_tag_snippet_pb.TagSnippet.AsObject>,
  ...
  export class AttributionModelSettings extends jspb.Message {
    getAttributionModel(): google_ads_googleads_v0_enums_attribution_model_pb.AttributionModelEnum.AttributionModel;
    setAttributionModel(value: google_ads_googleads_v0_enums_attribution_model_pb.AttributionModelEnum.AttributionModel): void;

    getDataDrivenModelStatus(): google_ads_googleads_v0_enums_data_driven_model_status_pb.DataDrivenModelStatusEnum.DataDrivenModelStatus;
    setDataDrivenModelStatus(value: google_ads_googleads_v0_enums_data_driven_model_status_pb.DataDrivenModelStatusEnum.DataDrivenModelStatus): void;
  ...
  export namespace AttributionModelSettings {
    export type AsObject = {
      attributionModel: google_ads_googleads_v0_enums_attribution_model_pb.AttributionModelEnum.AttributionModel,
      dataDrivenModelStatus: google_ads_googleads_v0_enums_data_driven_model_status_pb.DataDrivenModelStatusEnum.DataDrivenModelStatus,
    }
  }
