...
// file: google/ads/googleads/v0/resources/recommendation.proto
...
export class Recommendation extends jspb.Message {
  ...
  setType(value: google_ads_googleads_v0_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationType): void;
...
export namespace Recommendation {
  ...
  export namespace TargetCpaOptInRecommendation {
    ...
    export class TargetCpaOptInRecommendationOption extends jspb.Message {
      ...
      setGoal(value: google_ads_googleads_v0_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal): void;
