...
// file: google/ads/googleads/v0/resources/shared_set.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v0_enums_shared_set_status_pb from "../../../../../google/ads/googleads/v0/enums/shared_set_status_pb";
import * as google_ads_googleads_v0_enums_shared_set_type_pb from "../../../../../google/ads/googleads/v0/enums/shared_set_type_pb";
...
export class SharedSet extends jspb.Message {
  ...
  getType(): google_ads_googleads_v0_enums_shared_set_type_pb.SharedSetTypeEnum.SharedSetType;
  setType(value: google_ads_googleads_v0_enums_shared_set_type_pb.SharedSetTypeEnum.SharedSetType): void;
  ...
  getStatus(): google_ads_googleads_v0_enums_shared_set_status_pb.SharedSetStatusEnum.SharedSetStatus;
  setStatus(value: google_ads_googleads_v0_enums_shared_set_status_pb.SharedSetStatusEnum.SharedSetStatus): void;
...
export namespace SharedSet {
  export type AsObject = {
    ...
    type: google_ads_googleads_v0_enums_shared_set_type_pb.SharedSetTypeEnum.SharedSetType,
    name?: google_protobuf_wrappers_pb.StringValue.AsObject,
    status: google_ads_googleads_v0_enums_shared_set_status_pb.SharedSetStatusEnum.SharedSetStatus,
