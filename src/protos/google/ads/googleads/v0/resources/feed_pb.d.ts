...
// file: google/ads/googleads/v0/resources/feed.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v0_enums_affiliate_location_feed_relationship_type_pb from "../../../../../google/ads/googleads/v0/enums/affiliate_location_feed_relationship_type_pb";
import * as google_ads_googleads_v0_enums_feed_attribute_type_pb from "../../../../../google/ads/googleads/v0/enums/feed_attribute_type_pb";
import * as google_ads_googleads_v0_enums_feed_origin_pb from "../../../../../google/ads/googleads/v0/enums/feed_origin_pb";
import * as google_ads_googleads_v0_enums_feed_status_pb from "../../../../../google/ads/googleads/v0/enums/feed_status_pb";
...
export class Feed extends jspb.Message {
  ...
  getOrigin(): google_ads_googleads_v0_enums_feed_origin_pb.FeedOriginEnum.FeedOrigin;
  setOrigin(value: google_ads_googleads_v0_enums_feed_origin_pb.FeedOriginEnum.FeedOrigin): void;

  getStatus(): google_ads_googleads_v0_enums_feed_status_pb.FeedStatusEnum.FeedStatus;
  setStatus(value: google_ads_googleads_v0_enums_feed_status_pb.FeedStatusEnum.FeedStatus): void;
...
export namespace Feed {
  export type AsObject = {
    ...
    origin: google_ads_googleads_v0_enums_feed_origin_pb.FeedOriginEnum.FeedOrigin,
    status: google_ads_googleads_v0_enums_feed_status_pb.FeedStatusEnum.FeedStatus,
  ...
  export class AffiliateLocationFeedData extends jspb.Message {
    ...
    getRelationshipType(): google_ads_googleads_v0_enums_affiliate_location_feed_relationship_type_pb.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType;
    setRelationshipType(value: google_ads_googleads_v0_enums_affiliate_location_feed_relationship_type_pb.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType): void;
  ...
  export namespace AffiliateLocationFeedData {
    export type AsObject = {
      ...
      relationshipType: google_ads_googleads_v0_enums_affiliate_location_feed_relationship_type_pb.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType,
    }
  }
...
export class FeedAttribute extends jspb.Message {
  ...
  getType(): google_ads_googleads_v0_enums_feed_attribute_type_pb.FeedAttributeTypeEnum.FeedAttributeType;
  setType(value: google_ads_googleads_v0_enums_feed_attribute_type_pb.FeedAttributeTypeEnum.FeedAttributeType): void;
...
export namespace FeedAttribute {
  export type AsObject = {
    id?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    name?: google_protobuf_wrappers_pb.StringValue.AsObject,
    type: google_ads_googleads_v0_enums_feed_attribute_type_pb.FeedAttributeTypeEnum.FeedAttributeType,
