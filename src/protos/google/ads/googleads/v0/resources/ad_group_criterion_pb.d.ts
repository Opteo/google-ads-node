...
// file: google/ads/googleads/v0/resources/ad_group_criterion.proto
...
export class AdGroupCriterion extends jspb.Message {
  ...
  setStatus(value: google_ads_googleads_v0_enums_ad_group_criterion_status_pb.AdGroupCriterionStatusEnum.AdGroupCriterionStatus): void;
  ...
  setEffectiveCpcBidSource(value: google_ads_googleads_v0_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource): void;

  getEffectiveCpmBidSource(): google_ads_googleads_v0_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource;
  setEffectiveCpmBidSource(value: google_ads_googleads_v0_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource): void;

  getEffectiveCpvBidSource(): google_ads_googleads_v0_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource;
  setEffectiveCpvBidSource(value: google_ads_googleads_v0_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource): void;

  getEffectivePercentCpcBidSource(): google_ads_googleads_v0_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource;
  setEffectivePercentCpcBidSource(value: google_ads_googleads_v0_enums_bidding_source_pb.BiddingSourceEnum.BiddingSource): void;
  ...
  setListingGroup(value?: google_ads_googleads_v0_common_criteria_pb.ListingGroupInfo): void;
  ...
  getAppPaymentModel(): google_ads_googleads_v0_common_criteria_pb.AppPaymentModelInfo | undefined;
  setAppPaymentModel(value?: google_ads_googleads_v0_common_criteria_pb.AppPaymentModelInfo): void;
...
export namespace AdGroupCriterion {
  export type AsObject = {
    ...
    appPaymentModel?: google_ads_googleads_v0_common_criteria_pb.AppPaymentModelInfo.AsObject,
  }
  ...
  export class QualityInfo extends jspb.Message {
    ...
    setCreativeQualityScore(value: google_ads_googleads_v0_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucket): void;

    getPostClickQualityScore(): google_ads_googleads_v0_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucket;
    setPostClickQualityScore(value: google_ads_googleads_v0_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucket): void;

    getSearchPredictedCtr(): google_ads_googleads_v0_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucket;
    setSearchPredictedCtr(value: google_ads_googleads_v0_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucket): void;
