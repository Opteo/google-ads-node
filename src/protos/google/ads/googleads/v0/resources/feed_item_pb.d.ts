...
// file: google/ads/googleads/v0/resources/feed_item.proto
...
import * as google_ads_googleads_v0_common_feed_common_pb from "../../../../../google/ads/googleads/v0/common/feed_common_pb";
import * as google_ads_googleads_v0_common_policy_pb from "../../../../../google/ads/googleads/v0/common/policy_pb";
import * as google_ads_googleads_v0_enums_feed_item_quality_approval_status_pb from "../../../../../google/ads/googleads/v0/enums/feed_item_quality_approval_status_pb";
import * as google_ads_googleads_v0_enums_feed_item_quality_disapproval_reason_pb from "../../../../../google/ads/googleads/v0/enums/feed_item_quality_disapproval_reason_pb";
import * as google_ads_googleads_v0_enums_feed_item_status_pb from "../../../../../google/ads/googleads/v0/enums/feed_item_status_pb";
import * as google_ads_googleads_v0_enums_feed_item_validation_status_pb from "../../../../../google/ads/googleads/v0/enums/feed_item_validation_status_pb";
import * as google_ads_googleads_v0_enums_geo_targeting_restriction_pb from "../../../../../google/ads/googleads/v0/enums/geo_targeting_restriction_pb";
import * as google_ads_googleads_v0_enums_policy_approval_status_pb from "../../../../../google/ads/googleads/v0/enums/policy_approval_status_pb";
import * as google_ads_googleads_v0_enums_policy_review_status_pb from "../../../../../google/ads/googleads/v0/enums/policy_review_status_pb";
...
export class FeedItem extends jspb.Message {
  ...
  getGeoTargetingRestriction(): google_ads_googleads_v0_enums_geo_targeting_restriction_pb.GeoTargetingRestrictionEnum.GeoTargetingRestriction;
  setGeoTargetingRestriction(value: google_ads_googleads_v0_enums_geo_targeting_restriction_pb.GeoTargetingRestrictionEnum.GeoTargetingRestriction): void;
  ...
  getStatus(): google_ads_googleads_v0_enums_feed_item_status_pb.FeedItemStatusEnum.FeedItemStatus;
  setStatus(value: google_ads_googleads_v0_enums_feed_item_status_pb.FeedItemStatusEnum.FeedItemStatus): void;
...
export namespace FeedItem {
  export type AsObject = {
    ...
    geoTargetingRestriction: google_ads_googleads_v0_enums_geo_targeting_restriction_pb.GeoTargetingRestrictionEnum.GeoTargetingRestriction,
    urlCustomParametersList: Array<google_ads_googleads_v0_common_custom_parameter_pb.CustomParameter.AsObject>,
    status: google_ads_googleads_v0_enums_feed_item_status_pb.FeedItemStatusEnum.FeedItemStatus,
...
export class FeedItemAttributeValue extends jspb.Message {
  ...
  getPriceValue(): google_ads_googleads_v0_common_feed_common_pb.Price | undefined;
  setPriceValue(value?: google_ads_googleads_v0_common_feed_common_pb.Price): void;
...
export namespace FeedItemAttributeValue {
  export type AsObject = {
    ...
    priceValue?: google_ads_googleads_v0_common_feed_common_pb.Price.AsObject,
...
export class FeedItemPlaceholderPolicyInfo extends jspb.Message {
  ...
  getReviewStatus(): google_ads_googleads_v0_enums_policy_review_status_pb.PolicyReviewStatusEnum.PolicyReviewStatus;
  setReviewStatus(value: google_ads_googleads_v0_enums_policy_review_status_pb.PolicyReviewStatusEnum.PolicyReviewStatus): void;

  getApprovalStatus(): google_ads_googleads_v0_enums_policy_approval_status_pb.PolicyApprovalStatusEnum.PolicyApprovalStatus;
  setApprovalStatus(value: google_ads_googleads_v0_enums_policy_approval_status_pb.PolicyApprovalStatusEnum.PolicyApprovalStatus): void;

  clearPolicyTopicEntriesList(): void;
  getPolicyTopicEntriesList(): Array<google_ads_googleads_v0_common_policy_pb.PolicyTopicEntry>;
  setPolicyTopicEntriesList(value: Array<google_ads_googleads_v0_common_policy_pb.PolicyTopicEntry>): void;
  addPolicyTopicEntries(value?: google_ads_googleads_v0_common_policy_pb.PolicyTopicEntry, index?: number): google_ads_googleads_v0_common_policy_pb.PolicyTopicEntry;

  getValidationStatus(): google_ads_googleads_v0_enums_feed_item_validation_status_pb.FeedItemValidationStatusEnum.FeedItemValidationStatus;
  setValidationStatus(value: google_ads_googleads_v0_enums_feed_item_validation_status_pb.FeedItemValidationStatusEnum.FeedItemValidationStatus): void;
  ...
  getQualityApprovalStatus(): google_ads_googleads_v0_enums_feed_item_quality_approval_status_pb.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus;
  setQualityApprovalStatus(value: google_ads_googleads_v0_enums_feed_item_quality_approval_status_pb.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus): void;

  clearQualityDisapprovalReasonsList(): void;
  getQualityDisapprovalReasonsList(): Array<google_ads_googleads_v0_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason>;
  setQualityDisapprovalReasonsList(value: Array<google_ads_googleads_v0_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason>): void;
  addQualityDisapprovalReasons(value: google_ads_googleads_v0_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason, index?: number): google_ads_googleads_v0_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason;
...
export namespace FeedItemPlaceholderPolicyInfo {
  export type AsObject = {
    ...
    reviewStatus: google_ads_googleads_v0_enums_policy_review_status_pb.PolicyReviewStatusEnum.PolicyReviewStatus,
    approvalStatus: google_ads_googleads_v0_enums_policy_approval_status_pb.PolicyApprovalStatusEnum.PolicyApprovalStatus,
    policyTopicEntriesList: Array<google_ads_googleads_v0_common_policy_pb.PolicyTopicEntry.AsObject>,
    validationStatus: google_ads_googleads_v0_enums_feed_item_validation_status_pb.FeedItemValidationStatusEnum.FeedItemValidationStatus,
    validationErrorsList: Array<FeedItemValidationError.AsObject>,
    qualityApprovalStatus: google_ads_googleads_v0_enums_feed_item_quality_approval_status_pb.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus,
    qualityDisapprovalReasonsList: Array<google_ads_googleads_v0_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason>,
  }
}

export class FeedItemValidationError extends jspb.Message {
  getValidationError(): google_ads_googleads_v0_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationError;
  setValidationError(value: google_ads_googleads_v0_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationError): void;
  ...
  getExtraInformation(): google_protobuf_wrappers_pb.StringValue | undefined;
  setExtraInformation(value?: google_protobuf_wrappers_pb.StringValue): void;
...
export namespace FeedItemValidationError {
  export type AsObject = {
    validationError: google_ads_googleads_v0_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationError,
    description?: google_protobuf_wrappers_pb.StringValue.AsObject,
    feedAttributeIdsList: Array<google_protobuf_wrappers_pb.Int64Value.AsObject>,
    extraInformation?: google_protobuf_wrappers_pb.StringValue.AsObject,
  }
}
