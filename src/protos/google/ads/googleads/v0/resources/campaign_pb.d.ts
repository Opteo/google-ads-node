...
// file: google/ads/googleads/v0/resources/campaign.proto
...
import * as google_ads_googleads_v0_common_frequency_cap_pb from "../../../../../google/ads/googleads/v0/common/frequency_cap_pb";
import * as google_ads_googleads_v0_common_real_time_bidding_setting_pb from "../../../../../google/ads/googleads/v0/common/real_time_bidding_setting_pb";
import * as google_ads_googleads_v0_common_targeting_setting_pb from "../../../../../google/ads/googleads/v0/common/targeting_setting_pb";
...
import * as google_ads_googleads_v0_enums_brand_safety_suitability_pb from "../../../../../google/ads/googleads/v0/enums/brand_safety_suitability_pb";
...
import * as google_ads_googleads_v0_enums_vanity_pharma_display_url_mode_pb from "../../../../../google/ads/googleads/v0/enums/vanity_pharma_display_url_mode_pb";
import * as google_ads_googleads_v0_enums_vanity_pharma_text_pb from "../../../../../google/ads/googleads/v0/enums/vanity_pharma_text_pb";
...
export class Campaign extends jspb.Message {
  ...
  setStatus(value: google_ads_googleads_v0_enums_campaign_status_pb.CampaignStatusEnum.CampaignStatus): void;
  ...
  setServingStatus(value: google_ads_googleads_v0_enums_campaign_serving_status_pb.CampaignServingStatusEnum.CampaignServingStatus): void;
  ...
  setAdServingOptimizationStatus(value: google_ads_googleads_v0_enums_ad_serving_optimization_status_pb.AdServingOptimizationStatusEnum.AdServingOptimizationStatus): void;
  ...
  setAdvertisingChannelType(value: google_ads_googleads_v0_enums_advertising_channel_type_pb.AdvertisingChannelTypeEnum.AdvertisingChannelType): void;
  ...
  setAdvertisingChannelSubType(value: google_ads_googleads_v0_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType): void;
  ...
  getRealTimeBiddingSetting(): google_ads_googleads_v0_common_real_time_bidding_setting_pb.RealTimeBiddingSetting | undefined;
  setRealTimeBiddingSetting(value?: google_ads_googleads_v0_common_real_time_bidding_setting_pb.RealTimeBiddingSetting): void;
  ...
  getTargetingSetting(): google_ads_googleads_v0_common_targeting_setting_pb.TargetingSetting | undefined;
  setTargetingSetting(value?: google_ads_googleads_v0_common_targeting_setting_pb.TargetingSetting): void;
  ...
  setBiddingStrategyType(value: google_ads_googleads_v0_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyType): void;
  ...
  getFrequencyCapsList(): Array<google_ads_googleads_v0_common_frequency_cap_pb.FrequencyCapEntry>;
  setFrequencyCapsList(value: Array<google_ads_googleads_v0_common_frequency_cap_pb.FrequencyCapEntry>): void;
  addFrequencyCaps(value?: google_ads_googleads_v0_common_frequency_cap_pb.FrequencyCapEntry, index?: number): google_ads_googleads_v0_common_frequency_cap_pb.FrequencyCapEntry;

  getVideoBrandSafetySuitability(): google_ads_googleads_v0_enums_brand_safety_suitability_pb.BrandSafetySuitabilityEnum.BrandSafetySuitability;
  setVideoBrandSafetySuitability(value: google_ads_googleads_v0_enums_brand_safety_suitability_pb.BrandSafetySuitabilityEnum.BrandSafetySuitability): void;
  ...
  setManualCpc(value?: google_ads_googleads_v0_common_bidding_pb.ManualCpc): void;

  hasManualCpm(): boolean;
  clearManualCpm(): void;
  getManualCpm(): google_ads_googleads_v0_common_bidding_pb.ManualCpm | undefined;
  setManualCpm(value?: google_ads_googleads_v0_common_bidding_pb.ManualCpm): void;

  hasManualCpv(): boolean;
  clearManualCpv(): void;
  getManualCpv(): google_ads_googleads_v0_common_bidding_pb.ManualCpv | undefined;
  setManualCpv(value?: google_ads_googleads_v0_common_bidding_pb.ManualCpv): void;
  ...
  setMaximizeConversions(value?: google_ads_googleads_v0_common_bidding_pb.MaximizeConversions): void;
  ...
  setMaximizeConversionValue(value?: google_ads_googleads_v0_common_bidding_pb.MaximizeConversionValue): void;
  ...
  setPercentCpc(value?: google_ads_googleads_v0_common_bidding_pb.PercentCpc): void;

  hasTargetCpm(): boolean;
  clearTargetCpm(): void;
  getTargetCpm(): google_ads_googleads_v0_common_bidding_pb.TargetCpm | undefined;
  setTargetCpm(value?: google_ads_googleads_v0_common_bidding_pb.TargetCpm): void;
...
export namespace Campaign {
  export type AsObject = {
    ...
    realTimeBiddingSetting?: google_ads_googleads_v0_common_real_time_bidding_setting_pb.RealTimeBiddingSetting.AsObject,
    ...
    targetingSetting?: google_ads_googleads_v0_common_targeting_setting_pb.TargetingSetting.AsObject,
    ...
    frequencyCapsList: Array<google_ads_googleads_v0_common_frequency_cap_pb.FrequencyCapEntry.AsObject>,
    videoBrandSafetySuitability: google_ads_googleads_v0_enums_brand_safety_suitability_pb.BrandSafetySuitabilityEnum.BrandSafetySuitability,
    ...
    manualCpv?: google_ads_googleads_v0_common_bidding_pb.ManualCpv.AsObject,
    ...
    targetCpm?: google_ads_googleads_v0_common_bidding_pb.TargetCpm.AsObject,
  }
  ...
  export class DynamicSearchAdsSetting extends jspb.Message {
    ...
    setFeedIdsList(value: Array<google_protobuf_wrappers_pb.Int64Value>): void;
  ...
  export class VanityPharma extends jspb.Message {
    getVanityPharmaDisplayUrlMode(): google_ads_googleads_v0_enums_vanity_pharma_display_url_mode_pb.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode;
    setVanityPharmaDisplayUrlMode(value: google_ads_googleads_v0_enums_vanity_pharma_display_url_mode_pb.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode): void;

    getVanityPharmaText(): google_ads_googleads_v0_enums_vanity_pharma_text_pb.VanityPharmaTextEnum.VanityPharmaText;
    setVanityPharmaText(value: google_ads_googleads_v0_enums_vanity_pharma_text_pb.VanityPharmaTextEnum.VanityPharmaText): void;
  ...
  export namespace VanityPharma {
    export type AsObject = {
      vanityPharmaDisplayUrlMode: google_ads_googleads_v0_enums_vanity_pharma_display_url_mode_pb.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode,
      vanityPharmaText: google_ads_googleads_v0_enums_vanity_pharma_text_pb.VanityPharmaTextEnum.VanityPharmaText,
    }
  }
