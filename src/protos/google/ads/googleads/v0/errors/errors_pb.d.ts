...
export namespace ErrorCode {
  export type AsObject = {
    ...
    changeStatusError: google_ads_googleads_v0_errors_change_status_error_pb.ChangeStatusErrorEnum.ChangeStatusError,
    feedError: google_ads_googleads_v0_errors_feed_error_pb.FeedErrorEnum.FeedError,
    geoTargetConstantSuggestionError: google_ads_googleads_v0_errors_geo_target_constant_suggestion_error_pb.GeoTargetConstantSuggestionErrorEnum.GeoTargetConstantSuggestionError,
    feedItemError: google_ads_googleads_v0_errors_feed_item_error_pb.FeedItemErrorEnum.FeedItemError,
    billingSetupError: google_ads_googleads_v0_errors_billing_setup_error_pb.BillingSetupErrorEnum.BillingSetupError,
    customerClientLinkError: google_ads_googleads_v0_errors_customer_client_link_error_pb.CustomerClientLinkErrorEnum.CustomerClientLinkError,
    customerManagerLinkError: google_ads_googleads_v0_errors_customer_manager_link_error_pb.CustomerManagerLinkErrorEnum.CustomerManagerLinkError,
    feedMappingError: google_ads_googleads_v0_errors_feed_mapping_error_pb.FeedMappingErrorEnum.FeedMappingError,
    customerFeedError: google_ads_googleads_v0_errors_customer_feed_error_pb.CustomerFeedErrorEnum.CustomerFeedError,
    adGroupFeedError: google_ads_googleads_v0_errors_ad_group_feed_error_pb.AdGroupFeedErrorEnum.AdGroupFeedError,
    campaignFeedError: google_ads_googleads_v0_errors_campaign_feed_error_pb.CampaignFeedErrorEnum.CampaignFeedError,
    adParameterError: google_ads_googleads_v0_errors_ad_parameter_error_pb.AdParameterErrorEnum.AdParameterError,
    feedItemValidationError: google_ads_googleads_v0_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationError,
    extensionSettingError: google_ads_googleads_v0_errors_extension_setting_error_pb.ExtensionSettingErrorEnum.ExtensionSettingError,
    policyViolationError: google_ads_googleads_v0_errors_policy_violation_error_pb.PolicyViolationErrorEnum.PolicyViolationError,
  }
...
export class PolicyViolationDetails extends jspb.Message {
  ...
  setKey(value?: google_ads_googleads_v0_common_policy_pb.PolicyViolationKey): void;
