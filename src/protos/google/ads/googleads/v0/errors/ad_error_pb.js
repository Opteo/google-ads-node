...
goog.exportSymbol('proto.google.ads.googleads.v0.errors.AdErrorEnum', null, global);
goog.exportSymbol('proto.google.ads.googleads.v0.errors.AdErrorEnum.AdError', null, global);
 ...
 * @constructor
 */
proto.google.ads.googleads.v0.errors.AdErrorEnum = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.google.ads.googleads.v0.errors.AdErrorEnum, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.google.ads.googleads.v0.errors.AdErrorEnum.displayName = 'proto.google.ads.googleads.v0.errors.AdErrorEnum';
}
 ...
 * @return {!Object}
 */
proto.google.ads.googleads.v0.errors.AdErrorEnum.prototype.toObject = function(opt_includeInstance) {
  return proto.google.ads.googleads.v0.errors.AdErrorEnum.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.google.ads.googleads.v0.errors.AdErrorEnum} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.ads.googleads.v0.errors.AdErrorEnum.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.google.ads.googleads.v0.errors.AdErrorEnum}
 */
proto.google.ads.googleads.v0.errors.AdErrorEnum.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.google.ads.googleads.v0.errors.AdErrorEnum;
  return proto.google.ads.googleads.v0.errors.AdErrorEnum.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.google.ads.googleads.v0.errors.AdErrorEnum} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.google.ads.googleads.v0.errors.AdErrorEnum}
 */
proto.google.ads.googleads.v0.errors.AdErrorEnum.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.google.ads.googleads.v0.errors.AdErrorEnum.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.google.ads.googleads.v0.errors.AdErrorEnum.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.google.ads.googleads.v0.errors.AdErrorEnum} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.ads.googleads.v0.errors.AdErrorEnum.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @enum {number}
 */
proto.google.ads.googleads.v0.errors.AdErrorEnum.AdError = {
  UNSPECIFIED: 0,
  UNKNOWN: 1,
