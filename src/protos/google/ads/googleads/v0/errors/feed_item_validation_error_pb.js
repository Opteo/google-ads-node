...
goog.exportSymbol('proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum', null, global);
goog.exportSymbol('proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.FeedItemValidationError', null, global);
 ...
 * @constructor
 */
proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.displayName = 'proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum';
}
 ...
 * @return {!Object}
 */
proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.prototype.toObject = function(opt_includeInstance) {
  return proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum}
 */
proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum;
  return proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum}
 */
proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @enum {number}
 */
proto.google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.FeedItemValidationError = {
  UNSPECIFIED: 0,
  UNKNOWN: 1,
  STRING_TOO_SHORT: 2,
  STRING_TOO_LONG: 3,
